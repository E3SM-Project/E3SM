...
# Simulation
readonly COMPSET="F20TR-SHOC"                  # or F20TR-P3-piAEROSOL 
readonly sstplus4K=true                     # true if to run plus4k experiment, otherwise false
readonly RESOLUTION="ne30pg2_r05_oECv3"      # or ne120pg2_r0125_oRRS18to6v3
readonly DESCRIPTOR="PhaseII.F20TR-SHOC.sstplus4K.ne30pg2"   # This will be the main part of the casename

readonly CASE_GROUP="NGD.Convection"

# Code and compilation
readonly CHECKOUT="20210813"                 # Provide a timestamp for distinction
readonly BRANCH="crterai/atm/add_SHOC2_v2P3"   # update based off jacobshpundpnnl/atm/E3SMv2_alpha5_59_wP3v4
...
readonly CODE_ROOT="/compyfs/tera431/E3SM_code/P3SHOC_20210813_new"               # where it contains 'components','cime', etc.
...
! When ZM scheme not in use, remove ZMFLXPRC and ZMFLXSNW
 ...
 ! For SHOC
 shoc_c_diag_3rd_mom=  7.0D0 
 shoc_ckh=  0.1D0 
 shoc_ckh_s_max=  1.0D0 
 shoc_ckh_s_min=  0.1D0 
 shoc_ckm=  0.1D0 
 shoc_ckm_s_max=  1.0D0 
 shoc_ckm_s_min=  0.1D0 
 shoc_lambda_high=  0.04D0 
 shoc_lambda_low=  0.001D0 
 shoc_lambda_slope=  2.65D0 
 shoc_lambda_thresh= 0.03D0
 shoc_length_fac=  0.5D0 
 shoc_qw2tune=  0.15D0 
 shoc_qwthl2tune=  0.15D0 
 shoc_thl2tune=  0.15D0 
 shoc_timestep=  -1 
 shoc_w2tune=  1.0D0 
