!  SVN:$Id: ice_itd.F90 1012 2015-06-26 12:34:09Z eclare $
!=======================================================================
...
! 2014 ECH: Converted to column package
      ...
      use ice_kinds_mod
      use ice_constants_colpkg, only: c0, c1, c2, p001, puny, &
...
!=======================================================================
      ...
      use ice_colpkg_tracers, only: nt_qsno, nt_aero
