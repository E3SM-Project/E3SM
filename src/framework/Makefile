...
mpas_decomp.o: mpas_grid_types.o mpas_stream_manager.o
...
mpas_block_creator.o: mpas_dmpar.o mpas_hash.o mpas_sort.o mpas_configure.o mpas_io_units.o mpas_block_decomp.o mpas_decomp.o $(DEPS)
