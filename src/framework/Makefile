...
mpas_stream_list.o: mpas_grid_types.o mpas_kind_types.o mpas_io.o mpas_io_streams.o

mpas_stream_manager.o: mpas_timekeeping.o mpas_grid_types.o mpas_kind_types.o mpas_c_interfacing.o mpas_stream_list.o 
