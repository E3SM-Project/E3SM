...
int PIOc_set_chunk_cache(int iosysid, int iotype, int io_rank, PIO_Offset size, PIO_Offset nelems, float preemption);
int PIOc_get_chunk_cache(int iosysid, int iotype, int io_rank, PIO_Offset *sizep, PIO_Offset *nelemsp, float *preemptionp);
