...
!
!As a general rule, all of the routines in here will be called within a threaded context (assuming VERT_OPENMP is not
...
contains
  ...
  subroutine cuda_mod_init(elem,hybrid,deriv,hvcoord)
    ...
    write(*,*) 'ERROR: Do not use VERT_OPENMP and CUDA FORTRAN'
    stop
#endif
!$OMP BARRIER
!$OMP MASTER
