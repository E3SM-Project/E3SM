...
contains
  ...
  subroutine seq_flds_set(nmlfile, ID, infodata)
    ...
    call seq_flds_add(x2o_fluxes,"Faxa_swndr")
    ...
    call seq_flds_add(x2o_fluxes,"Faxa_swvdr")
    ...
    call seq_flds_add(x2o_fluxes,"Faxa_swndf")
    ...
    call seq_flds_add(x2o_fluxes,"Faxa_swvdf")
