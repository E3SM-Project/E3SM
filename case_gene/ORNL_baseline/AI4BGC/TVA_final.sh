...
# Create a test case uELM_TVA_I1850uELMCNPRDCTCBC_finalspin
...
EXPID="TVA"
CASEDIR="$E3SM_SRCROOT/e3sm_cases/uELM_${EXPID}_ai4bgc_final"
...
./xmlchange USER_REQUESTED_WALLTIME="6:00:00"
...
echo "
finidat = '/gpfs/wolf2/cades/cli185/proj-shared/wangd/kmELM/e3sm_runs/uELM_TVA_ai4bgc/run/uELM_TVA_ai4bgc.elm.r.0021-01-01-00000.nc'
