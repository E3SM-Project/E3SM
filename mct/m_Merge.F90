...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: MergeTwoGG_ - merge data from two components.
!
...
! !INTERFACE:
 ...
 subroutine MergeTwoGG_(inAv1, iMaskTags1, rMaskTags1, &
...
!
      ...
      real,           dimension(:), pointer       :: WeightSum
...
!
  ...
  if(present(iMaskTags1)) then
	...
	call MergeInDataGG_(inAv1, iMaskTags1, rMaskTags1, GGrid, &
                            CheckMasks, outAv, WeightSum)
     else ! only integer masks
	call MergeInDataGG_(inAv1, iMaskTags=iMaskTags1, GGrid=GGrid, &
	...
	call MergeInDataGG_(inAv1, rMaskTags=rMaskTags1, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     else ! no masks at all
	call MergeInDataGG_(inAv1, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     endif
  ...
  if(present(iMaskTags2)) then
	...
	call MergeInDataGG_(inAv2, iMaskTags2, rMaskTags2, GGrid, &
                            CheckMasks, outAv, WeightSum)
     else ! only integer masks
	call MergeInDataGG_(inAv2, iMaskTags=iMaskTags2, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     endif
	...
	call MergeInDataGG_(inAv2, rMaskTags=rMaskTags2, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     else ! no masks at all
	call MergeInDataGG_(inAv2, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     endif
 ...
 end subroutine MergeTwoGG_

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!    Math and Computer Science Division, Argonne National Laboratory   !
!BOP -------------------------------------------------------------------
!
! !IROUTINE: MergeThreeGG_ - merge data from three components.
!
! !DESCRIPTION:  This routine merges {\tt REAL} attribute data from 
...
! !INTERFACE:
 ...
 subroutine MergeThreeGG_(inAv1, iMaskTags1, rMaskTags1, &
                          inAv2, iMaskTags2, rMaskTags2, &
...
!
  ...
  if(present(iMaskTags3)) then
	...
	call MergeInDataGG_(inAv3, iMaskTags3, rMaskTags3, GGrid, &
                            CheckMasks, outAv, WeightSum)
     else ! only integer masks
	call MergeInDataGG_(inAv3, iMaskTags=iMaskTags3, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     endif
	...
	call MergeInDataGG_(inAv3, rMaskTags=rMaskTags3, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     else ! no masks at all
	call MergeInDataGG_(inAv3, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     endif
 ...
 end subroutine MergeThreeGG_

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!    Math and Computer Science Division, Argonne National Laboratory   !
!BOP -------------------------------------------------------------------
!
! !IROUTINE: MergeFourGG_ - merge data from four components.
!
! !DESCRIPTION:  This routine merges {\tt REAL} attribute data from 
...
! !INTERFACE:
 ...
 subroutine MergeFourGG_(inAv1, iMaskTags1, rMaskTags1, &
                         inAv2, iMaskTags2, rMaskTags2, &
                         inAv3, iMaskTags3, rMaskTags3, &
...
!
  ...
  if(present(iMaskTags4)) then
	...
	call MergeInDataGG_(inAv4, iMaskTags4, rMaskTags4, GGrid, &
                            CheckMasks, outAv, WeightSum)
     else ! only integer masks
	call MergeInDataGG_(inAv4, iMaskTags=iMaskTags4, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     endif
	...
	call MergeInDataGG_(inAv4, rMaskTags=rMaskTags4, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     else ! no masks at all
	call MergeInDataGG_(inAv4, GGrid=GGrid, &
                            CheckMasks=CheckMasks, outAv=outAv, &
			    WeightSum=WeightSum)
     endif
 ...
 end subroutine MergeFourGG_

!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!    Math and Computer Science Division, Argonne National Laboratory   !
!BOP -------------------------------------------------------------------
!
! !IROUTINE: MergeInDataGG_ - merge in data from a component.
!
...
! !INTERFACE:
 ...
 subroutine MergeInDataGG_(inAv, iMaskTags, rMaskTags, GGrid, &
                           CheckMasks, outAv, WeightSum)
!
! !USES:
!
