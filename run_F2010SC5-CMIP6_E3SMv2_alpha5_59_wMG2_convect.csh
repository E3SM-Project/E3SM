...
set job_name       = F2010SC5-CMIP6_wMG2_test
...
set e3sm_tag       = cff12d21ca4b498d90a54d67adc2f787772a1649
set tag_name       = alpha5_59_v2candidate_NGD_Conv
...
#$xmlchange_exe --id CAM_CONFIG_OPTS --val "-phys cam5 -clubb_sgs -microphys mg2 -chem linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 72"

# +++
# [JS]: does this cause the input of small particles in the lower troposphere ? 
#$xmlchange_exe --id CAM_CONFIG_OPTS --val "-mach $machine -phys cam5 -clubb_sgs -microphys p3 -chem linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 72 -cosp"
$xmlchange_exe --id CAM_CONFIG_OPTS --val "-mach $machine -phys cam5 -clubb_sgs -microphys mg2 -chem linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 72"
# +++
...
! nhtfrq = 0,-24,-3
  ...
  fincl2 = 'PRECT','PRECC','PRECL','U200','V200'
