  ...
  subroutine component_init_aream(infodata, rof_c2_ocn, samegrid_ao, samegrid_al, &
    ...
    if (atm_present .and. ocn_present) then
       if (samegrid_ao) then
          ...
          call seq_map_map(mapper_Fa2o, av_s=dom_s%data, av_d=dom_d%data, fldlist='aream',string='init:areamFa2o')
       endif
    endif
    ...
    if (ice_present .and. ocn_present) then
       ...
       call seq_map_map(mapper_SFo2i, av_s=dom_s%data, av_d=dom_d%data, fldlist='aream',string='init:areamSFo2i')
    endif
    ...
    if (lnd_present .and. atm_present) then
       if (samegrid_al) then
          ...
          call seq_map_map(mapper_Sa2l, av_s=dom_s%data, av_d=dom_d%data, fldlist='aream',string='init:areamFa2l')
       endif
    end if
