...
set e3sm_tag       = 2f91b63cfd15bf53d54f59c8fb01581b29e0a1f8
...
cat <<EOF >> user_nl_elm
fsurdat = '/lcrc/group/acme/griffinb/E3SM_run_files/surfdata_0.5x0.5_simyr2000_c190418.nc'
EOF
...
cat <<EOF >> user_nl_eam
 ...
 clubb_altitude_threshold = 100.0
...
#-----------------------------------------------------------------------------------------------
  ...
  cp -s ${restart_files_dir}/${restart_case_name}.eam.r.${restart_filedate}-00000.nc $case_run_dir
  cp -s ${restart_files_dir}/${restart_case_name}.eam.rs.${restart_filedate}-00000.nc $case_run_dir
  cp -s ${restart_files_dir}/${restart_case_name}.eam.i.${restart_filedate}-00000.nc $case_run_dir
  cp -s ${restart_files_dir}/${restart_case_name}.elm2.r.${restart_filedate}-00000.nc $case_run_dir
  cp -s ${restart_files_dir}/${restart_case_name}.elm2.rh0.${restart_filedate}-00000.nc $case_run_dir
  ...
  #cp -s ${restart_files_dir}/${restart_case_name}.eam.h0.${restart_prevdate}.nc $case_run_dir
  #cp -s ${restart_files_dir}/${restart_case_name}.mosart.h0.${restart_prevdate}.nc $case_run_dir
  #cp -s ${restart_files_dir}/${restart_case_name}.elm2.h0.${restart_prevdate}.nc $case_run_dir
