...
# Simulation
# This is the second simulation of two for estimating aerorol radiative effect
# F2010-piAEROSOL, a nudging simulation towards the state of the CTL simulation F2010-CTL

readonly CTL_CASE_NAME=20210707.F2010-CTL.ne30pg2.cori        # The name of the CTL case
readonly CTL_CASE_PATH=/global/cscratch1/sd/wlin/E3SM_testings/${CTL_CASE_NAME}

readonly COMPSET="F2010SC5-P3"                  # or F20TR-P3-piAEROSOL 
readonly sstplus4K=false                        # true if to run plus4k experiment, otherwise false
readonly RESOLUTION="ne30pg2_r05_oECv3"         
readonly DESCRIPTOR="F2010-piAEROSOL.ne30pg2"   # This will be the main part of the casename. Reset to use 1850 aerosols in user_nl
...
! Use the IC generated by CTL run
 ncdata='${CTL_CASE_PATH}/run/${CTL_CASE_NAME}.eam.i.2009-10-01-00000.nc'
...
! Nudging settings
 ...
 nudge_end_month        = 1
 nudge_end_year         = 9999
 nudge_file_template    = '${CTL_CASE_NAME}.eam.h1.%y-%m-%d-00000.nc'
 nudge_method           = 'Linear'
 nudge_file_ntime       = 4
 nudge_model            = .True.
 ...
 nudge_qprof            = 0
 nudge_tcoef            = 0.
 nudge_times_per_day    = 4 !! or set Nudge_Tau = 6 !! 6h relaxation time scale
 nudge_tprof            = 0
 nudge_ucoef            = 1.
 nudge_uprof            = 1
 nudge_vcoef            = 1.
...
cat << EOF >> user_nl_elm
 ...
 finidat='${CTL_CASE_PATH}/run/${CTL_CASE_NAME}.elm.r.2009-10-01-00000.nc'
