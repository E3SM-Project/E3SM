...
conda activate dev_polaris_0.5.0-alpha.1
echo Done.
echo
...
source /ccs/proj/cli115/software/polaris/frontier/spack/dev_polaris_0_5_0_crayclang_mpich/share/spack/setup-env.sh
spack env activate dev_polaris_0_5_0_crayclang_mpich
module reset >& /dev/null
module switch Core/24.07 >& /dev/null
module switch PrgEnv-cray PrgEnv-cray/8.3.3 >& /dev/null
module switch cce cce/15.0.0 >& /dev/null
...
export POLARIS_COMPILER=crayclang
...
export PIO=/ccs/proj/cli115/software/polaris/frontier/spack/dev_polaris_0_5_0_crayclang_mpich/var/spack/environments/dev_polaris_0_5_0_crayclang_mpich/.spack-env/view
export METIS_ROOT=/ccs/proj/cli115/software/polaris/frontier/spack/dev_polaris_0_5_0_crayclang_mpich/var/spack/environments/dev_polaris_0_5_0_crayclang_mpich/.spack-env/view
export PARMETIS_ROOT=/ccs/proj/cli115/software/polaris/frontier/spack/dev_polaris_0_5_0_crayclang_mpich/var/spack/environments/dev_polaris_0_5_0_crayclang_mpich/.spack-env/view
...
export OPENMP=true
export HDF5_USE_FILE_LOCKING=FALSE
export LOAD_POLARIS_ENV=/autofs/nccs-svm1_home1/mpetersen/repos/polaris/main/load_dev_polaris_0.5.0-alpha.2_frontier_crayclang_mpich.sh
