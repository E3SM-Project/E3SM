...
source /global/cfs/cdirs/e3sm/software/polaris/pm-cpu/spack/dev_polaris_0_4_0_nvidia_mpich/share/spack/setup-env.sh
spack env activate dev_polaris_0_4_0_nvidia_mpich
...
export POLARIS_COMPILER=nvidia
...
#export PIO=/global/cfs/cdirs/e3sm/software/polaris/pm-cpu/spack/dev_polaris_0_4_0_nvidia_mpich/var/spack/environments/dev_polaris_0_4_0_nvidia_mpich/.spack-env/view
export PIO=/global/cfs/projectdirs/e3sm/hgkang/programs/ParallelIO_nvidia_new
export METIS_ROOT=/global/cfs/cdirs/e3sm/software/polaris/pm-cpu/spack/dev_polaris_0_4_0_nvidia_mpich/var/spack/environments/dev_polaris_0_4_0_nvidia_mpich/.spack-env/view
...
export PATH="/global/cfs/cdirs/e3sm/software/polaris/pm-cpu/spack/dev_polaris_soft_0_4_0/var/spack/environments/dev_polaris_soft_0_4_0/.spack-env/view/bin:$PATH"

export USE_PIO2=true
export OPENMP=false
export HDF5_USE_FILE_LOCKING=FALSE
export LOAD_POLARIS_ENV=/global/cfs/cdirs/e3sm/hgkang/polaris/polaris_MSdel2del4_nvidia/load_dev_polaris_0.4.0-alpha.2_pm-cpu_nvidia_mpich.sh
export POLARIS_MACHINE=pm-cpu
