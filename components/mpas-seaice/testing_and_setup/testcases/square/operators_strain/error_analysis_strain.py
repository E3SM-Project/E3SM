    ...
    for gridType in gridTypes:
        ...
        for iTerm in range(0,nTerms):
            ...
            for iEdgeOnCell in range(0,nEdgesOnCell[iCell]):
                ...
                dfdx[iTerm] += (velocityEdge * normalVectorPolygon[iCell,iEdgeOnCell,0] * dvEdge[iEdge]) / areaCell[iCell]
                dfdy[iTerm] += (velocityEdge * normalVectorPolygon[iCell,iEdgeOnCell,1] * dvEdge[iEdge]) / areaCell[iCell]
