...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public ::  &  ! model size parameters
      POP_nxGlobal =  30 ,&! extent of horizontal axis in i direction
      POP_nyGlobal =  31 ,&! extent of horizontal axis in j direction
      POP_km =  3        ,&! number of vertical levels
   ...
   integer (POP_i4), parameter, public :: &
      POP_maxBlocksClinic = 65,  &! max number of blocks per processor
      POP_maxBlocksTropic = 65    !   in each distribution
