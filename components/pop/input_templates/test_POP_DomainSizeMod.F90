...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public :: &
      POP_blockSizeX = 16, &! size of block in first  horizontal dimension
      POP_blockSizeY = 16   ! size of block in second horizontal dimension
   ...
   integer (POP_i4), parameter, public :: &
      POP_maxBlocksClinic = 96,  &! max number of blocks per processor
      POP_maxBlocksTropic = 96    !   in each distribution
