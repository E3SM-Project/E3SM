...
!!== KZ_INSITU 
use modal_aer_opt,    only: modal_aero_sw_dry, modal_aero_sw_dry_fine, modal_aero_sw_rhfix 
!!== KZ_INSITU 
...
logical :: aw_insitu_diag = .false. 
public  :: aw_insitu_diag
...
subroutine aer_rad_props_sw(list_idx, state, pbuf,  nnite, idxnite, is_cmip6_volc, &
   ...
   if (nmodes > 0) then
      call modal_aero_sw(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level, &
                         tau, tau_w, tau_w_g, tau_w_f)
!!== KZ_INSITU 
      if(aw_insitu_diag) then 
      call modal_aero_sw_dry(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level)
      call modal_aero_sw_rhfix(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level, 1)
      call modal_aero_sw_rhfix(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level, 2)
      call modal_aero_sw_rhfix(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level, 3)
      call modal_aero_sw_rhfix(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level, 4)
      call modal_aero_sw_rhfix(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level, 5)
      call modal_aero_sw_dry_fine(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw(:,:,idx_sw_diag), trop_level)
      end if
!!== KZ_INSITU 
   else
      tau    (1:ncol,:,:) = 0._r8
