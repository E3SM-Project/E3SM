...
!! Kai Zhang 
!! 2019-08 
!! added aerocom INSITU diagnostics 
!!
!!
...
public :: modal_aero_sw_dry
public :: modal_aero_sw_dry_fine
public :: modal_aero_sw_rhfix
...
integer :: dgnumwet_rh40_idx = -1
integer :: dgnumwet_rh55_idx = -1
integer :: dgnumwet_rh65_idx = -1
integer :: dgnumwet_rh75_idx = -1
integer :: dgnumwet_rh85_idx = -1
integer :: qaerwat_rh40_idx  = -1
integer :: qaerwat_rh55_idx  = -1
integer :: qaerwat_rh65_idx  = -1
integer :: qaerwat_rh75_idx  = -1
integer :: qaerwat_rh85_idx  = -1
!!== KZ_INSITU
...
!!== KZ_INSITU
   dgnumwet_rh40_idx = pbuf_get_index('DGNUMWET40',errcode)
   dgnumwet_rh55_idx = pbuf_get_index('DGNUMWET55',errcode)
   dgnumwet_rh65_idx = pbuf_get_index('DGNUMWET65',errcode)
   dgnumwet_rh75_idx = pbuf_get_index('DGNUMWET75',errcode)
   dgnumwet_rh85_idx = pbuf_get_index('DGNUMWET85',errcode)
!!== KZ_INSITU
   if (errcode < 0) then
...
!!== KZ_INSITU
   ...
   qaerwat_rh40_idx  = pbuf_get_index('QAERWAT40')
   qaerwat_rh55_idx  = pbuf_get_index('QAERWAT55')
   qaerwat_rh65_idx  = pbuf_get_index('QAERWAT65')
   qaerwat_rh75_idx  = pbuf_get_index('QAERWAT75')
   qaerwat_rh85_idx  = pbuf_get_index('QAERWAT85')

   dgnumdry_idx = pbuf_get_index('DGNUM',errcode)
   if (errcode < 0) then
      call endrun(routine//' ERROR: cannot find physics buffer field DGNUM')
   end if
!!== KZ_INSITU
   if (errcode < 0) then
...
!!== KZ_INSITU
   call addfld ('EXTINCT440',(/ 'lev' /),'A','/m','EXT_440  ', flag_xyfill=.true.)
   call addfld ('EXTINCT870',(/ 'lev' /),'A','/m','EXT_870  ', flag_xyfill=.true.)
   call addfld ('EXTINCT40', (/ 'lev' /),'A','/m','EXT_RH40 ', flag_xyfill=.true.)
   call addfld ('EXTINCT55', (/ 'lev' /),'A','/m','EXT_RH55 ', flag_xyfill=.true.)
   call addfld ('EXTINCT65', (/ 'lev' /),'A','/m','EXT_RH65 ', flag_xyfill=.true.)
   call addfld ('EXTINCT75', (/ 'lev' /),'A','/m','EXT_RH75 ', flag_xyfill=.true.)
   call addfld ('EXTINCT85', (/ 'lev' /),'A','/m','EXT_RH85 ', flag_xyfill=.true.)
   call addfld ('EXTINCTdry',(/ 'lev' /),'A','/m','EXT_dry  ', flag_xyfill=.true.)
   call addfld ('EXTINCT440dry',(/ 'lev' /), 'A','/m','EXT_440dry', flag_xyfill=.true.)
   call addfld ('EXTINCT870dry',(/ 'lev' /), 'A','/m','EXT_870dry', flag_xyfill=.true.)
   call addfld ('EXTINCTdryFine',(/ 'lev' /),'A','/m','EXT_dryfine', flag_xyfill=.true.)
   
   call addfld ('ABSORB440',(/ 'lev' /),'A','/m','ABS_440  ', flag_xyfill=.true.)
   call addfld ('ABSORB870',(/ 'lev' /),'A','/m','ABS_870  ', flag_xyfill=.true.)
   call addfld ('ABSORB40', (/ 'lev' /),'A','/m','ABS_RH40 ', flag_xyfill=.true.)
   call addfld ('ABSORB55', (/ 'lev' /),'A','/m','ABS_RH55 ', flag_xyfill=.true.)
   call addfld ('ABSORB65', (/ 'lev' /),'A','/m','ABS_RH65 ', flag_xyfill=.true.)
   call addfld ('ABSORB75', (/ 'lev' /),'A','/m','ABS_RH75 ', flag_xyfill=.true.)
   call addfld ('ABSORB85', (/ 'lev' /),'A','/m','ABS_RH85 ', flag_xyfill=.true.)
   call addfld ('ABSORBdry',(/ 'lev' /),'A','/m','ABS_dry  ', flag_xyfill=.true.)
   call addfld ('ABSORB440dry',(/ 'lev' /), 'A','/m','ABS_440dry', flag_xyfill=.true.)
   call addfld ('ABSORB870dry',(/ 'lev' /), 'A','/m','ABS_870dry', flag_xyfill=.true.)
   call addfld ('ABSORBdryFine',(/ 'lev' /),'A','/m','ABS_dryfine', flag_xyfill=.true.)
   ...
   call addfld ('A2EXTINCT55', horiz_only,'A','/m','EXT_RH55 ', flag_xyfill=.true.)
   call addfld ('A2EXTINCT65', horiz_only,'A','/m','EXT_RH65 ', flag_xyfill=.true.)
   call addfld ('A2EXTINCT75', horiz_only,'A','/m','EXT_RH75 ', flag_xyfill=.true.)
   call addfld ('A2EXTINCT85', horiz_only,'A','/m','EXT_RH85 ', flag_xyfill=.true.)
   call addfld ('A2EXTINCTdry',horiz_only,'A','/m','EXT_dry  ', flag_xyfill=.true.)
   call addfld ('A2EXTINCT440dry',horiz_only, 'A','/m','EXT_440dry', flag_xyfill=.true.)
   ...
   call addfld ('A2ABSORB55', horiz_only,'A','/m','ABS_RH55 ', flag_xyfill=.true.)
   call addfld ('A2ABSORB65', horiz_only,'A','/m','ABS_RH65 ', flag_xyfill=.true.)
   call addfld ('A2ABSORB75', horiz_only,'A','/m','ABS_RH75 ', flag_xyfill=.true.)
   call addfld ('A2ABSORB85', horiz_only,'A','/m','ABS_RH85 ', flag_xyfill=.true.)
   call addfld ('A2ABSORBdry',horiz_only,'A','/m','ABS_dry  ', flag_xyfill=.true.)
   call addfld ('A2ABSORB440dry',horiz_only, 'A','/m','ABS_440dry', flag_xyfill=.true.)
   call addfld ('A2ABSORB870dry',horiz_only, 'A','/m','ABS_870dry', flag_xyfill=.true.)
   call addfld ('A2ABSORBdryFine',horiz_only,'A','/m','ABS_dryfine', flag_xyfill=.true.)
...
!!== KZ_INSITU
   call addfld ('AODVIS40',horiz_only, 'A','  ','AOD40', flag_xyfill=.true.)
   call addfld ('AODVIS55',horiz_only, 'A','  ','AOD55', flag_xyfill=.true.)
   call addfld ('AODVIS65',horiz_only, 'A','  ','AOD65', flag_xyfill=.true.)
   call addfld ('AODVIS75',horiz_only, 'A','  ','AOD75', flag_xyfill=.true.)
   call addfld ('AODVIS85',horiz_only, 'A','  ','AOD85', flag_xyfill=.true.)
   call addfld ('AODVISdry',horiz_only,'A','  ','AODdry', flag_xyfill=.true.)
   call addfld ('AODVISdryFine',horiz_only,   'A','  ','AODdryFine', flag_xyfill=.true.)

   call addfld ('AODUVdry',horiz_only, 'A','  ','AODUVdry', flag_xyfill=.true.)  
   call addfld ('AODUVdryFine',horiz_only, 'A','  ','AODUVdryFine', flag_xyfill=.true.)  
   call addfld ('AODNIRdry',horiz_only,    'A','  ','AODNIRdry', flag_xyfill=.true.) 
   call addfld ('AODNIRdryFine',horiz_only,'A','  ','AODNIRdryFine', flag_xyfill=.true.) 
   call addfld ('AODABSdry',horiz_only, 'A','  ',   'AODABSdry', flag_xyfill=.true.)
   call addfld ('AODABSdryFine',horiz_only,'A','  ','AODABSdryFine', flag_xyfill=.true.)
!!== KZ_INSITU
...
if (history_amwg) then 
   ...
   if (history_aero_optics) then 
      ...
      call add_default ('AODDUST3'     , 1, ' ')
!!== KZ_INSITU
      call add_default ('ABSORB440'      , 1, ' ')
      call add_default ('ABSORB870'      , 1, ' ')
      call add_default ('ABSORB40'       , 1, ' ')
      call add_default ('ABSORB55'       , 1, ' ')
      call add_default ('ABSORB65'       , 1, ' ')
      call add_default ('ABSORB75'       , 1, ' ')
      call add_default ('ABSORB85'       , 1, ' ')
      call add_default ('ABSORBdry'      , 1, ' ')
      call add_default ('ABSORB440dry'   , 1, ' ')
      call add_default ('ABSORB870dry'   , 1, ' ')
      call add_default ('ABSORBdryFine'  , 1, ' ')
      call add_default ('AODVIS40'       , 1, ' ')
      call add_default ('AODVIS55'       , 1, ' ')
      call add_default ('AODVIS65'       , 1, ' ')
      call add_default ('AODVIS75'       , 1, ' ')
      call add_default ('AODVIS85'       , 1, ' ')
      call add_default ('AODVISdry'      , 1, ' ')
      call add_default ('AODVISdryFine'  , 1, ' ')
      call add_default ('AODUVdry'       , 1, ' ')
      call add_default ('AODUVdryFine'   , 1, ' ')
      call add_default ('AODNIRdry'      , 1, ' ')
      call add_default ('AODNIRdryFine'  , 1, ' ')
      ...
      call add_default ('EXTINCT55'      , 1, ' ')
      call add_default ('EXTINCT65'      , 1, ' ')
      call add_default ('EXTINCT75'      , 1, ' ')
      call add_default ('EXTINCT85'      , 1, ' ')
      call add_default ('EXTINCTdry'     , 1, ' ')
      call add_default ('EXTINCT440dry'  , 1, ' ')
      call add_default ('EXTINCT870dry'  , 1, ' ')
...
!!== KZ_INSITU
   real(r8) :: extinct440(pcols,pver)
   real(r8) :: extinct870(pcols,pver)
   real(r8) :: absorb440(pcols,pver)
   real(r8) :: absorb870(pcols,pver)
   real(r8) :: gavis(pcols,pver)
!!== KZ_INSITU
...
!!== KZ_INSITU
   extinct440(1:ncol,:)     = 0.0_r8
   extinct870(1:ncol,:)     = 0.0_r8
   absorb440(1:ncol,:)      = 0.0_r8
   absorb870(1:ncol,:)      = 0.0_r8
   gavis(1:ncol,:)     = 0.0_r8
!!== KZ_INSITU
...
!!== KZ_INSITU
                  extinct440(i,k) = extinct440(i,k) + dopaer(i)*air_density(i,k)/mass(i,k)
                  absorb440(i,k)  = absorb440(i,k) + pabs(i)*air_density(i,k)
!!== KZ_INSITU
               end do
            end if
...
!!== KZ_INSITU
                  extinct870(i,k) = extinct870(i,k) + dopaer(i)*air_density(i,k)/mass(i,k)
                  absorb870(i,k)  = absorb870(i,k) + pabs(i)*air_density(i,k)
!!== KZ_INSITU
               end do
            endif
...
!!== KZ_INSITU
            if (savaervis) then
               ! asy
               do i = 1, ncol
                  gavis(i,k) = gavis(i,k) + ga(i,k,isw) 
               end do
            end if 
!!== KZ_INSITU
         end do ! pver
   ...
   do i = 1, nnite
      ...
      extinct440(idxnite(i),:) = fillvalue
      extinct870(idxnite(i),:) = fillvalue
      absorb440(idxnite(i),:)  = fillvalue
      absorb870(idxnite(i),:)  = fillvalue
      gavis(idxnite(i),:)  = fillvalue
   end do
...
subroutine modal_aero_sw_dry(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw, trop_level)
   ...
   real(r8) :: tauxar(pcols,0:pver,nswbands) ! layer extinction optical depth
   real(r8) :: wa(pcols,0:pver,nswbands)     ! layer single-scatter albedo
   real(r8) :: ga(pcols,0:pver,nswbands)     ! asymmetry factor
   real(r8) :: fa(pcols,0:pver,nswbands)     ! forward scattered fraction
...
!!== KZ_INSITU
   ...
   real(r8) :: absorb440(pcols,pver)
   real(r8) :: absorb870(pcols,pver)
   real(r8) :: gavis(pcols,pver)               ! asy
   real(r8) :: qaerwat(pcols,pver)             ! bugfix
!!== KZ_INSITU
   real(r8) :: aodvis(pcols)               ! extinction optical depth
   real(r8) :: aodabs(pcols)               ! absorption optical depth
   ...
   integer  :: nerr_dopaer = 0
   real(r8) :: volf            ! volume fraction of insoluble aerosol
   character(len=*), parameter :: subname = 'modal_aero_sw_dry'
   !----------------------------------------------------------------------------
...
!!== KZ_INSITU
      ...
      call outfld('SSAVISdry',        ssavis,        pcols, lchnk)
      call outfld('AODUVdry',         aoduv,         pcols, lchnk)
      call outfld('AODNIRdry',        aodnir,        pcols, lchnk)

   end if

end subroutine modal_aero_sw_dry

!===============================================================================

subroutine modal_aero_sw_rhfix(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw, trop_level,  &
                         irh)

   ! calculates aerosol sw radiative properties

   integer,             intent(in) :: list_idx       ! index of the climate or a diagnostic list
   integer,             intent(in) :: irh            ! 1 : 40 
   type(physics_state), intent(in), target :: state          ! state variables
   ...
   integer  :: nerr_dopaer = 0
   real(r8) :: volf            ! volume fraction of insoluble aerosol
   character(len=*), parameter :: subname = 'modal_aero_sw_rhfix'
   !----------------------------------------------------------------------------
...
!!== KZ_INSITU
      select case (irh) 
      case(1) 
         call pbuf_get_field(pbuf, dgnumwet_rh40_idx, dgnumwet_m)
         call pbuf_get_field(pbuf, qaerwat_rh40_idx,  qaerwat_m)
      case(2) 
         call pbuf_get_field(pbuf, dgnumwet_rh55_idx, dgnumwet_m)
         call pbuf_get_field(pbuf, qaerwat_rh55_idx,  qaerwat_m)
      case(3) 
         call pbuf_get_field(pbuf, dgnumwet_rh65_idx, dgnumwet_m)
         call pbuf_get_field(pbuf, qaerwat_rh65_idx,  qaerwat_m)
      case(4) 
         call pbuf_get_field(pbuf, dgnumwet_rh75_idx, dgnumwet_m)
         call pbuf_get_field(pbuf, qaerwat_rh75_idx,  qaerwat_m)
      case(5) 
         call pbuf_get_field(pbuf, dgnumwet_rh85_idx, dgnumwet_m)
         call pbuf_get_field(pbuf, qaerwat_rh85_idx,  qaerwat_m)
      end select
!!== KZ_INSITU
   else
      ! If doing a diagnostic calculation then need to calculate the wet radius
...
subroutine modal_aero_sw_dry_fine(list_idx, state, pbuf, nnite, idxnite, is_cmip6_volc, ext_cmip6_sw, trop_level)
...
!!   real(r8), pointer :: qaerwat(:,:)      ! aerosol water (g/g)
   ...
   real(r8) :: aodabs(pcols)               ! absorption optical depth
!!== KZ_INSITU
   real(r8) :: qaerwat(pcols,pver)               ! asy
!!== KZ_INSITU
   ...
   integer  :: nerr_dopaer = 0
   real(r8) :: volf            ! volume fraction of insoluble aerosol
   character(len=*), parameter :: subname = 'modal_aero_sw_dry_fine'
   !----------------------------------------------------------------------------
...
!!== KZ_INSITU
   ...
   end if ! if (trim(str32).ne.'coarse') then 
   end do ! nmodes
