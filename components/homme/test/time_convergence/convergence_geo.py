...
plt.title('Max-norm error vs dt for L2-spatial norm of geo, 22.8 s')
dt = [0.45, 0.9, 1.8, 3.6]
...
slp2   = [ .5e-7/(4**3), .5e-7/(4**2), .5e-7/4, .5e-7] 
slp3   = [ .5e-8/(8**3), .5e-8/(8**2),.5e-8/8 , .5e-8]
...
plt.title('Max-norm error vs dt for L2-spatial norm of geo (hydrostatic mode), 22.8 s')
dt = [0.45, 0.9, 1.8, 3.6]
...
slp3   = [  1e-9/(8**3), 1e-9/(8**2), 1e-9/8 , 1e-9]
slope2 = plt.loglog(dt,slp2,label='Slope 2')
slope3 = plt.loglog(dt,slp3,label='Slope 3')
plt.xticks([ 0.45,0.9,1.8,3.6], ['0.45','0.9','1.8','3.6'])
plt.legend()
