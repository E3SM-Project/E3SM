...
for j in range(1,6):
  if (j == 1):
    ...
    fileteststr9h  = '/nscratch/asteyer/test_convergence/tstep9h_dt0p225.nc'
    fileteststr5h  = '/nscratch/asteyer/test_convergence/tstep5h_dt0p225.nc'
    fileteststr10h = '/nscratch/asteyer/test_convergence/tstep10h_dt0p225.nc'
  elif (j == 2):
    fileteststr9  = '/nscratch/asteyer/test_convergence/tstep9h_dt0p45.nc'
    fileteststr5  = '/nscratch/asteyer/test_convergence/tstep5h_dt0p45.nc'
    fileteststr10 = '/nscratch/asteyer/test_convergence/tstep10h_dt0p45.nc'
  elif (j == 3):
    fileteststr9  = '/nscratch/asteyer/test_convergence/tstep9h_dt0p9.nc'
    fileteststr5  = '/nscratch/asteyer/test_convergence/tstep5h_dt0p9.nc'
    fileteststr10 = '/nscratch/asteyer/test_convergence/tstep10h_dt0p9.nc'
  elif (j == 4):
    fileteststr9  = '/nscratch/asteyer/test_convergence/tstep9h_dt1p8.nc'
    fileteststr5  = '/nscratch/asteyer/test_convergence/tstep5h_dt1p8.nc'
    fileteststr10 = '/nscratch/asteyer/test_convergence/tstep10h_dt1p8.nc'
  elif (j == 5):
    fileteststr9  = '/nscratch/asteyer/test_convergence/tstep9h_dt3p6.nc'
    fileteststr5  = '/nscratch/asteyer/test_convergence/tstep5h_dt3p6.nc'
    fileteststr10 = '/nscratch/asteyer/test_convergence/tstep10h_dt3p6.nc'
...
Th9h = plt.loglog(dt,E9h,label='type9 Max-norm error')
Th5h = plt.loglog(dt,E5h,label='type5 Max-norm error')
Th10h = plt.loglog(dt,E10h,label='type10 Max-norm error')
slp2   = [ 1e-7/(4**4), 1e-7/(4**3), 1e-7/(4**2), 1e-7/4, 1e-7] 
slp3   = [ 1e-10/(8**4), 1e-10/(8**3), 1e-10/(8**2), 1e-10/8 , 1e-10]
