...
!  theta_hydrostatic_mode = .true.
  ...
  vert_remap_q_alg  = 10
  moisture          = 'dry'
  ne_x              = 68                       ! number of elements in x-dir
  ne_y              = 4                       ! number of elements in y-dir
  qsize             = 0                         ! num tracer fields
  nmax              = 45000                       ! total number of steps: 600s / tstep
...
!  tstep_type        = 5                         ! 1 => default method
  ...
  dt_remap_factor   = 20				! remap every 1 time steps
...
!!!0.02 !!!!default EAM is 3.4e-8 for earth circ=40000
  ...
  sx = -500.0
  sy = -500.0
  bubble_zcenter=200.0
  bubble_ztop=1500.0
  bubble_xyradius=250.0
  bubble_zradius =175.0
  bubble_cosine=.true.
  bubble_T0=300.0
  bubble_dT=0.5
/
...
&analysis_nl
  ...
  output_varnames1  ='T','Th','ps','geo'   ! variables to write to file
