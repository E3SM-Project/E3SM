...
!  theta_hydrostatic_mode = .true.
  ...
  qsize             = 9                         ! num tracer fields
  nmax              = 1200                    ! total number of steps: 600s / tstep
...
!  tstep_type        = 5                         ! 1 => default method
  tstep             = 0.1 !! 20x20x60lev 0.1                       ! dynamics timestep
...
&analysis_nl
  ...
  output_frequency  = 1200,                        ! steps
  output_varnames1  ='T','Th','ps','geo','Q','Q2','Q3','Q4','Q5','Q6','Q7','Q8','Q9'
