!===============================================================================
! SVN $Id: shr_mpi_mod.F90 3249 2007-02-21 00:45:09Z erik $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/trunk_tags/share3_070423/shr/shr_mpi_mod.F90 $
!===============================================================================
...
SUBROUTINE shr_mpi_bcastc0(vec,comm,string)
...
!-------------------------------------------------------------------------------
   ...
   call MPI_BCAST(vec,lsize,MPI_CHARACTER,0,comm,ierr)
   if (present(string)) then
     call shr_mpi_chkerr(ierr,subName//trim(string))
   else
     call shr_mpi_chkerr(ierr,subName)
...
SUBROUTINE shr_mpi_bcastr2(arr,comm,string)
...
!-------------------------------------------------------------------------------
   ...
   call MPI_BCAST(arr,lsize,MPI_REAL8,0,comm,ierr)
   if (present(string)) then
     call shr_mpi_chkerr(ierr,subName//trim(string))
   else
     call shr_mpi_chkerr(ierr,subName)
...
SUBROUTINE shr_mpi_bcasti2(arr,comm,string)
...
!-------------------------------------------------------------------------------
   ...
   call MPI_BCAST(arr,lsize,MPI_INTEGER,0,comm,ierr)
   if (present(string)) then
     call shr_mpi_chkerr(ierr,subName//trim(string))
   else
     call shr_mpi_chkerr(ierr,subName)
...
SUBROUTINE shr_mpi_bcastr3(arr,comm,string)
