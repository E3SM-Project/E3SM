!===============================================================================
! SVN $Id: shr_map_mod.F90 239 2006-02-08 19:02:33Z kauff $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/trunk_tags/share3_070423/shr/shr_map_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!BOP ===========================================================================
!
! !IROUTINE: shr_map_mapSet -- Compute mapping weights
!
! !DESCRIPTION:
...
!XXBOP ===========================================================================
!
! !IROUTINE: shr_map_checkGrids -- local routine to check mapSet grids
!
! !DESCRIPTION:
!     Local method to check grid arguments in shr\_map\_mapSet
!     \newline
!     call shr\_map\_checkGrids(Xs,Ys,Ms,Xd,Yd,Md,mymap)
!
! !REVISION HISTORY:
!     2005-Mar-27 - T. Craig - first version
!
...
!XXBOP ===========================================================================
!
! !IROUTINE: shr_map_checkWgts -- checks weights
!
! !DESCRIPTION:
!     Checks weights in map for validity
!     \newline
!     call shr\_map\_checkWgts(Ms,Md,mymap)
!
! !REVISION HISTORY:
!     2005-Mar-27 - T. Craig - first version
!
