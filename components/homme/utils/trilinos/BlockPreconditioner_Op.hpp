#ifndef HOMME_BLOCK_PREC_OP_HPP
#define HOMME_BLOCK_PREC_OP_HPP
...
class BlockPreconditioner_Op : public hommePreconditionerBase 
{
public:
  BlockPreconditioner_Op(int np_, int nlev_, int nelemd_, 
