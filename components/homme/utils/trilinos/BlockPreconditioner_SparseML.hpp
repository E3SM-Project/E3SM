#ifndef BLOCKPREC_SPARSEML_HPP
#define BLOCKPREC_SPARSEML_HPP
...
class BlockPreconditioner_SparseML : public SparsePreconditionerBase
{
public:
  BlockPreconditioner_SparseML(const int np_, const int nlev_, const int nelemd_, 
...
private:
  ...
  RCP<ML_Epetra::MultiLevelPreconditioner> MLAsolve;
  ...
  RCP<ML_Epetra::MultiLevelPreconditioner> MLSsolve;
  ...
  RCP<ML_Epetra::MultiLevelPreconditioner> MLPsolve;
