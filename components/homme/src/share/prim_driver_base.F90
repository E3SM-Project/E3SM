...
1000 continue
    ...
    if (single_column) then
      call prim_apply_SC_forcing(elem,hvcoord,tl,3,.false.,nets,nete)
    endif
...
!=======================================================================================================!
  ...
  call noxfinish()
    ...
    subroutine prim_apply_SC_forcing(elem,hvcoord,tl,n,t_before_advance,nets,nete)
! 
    use scamMod, only: single_column
...
!$omp parallel do private(k)
    ...
    end subroutine prim_apply_SC_forcing    
