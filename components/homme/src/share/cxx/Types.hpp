...
// Usual typedef for real scalar type. C data can be
// double or single precision, depending on the build.
...
// F90 data is always double precision
using F90Real = double;
