...
max (const Vector<VectorTag<SIMD<T, SpT>, l> >& a,
     const Vector<VectorTag<SIMD<T, SpT>, l> >& b)
{
...
KOKKOS_INLINE_FUNCTION
Vector<VectorTag<SIMD<T, SpT>, l> >
min (const Vector<VectorTag<SIMD<T, SpT>, l> >& a,
     const Vector<VectorTag<SIMD<T, SpT>, l> >& b)
{
  Vector<VectorTag<SIMD<T, SpT>, l> > r_val;
VECTOR_SIMD_LOOP
...
template <typename T, typename SpT, int l, typename ExpType>
KOKKOS_INLINE_FUNCTION
Vector<VectorTag<SIMD<T, SpT>, l> >
pow (const Vector<VectorTag<SIMD<T,SpT>,l>>& v, const ExpType p)
{
  using VectorType = Vector<VectorTag<SIMD<T,SpT>,l>>;
  VectorType vp;
VECTOR_SIMD_LOOP
...
KOKKOS_INLINE_FUNCTION
Vector<VectorTag<SIMD<T, SpT>, l> >
log (const Vector<VectorTag<SIMD<T,SpT>,l>>& v)
{
  using VectorType = Vector<VectorTag<SIMD<T,SpT>,l>>;
  VectorType vp;
VECTOR_SIMD_LOOP
