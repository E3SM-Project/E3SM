...
10  continue
  ...
  subroutine create_spectral_moab_meshes(par, elem)
use ISO_C_BINDING
    ...
    if(par%masterproc) then
      write (iulog, *) " MOAB: semoab_mod module: create_spectral_moab_meshes  on processor " , par%rank ," nelemd: " , nelemd
    endif
...
!    end copy
  end subroutine create_spectral_moab_meshes
...
!    end copy
  ...
  end subroutine create_moab_pg_mesh 
