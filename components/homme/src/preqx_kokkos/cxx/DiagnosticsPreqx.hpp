#ifndef HOMMEXX_DIAGNOSTICS_PREQX_HPP
#define HOMMEXX_DIAGNOSTICS_PREQX_HPP
...
class DiagnosticsPreqx : public DiagnosticsBase
{
public:
...
#endif // HOMMEXX_DIAGNOSTICS_PREQX_HPP
