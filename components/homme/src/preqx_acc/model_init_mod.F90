...
contains
  ...
  subroutine model_init2( elem , hybrid, deriv ,hvcoord,tl,nets,nete)
    use element_state, only: state_qdp, derived_vn0, derived_divdp, derived_divdp_proj, deriv_dvv, hvcoord_dp0, derived_dpdiss_ave
    ...
    !$acc enter data pcreate(state_Qdp,derived_vn0,derived_divdp,derived_divdp_proj,derived_dpdiss_ave)
