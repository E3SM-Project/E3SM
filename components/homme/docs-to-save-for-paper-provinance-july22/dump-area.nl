...
!  theta_hydrostatic_mode = .true.
  ...
  vert_remap_q_alg  = 10
  moisture          = 'moist'
  ne_x              = 128                       ! number of elements in x-dir
  ne_y              = 4                       ! number of elements in y-dir
  qsize             = 3                         ! num tracer fields
  nmax              = 1                     ! total number of steps: 600s / tstep
...
!  tstep_type        = 5                         ! 1 => default method
  tstep             = 0.1  !!0.016 ran,  20x20x60lev 0.1                       ! dynamics timestep
...
!  hypervis_scaling  = 0.0
  nu                = 0.01 ! 0.216784  !dry ran with 0.01
...
!  bubble_moist=.false.
  ...
  bubble_prec_type=1
bubble_rj_cpdry = .false.
bubble_rj_cpstar_hy = .false.
bubble_rj_cpstar_nh = .false.
bubble_rj_cVstar = .true.
!bubble_rj_nosedim = .true.
/
&vert_nl
...
&analysis_nl
  ...
  output_frequency  = 1000,                        ! steps
  output_varnames1  = 'area'   ! variables to write to file
