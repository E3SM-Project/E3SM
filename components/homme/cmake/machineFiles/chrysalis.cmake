...
EXECUTE_PROCESS(COMMAND which ifx     RESULT_VARIABLE IFX_RESULT)
...
ELSE()
  # Use mpif90/mpicc/mpicxx for oneapi-ifx and gnu compiler
...
ELSEIF (${IFX_RESULT} EQUAL 0)
  SET (ADD_C_FLAGS   "-traceback" CACHE STRING "")
  SET (ADD_CXX_FLAGS "-traceback" CACHE STRING "")

  # Workaround for oneapi ifx v2025.2.0 (and earlier than 2025.3.0):
  # use -mllvm -disable-hir-temp-cleanup to avoid ICE
  # See: argonne-lcf/AuroraBugTracking#64
  SET (ADD_Fortran_FLAGS " -traceback -DCPRINTEL -mllvm -disable-hir-temp-cleanup" CACHE STRING "")

  SET (ADD_LINKER_FLAGS  " -L/gpfs/fs1/soft/chrysalis/spack-latest/opt/spack/linux-rhel8-x86_64/gcc-8.5.0/gcc-11.3.0-jkpmtgq/lib64 -lstdc++" CACHE STRING "")
  SET (BUILD_HOMME_THETA_KOKKOS TRUE CACHE BOOL "")
