...
#not the proper way!!!
SET(MPICH_DIR "$ENV{MPICH_DIR}" CACHE STRING "")
SET(flag1 "$ENV{PE_MPICH_GTL_DIR_amd_gfx90a}" CACHE STRING "")

SET(Extrae_LIBRARY "-I${MPICH_DIR}/include -L${MPICH_DIR}/lib -lmpi ${flag1} -lmpi_gtl_hsa" CACHE STRING "")
