...
export LD_LIBRARY_PATH=/home/onguba/kokkos-build/bld-sycl-aot-may16/lib64/:$LD_LIBRARY_PATH
...
set(KOKKOS_HOME "/home/onguba/kokkos-build/bld-sycl-aot-may16" CACHE STRING "")
...
set(extra "-Wno-deprecated-declarations -fno-finite-math-only -O3 -DNDEBUG -fPIC -fsycl -fno-sycl-id-queries-fit-in-int -fsycl-dead-args-optimization -fsycl-unnamed-lambda -fsycl-targets=spir64_gen -Xsycl-target-backend \"-device 12.60.7\" ")
...
SET(ADD_LINKER_FLAGS "-L${KOKKOS_HOME}/lib64 ${extra2}  -fPIC -Wno-deprecated-declarations -fno-finite-math-only -O3 -DNDEBUG -DKOKKOS_DEPENDENCE -fsycl -fno-sycl-id-queries-fit-in-int -fsycl-dead-args-optimization -fsycl-targets=spir64_gen -Xsycl-target-backend \"-device 12.60.7\" " CACHE STRING "")
