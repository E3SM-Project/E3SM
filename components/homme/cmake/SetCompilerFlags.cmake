...
ELSE ()
  ...
  ELSEIF (CMAKE_Fortran_COMPILER_ID MATCHES "^(Intel|IntelLLVM)$")
    ...
    #ndk was working with only this: SET(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -ftz")
    ...
    # Fixes: remark #8291: Recommended relationship between field width 'W' and the number of fractional digits 'D' in this edit descriptor is 'W>=D+7'.
...
IF (NOT _BUILD_TYPE_UPPER MATCHES "DEBUG")
  IF (OPT_FLAGS)
