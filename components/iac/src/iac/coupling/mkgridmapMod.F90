...
contains
  ...
  subroutine gridmap_mapread(gridmap, fileName)
    ...
    !--- formats ---
    character(*),parameter :: subName = '(gridmap_mapread) '
    character(*),parameter :: F00 = '("(gridmap_mapread) ",4a)'
    character(*),parameter :: F01 = '("(gridmap_mapread) ",2(a,i7))'
...
!==========================================================================
  ...
  subroutine gridmap_areaave_mask (gridmap, src_array, dst_array, mask_src)
