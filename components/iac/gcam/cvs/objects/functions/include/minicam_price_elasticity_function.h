...
#ifndef _MINICAM_PRICE_ELASTICITY_FUNCTION_H_
#define _MINICAM_PRICE_ELASTICITY_FUNCTION_H_
#if defined(_MSC_VER)
#pragma once
#endif

/*! 
 * \file minicam_price_elasticity_function.h
 * \ingroup Objects
 * \brief MinicamPriceElasticityProductionFunction class header file.
 * \author Josh Lurz
 */
...
/*! 
 * \ingroup Objects
 * \brief Defines the a production function which uses coefficients adjusted for
 *        price changes from the base period.
 * \details TODO
 * \author Josh Lurz
 */
class MinicamPriceElasticityFunction : public IFunction {
public:
...
#endif // _MINICAM_PRICE_ELASTICITY_FUNCTION_H_
