...
subroutine modal_aer_opt_init()
  ...
  if (cam_chempkg_is('trop_mam4').or.cam_chempkg_is('trop_mam4_resus').or. &
       ...
       cam_chempkg_is('chemuci_linozv3_mam4_resus_mom_vbs')) then 
   ...
   if(cam_chempkg_is('chemuci_linozv3_mam5_vbs').or.cam_chempkg_is('chemuci_linozv3_mam4_resus_mom_vbs')) then 
