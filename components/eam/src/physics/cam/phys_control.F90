...
subroutine phys_ctl_readnl(nlfile)
   ...
   call mpibcast(micro_do_nccons,                 1 , mpilog,  0, mpicom) !XZ
...
!-----------------------------------------------------------------------
   ...
   logical,           intent(out), optional :: micro_do_nccons_out !! XZ for prescribed CDNC 
   ...
   if ( present(micro_do_nccons_out        ) ) micro_do_nccons_out         = micro_do_nccons  !XZ
