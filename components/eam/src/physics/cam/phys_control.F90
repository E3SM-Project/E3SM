...
integer :: cflx_cpl_opt = 1  ! When to apply surface tracer fluxes
                             ! Default is after tphysac:clubb_surface and before
                             ! aerosol dry removal
...
subroutine phys_ctl_readnl(nlfile)
   ...
   write(iulog,*) '**** phys_ctl_readnl: cflx_cpl_opt = ', cflx_cpl_opt
