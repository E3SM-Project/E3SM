...
logical :: modal_strat_sulfate_ice_nucleation = .false. 
logical :: modal_strat_sulfate_wet_removal = .false. 
...
subroutine phys_ctl_readnl(nlfile)
   ...
   call mpibcast(modal_strat_sulfate_ice_nucleation, 1 , mpilog,  0, mpicom)
   call mpibcast(modal_strat_sulfate_wet_removal, 1 , mpilog,  0, mpicom)
...
! ++MW
                      .or. cam_chempkg_is('trop_strat_mam4_resus_mom') &
! --MW
! kzm ++
                      .or. cam_chempkg_is('linoz_mam7_resus_mom_soag_s') &
                      .or. cam_chempkg_is('trop_strat_mam7_resus_mom_s') &
                      .or. cam_chempkg_is('linoz_mam5_resus_mom_soag') &
                      .or. cam_chempkg_is('trop_strat_mam5_resus_mom_soag') &
! kzm --
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, & 
                       ...
                       ,modal_strat_sulfate_aod_treatment_out,modal_strat_sulfate_ice_nucleation_out &
...
!-----------------------------------------------------------------------
   ...
   logical,           intent(out), optional :: modal_strat_sulfate_ice_nucleation_out
   logical,           intent(out), optional :: modal_strat_sulfate_wet_removal_out
   ...
   if ( present(modal_strat_sulfate_aod_treatment_out      ) ) modal_strat_sulfate_aod_treatment_out &
                                                               = modal_strat_sulfate_aod_treatment
   if ( present(modal_strat_sulfate_ice_nucleation_out      ) ) modal_strat_sulfate_ice_nucleation_out &
                                                               = modal_strat_sulfate_ice_nucleation
   if ( present(modal_strat_sulfate_wet_removal_out      ) ) modal_strat_sulfate_wet_removal_out &
                                                               = modal_strat_sulfate_wet_removal                                                                                                                        
