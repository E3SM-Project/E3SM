...
subroutine zm_param_mpi_broadcast(zm_param)
   ...
   type(zm_param_t), intent(inout) :: zm_param
   !----------------------------------------------------------------------------
   call mpi_bcast(zm_param%tau,               1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%alfa,              1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%ke,                1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%dmpdz,             1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%tpert_fix,         1, mpilog, 0, mpicom)
   call mpi_bcast(zm_param%tpert_fac,         1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%tiedke_add,        1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%c0_lnd,            1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%c0_ocn,            1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%num_cin,           1, mpiint, 0, mpicom)
   call mpi_bcast(zm_param%limcnv,            1, mpiint, 0, mpicom)
   call mpi_bcast(zm_param%mx_bot_lyr_adj,    1, mpiint, 0, mpicom)
   call mpi_bcast(zm_param%trig_dcape,        1, mpilog, 0, mpicom)
   call mpi_bcast(zm_param%trig_ull,          1, mpilog, 0, mpicom)
   call mpi_bcast(zm_param%clos_dyn_adj,      1, mpilog, 0, mpicom)
   call mpi_bcast(zm_param%no_deep_pbl,       1, mpilog, 0, mpicom)
   ! ZM micro parameters
   call mpi_bcast(zm_param%zm_microp,         1, mpilog, 0, mpicom)
   call mpi_bcast(zm_param%auto_fac,          1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%accr_fac,          1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%micro_dcs,         1, mpir8,  0, mpicom)
   ! MCSP parameters
   call mpi_bcast(zm_param%mcsp_enabled,      1, mpilog, 0, mpicom)
   call mpi_bcast(zm_param%mcsp_t_coeff,      1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%mcsp_q_coeff,      1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%mcsp_u_coeff,      1, mpir8,  0, mpicom)
   call mpi_bcast(zm_param%mcsp_v_coeff,      1, mpir8,  0, mpicom)
