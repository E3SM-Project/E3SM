...
subroutine add_fld_default_calls()
  ...
  character(len=20), parameter :: vlist(28) = (/     'topphysbc           '                       ,&
       ...
       'momtran             ','zm_conv_tend        ','UWSHCU              ','conv_shl     ',&
       'pcwdetrain_mac      ','macro_park          ','macrop              ','micro_mg            ',&
       'cldwat_mic          ','ar_wetdep_ma','convtran2           ','cam_radheat         ',&
       'chemistry           ','vdiff               ','ray_frc   ','ar_drydep_ma',&
       'Grav_wave_drag      ','conv_sh_off ','clubb_ice1          ','clubb_det           ',&
