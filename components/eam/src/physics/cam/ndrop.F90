...
public ndrop_init, dropmixnuc, activate_modal, so4_cdnc, lnd_ocean_cdnc  ! XZ
...
subroutine lnd_ocean_cdnc(landfrac,ncnst_land,ncnst_ocean,cdncst)
        ...
        cdncst = 0._r8
        do i=1,pcols
          cdncst(i,:)= (ncnst_ocean * (1._r8-landfrac(i)) +   ncnst_land * landfrac(i))
        enddo

end subroutine lnd_ocean_cdnc 
