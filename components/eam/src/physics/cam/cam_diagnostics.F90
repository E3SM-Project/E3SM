...
subroutine diag_init()
  ...
  ! Declare the history fields for which this module contains outfld calls.
   ...
   call addfld ('DTENDTTW',horiz_only, 'A', 'kg/m2/s','Dynamic Tendency of Total (vertically integrated) total water (Q+CLDLIQ+CLDICE+RAINQM)')
   ...
   call addfld ('PRECST',horiz_only,    'A','m/s','Total (convective and large-scale) snow rate (water equivalent)'    )
