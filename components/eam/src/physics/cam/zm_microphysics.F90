              ...
              if (t(i,k).lt.tmelt ) then
                 ...
                 if (aero%scheme == 'modal') then          
                    ...
                    dmc   = 0.5_r8*(aero%mmrg_a(i,k-1,aero%coarse_dust_idx,aero%mode_coarse_idx)    &
                                   ...
                                   +aero%mmrg_a(i,k-1,aero%coarse_ca_idx,aero%mode_coarse_idx)      &
                                   +aero%mmrg_a(i,k,aero%coarse_ca_idx,aero%mode_coarse_idx)        &
                                   +aero%mmrg_a(i,k-1,aero%coarse_co3_idx,aero%mode_coarse_idx)     &
                                   +aero%mmrg_a(i,k,aero%coarse_co3_idx,aero%mode_coarse_idx))
                    ...
                    ssmc  = 0.5_r8*(aero%mmrg_a(i,k-1,aero%coarse_nacl_idx,aero%mode_coarse_idx)    &
                                   ...
                                   +aero%mmrg_a(i,k-1,aero%coarse_cl_idx,aero%mode_coarse_idx)      &
                                   +aero%mmrg_a(i,k,aero%coarse_cl_idx,aero%mode_coarse_idx))

                    nh4mc = 0.5_r8*(aero%mmrg_a(i,k-1,aero%coarse_nh4_idx,aero%mode_coarse_idx)     &
                                   +aero%mmrg_a(i,k,aero%coarse_nh4_idx,aero%mode_coarse_idx))

                    no3mc = 0.5_r8*(aero%mmrg_a(i,k-1,aero%coarse_no3_idx,aero%mode_coarse_idx)     &
                                   +aero%mmrg_a(i,k,aero%coarse_no3_idx,aero%mode_coarse_idx))
