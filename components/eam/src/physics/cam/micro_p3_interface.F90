...
!!== KZ_DCS
   ...
   ! Self-Coll output
   call addfld('P3_selfcoll_TblVal',   (/ 'lev' /), 'A', 'none', 'Self-coll tabular normalized value Q/N')
   call addfld('P3_selfcoll_eii',      (/ 'lev' /), 'A', 'unitless', 'Self-coll collection efficiency')
   call addfld('P3_selfcoll_Eii_fact', (/ 'lev' /), 'A', 'unitless', 'Self-coll coalescence efficiency by riming')
   call addfld('P3_selfcoll_rhofact',  (/ 'lev' /), 'A', 'unitless', 'Self-coll density scale factor')
   call addfld('P3_selfcoll_ni_incld', (/ 'lev' /), 'A', '#/kg', 'Self-coll ice in-cld number concentration ')
   call addfld('P3_ice_eff_radius',    (/ 'lev' /), 'A', 'um',   'Ice effective radius in-cld ')
   call addfld('P3_selfcoll_eii_I',    (/ 'lev' /), 'I', 'unitless', 'Instanteous Self-coll collection efficiency')
   ...
   if (history_amwg) then
      ...
      if (micro_tend_output) then
         ...
         ! Self-Coll output
         !call add_default('P3_selfcoll_TblVal',   1, ' ')
         !call add_default('P3_selfcoll_eii',      1, ' ')
         !call add_default('P3_selfcoll_Eii_fact', 1, ' ')
         !call add_default('P3_selfcoll_rhofact',  1, ' ')
         !call add_default('P3_selfcoll_ni_incld', 1, ' ')
         !call add_default('P3_ice_eff_radius',    1, ' ')
         !call add_default('P3_selfcoll_eii_I',    1, ' ')
