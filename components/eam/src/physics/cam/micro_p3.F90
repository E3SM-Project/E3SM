...
!       mu_r = real(ii-1)  ! values of mu
  ...
  SUBROUTINE p3_main_part1(kts, kte, kbot, ktop, kdir, do_predict_nc, do_prescribed_CCN, dt,                &
       ...
       nc_incld, nr_incld, ni_incld, bm_incld, is_nucleat_possible, is_hydromet_present, p3_tend_out)
...
!    real(rtype) :: qcevp   ! cloud droplet evaporation
    ...
    real(rtype) :: ncheti_cnt,qcheti_cnt,nicnt,qicnt,ninuc_cnt,qinuc_cnt     
...
444   continue
      ...
      call ice_supersat_conservation(qidep, qinuc, qinuc_cnt, cld_frac_i(k), qv(k), qv_sat_i(k), latent_heat_sublim(k), th_atm(k)/exner(k), dt)
...
!      endif
       ...
       !................................................................
       ! Adding instantenous melting of ice/snow at T = t_snow_melt = 2c    
...
subroutine ice_supersat_conservation(qidep,qinuc,qinuc_cnt,cld_frac_i,qv,qv_sat_i,latent_heat_sublim,T_atm,dt)
