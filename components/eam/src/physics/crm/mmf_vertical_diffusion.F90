...
module mmf_vertical_diffusion
  ...
  !-----------------------------------------------------------------------------
  public vd_readnl
  public mmf_vertical_diffusion_register                     ! Register multi-time-level variables with physics buffer
  public mmf_vertical_diffusion_init     ! Initialization
  public mmf_vertical_diffusion_ts_init  ! Time step initialization (only used for upper boundary condition)
  public mmf_vertical_diffusion_tend     ! Full vertical diffusion routine
...
subroutine mmf_vertical_diffusion_register()
...
end subroutine mmf_vertical_diffusion_register

!===============================================================================
!===============================================================================

subroutine mmf_vertical_diffusion_init(pbuf2d)
  !-----------------------------------------------------------------------------
  ...
  use mmf_hb_diff,       only : init_mmf_hb_diff
  ...
  call init_mmf_hb_diff(gravit, cpair, ntop_eddy, nbot_eddy, pref_mid, karman)
...
end subroutine mmf_vertical_diffusion_init

!===============================================================================
!===============================================================================

subroutine mmf_vertical_diffusion_ts_init( pbuf2d, state )
  !-----------------------------------------------------------------------------
...
end subroutine mmf_vertical_diffusion_ts_init

!===============================================================================
!===============================================================================

subroutine mmf_vertical_diffusion_tend( ztodt    , state    ,                  &
  ...
  use mmf_hb_diff,        only : compute_mmf_hb_diff
  ...
  call compute_mmf_hb_diff( lchnk     , ncol     ,                            &
  ...
  !-----------------------------------------------------------------------------
  return
end subroutine mmf_vertical_diffusion_tend

!===============================================================================
!===============================================================================

end module mmf_vertical_diffusion
