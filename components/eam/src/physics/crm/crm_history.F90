...
subroutine crm_history_init(species_class)
   ...
   call add_default('MMF_QTTR  ', 1, ' ')
   call add_default('MMF_QPTR  ', 1, ' ')
   call add_default('MMF_QPEVP ', 1, ' ')
   call add_default('MMF_QPFALL', 1, ' ')
   call add_default('MMF_QPSRC ', 1, ' ')
