...
subroutine crm_history_init(species_class)
   ...
   call addfld('MMF_MCUP2',  (/'lev'/), 'A','kg/m2/s','Updraft mass flux from CRM' )
...
subroutine crm_history_out(state, ptend, crm_state, crm_rad, crm_output, & 
   ...
   call outfld('MMF_MCUP2 ', crm_output%mcup_alt  (icol_beg:icol_end,:), ncol, lchnk )
