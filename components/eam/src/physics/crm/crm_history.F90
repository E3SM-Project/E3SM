...
subroutine crm_history_init(species_class)
   ...
   call addfld('MMF_TKEB',   (/'lev'/), 'A','kg/m/s2','buoyancy flux, wb')
   call addfld('MMF_TKEQC',   (/'lev'/), 'A','kg/m/s2','liquid water flux')
   call addfld('MMF_TKEQT',   (/'lev'/), 'A','kg/m/s2','total water flux')
...
subroutine crm_history_out(state, ptend, crm_state, crm_rad, crm_output, & 
   ...
   call outfld('MMF_TKEB  ',crm_output%tkeb      (icol_beg:icol_end,:), ncol, lchnk )
   call outfld('MMF_TKEQC  ',crm_output%tkeqc    (icol_beg:icol_end,:), ncol, lchnk )
   call outfld('MMF_TKEQT  ',crm_output%tkeqt    (icol_beg:icol_end,:), ncol, lchnk )
