...
subroutine crm(lchnk, ncrms, dt_gl, plev,       &
    ...
    do icrm = 1 , ncrms
      ...
      if (rand_num < rand_thresh) then
        call dmdf_write(dt_gl                                 ,myrank,'crmdata_3d_bug',trim('dt_gl              ')                                           ,.true. ,.false.)
        call dmdf_write(latitude0                 (icrm)      ,myrank,'crmdata_3d_bug',trim('latitude0          ')                                           ,.false.,.false.)
        call dmdf_write(longitude0                (icrm)      ,myrank,'crmdata_3d_bug',trim('longitude0         ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%zmid            (icrm,:)    ,myrank,'crmdata_3d_bug',trim('in_zmid            '),(/'nlev  '/)                              ,.false.,.false.)
        call dmdf_write(crm_input%zint            (icrm,:)    ,myrank,'crmdata_3d_bug',trim('in_zint            '),(/'nlevp1'/)                              ,.false.,.false.)
        call dmdf_write(crm_input%tl              (icrm,:)    ,myrank,'crmdata_3d_bug',trim('in_tl              '),(/'nlev  '/)                              ,.false.,.false.)
        ...
        call dmdf_write(crm_input%phis            (icrm)      ,myrank,'crmdata_3d_bug',trim('in_phis            ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%ul              (icrm,:)    ,myrank,'crmdata_3d_bug',trim('in_ul              '),(/'nlev  '/)                              ,.false.,.false.)
        call dmdf_write(crm_input%vl              (icrm,:)    ,myrank,'crmdata_3d_bug',trim('in_vl              '),(/'nlev  '/)                              ,.false.,.false.)
        call dmdf_write(crm_input%ocnfrac         (icrm)      ,myrank,'crmdata_3d_bug',trim('in_ocnfrac         ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%tau00           (icrm)      ,myrank,'crmdata_3d_bug',trim('in_tau00           ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%wndls           (icrm)      ,myrank,'crmdata_3d_bug',trim('in_wndls           ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%bflxls          (icrm)      ,myrank,'crmdata_3d_bug',trim('in_bflxls          ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%fluxu00         (icrm)      ,myrank,'crmdata_3d_bug',trim('in_fluxu00         ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%fluxv00         (icrm)      ,myrank,'crmdata_3d_bug',trim('in_fluxv00         ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%fluxt00         (icrm)      ,myrank,'crmdata_3d_bug',trim('in_fluxt00         ')                                           ,.false.,.false.)
        call dmdf_write(crm_input%fluxq00         (icrm)      ,myrank,'crmdata_3d_bug',trim('in_fluxq00         ')                                           ,.false.,.false.)
        call dmdf_write(crm_state%u_wind          (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('state_u_wind       '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_state%v_wind          (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('state_v_wind       '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_state%w_wind          (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('state_w_wind       '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_state%temperature     (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('state_temperature  '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_state%qt              (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('state_qt           '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.) 
        call dmdf_write(crm_state%qp              (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('state_qp           '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_state%qn              (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('state_qn           '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%qcl            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_qcl            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%qci            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_qci            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%qpl            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_qpl            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%qpi            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_qpi            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%tk             (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_tk             '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%tkh            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_tkh            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%prec_crm       (icrm,:,:)  ,myrank,'crmdata_3d_bug',trim('out_prec_crm       '),(/'crm_nx','crm_ny'/)                     ,.false.,.false.)
        call dmdf_write(crm_output%wvar           (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_wvar           '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%aut            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_aut            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%acc            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_acc            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%evpc           (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_evpc           '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%evpr           (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_evpr           '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%mlt            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_mlt            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%sub            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_sub            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%dep            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_dep            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%con            (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('out_con            '),(/'crm_nx','crm_ny','crm_nz'/)            ,.false.,.false.)
        call dmdf_write(crm_output%cltot          (icrm)      ,myrank,'crmdata_3d_bug',trim('out_cltot          ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%cllow          (icrm)      ,myrank,'crmdata_3d_bug',trim('out_cllow          ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%clmed          (icrm)      ,myrank,'crmdata_3d_bug',trim('out_clmed          ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%clhgh          (icrm)      ,myrank,'crmdata_3d_bug',trim('out_clhgh          ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%precc          (icrm)      ,myrank,'crmdata_3d_bug',trim('out_precc          ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%precl          (icrm)      ,myrank,'crmdata_3d_bug',trim('out_precl          ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%precsc         (icrm)      ,myrank,'crmdata_3d_bug',trim('out_precsc         ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%precsl         (icrm)      ,myrank,'crmdata_3d_bug',trim('out_precsl         ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%cldtop         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_cldtop         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qc_mean        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qc_mean        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qi_mean        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qi_mean        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qs_mean        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qs_mean        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qg_mean        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qg_mean        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qr_mean        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qr_mean        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%sltend         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_sltend         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qltend         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qltend         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qcltend        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qcltend        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qiltend        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qiltend        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%cld            (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_cld            '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%gicewp         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_gicewp         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%gliqwp         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_gliqwp         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%mctot          (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_mctot          '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%mcup           (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_mcup           '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%mcdn           (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_mcdn           '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%mcuup          (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_mcuup          '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%mcudn          (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_mcudn          '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%mu_crm         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_mu_crm         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%md_crm         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_md_crm         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%du_crm         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_du_crm         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%eu_crm         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_eu_crm         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%ed_crm         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_ed_crm         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%jt_crm         (icrm)      ,myrank,'crmdata_3d_bug',trim('out_jt_crm         ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%mx_crm         (icrm)      ,myrank,'crmdata_3d_bug',trim('out_mx_crm         ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%flux_qt        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_flux_qt        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%fluxsgs_qt     (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_fluxsgs_qt     '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%tkez           (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_tkez           '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%tkew           (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_tkew           '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%tkesgsz        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_tkesgsz        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%tkz            (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_tkz            '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%flux_u         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_flux_u         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%flux_v         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_flux_v         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%flux_qp        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_flux_qp        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%precflux       (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_precflux       '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qt_ls          (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qt_ls          '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qt_trans       (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qt_trans       '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qp_trans       (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qp_trans       '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qp_fall        (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qp_fall        '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qp_src         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qp_src         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%qp_evp         (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_qp_evp         '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%t_ls           (icrm,:)    ,myrank,'crmdata_3d_bug',trim('out_t_ls           '),(/'nlev'/)                                ,.false.,.false.)
        call dmdf_write(crm_output%prectend       (icrm)      ,myrank,'crmdata_3d_bug',trim('out_prectend       ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%precstend      (icrm)      ,myrank,'crmdata_3d_bug',trim('out_precstend      ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%taux           (icrm)      ,myrank,'crmdata_3d_bug',trim('out_taux           ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%tauy           (icrm)      ,myrank,'crmdata_3d_bug',trim('out_tauy           ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%z0m            (icrm)      ,myrank,'crmdata_3d_bug',trim('out_z0m            ')                                           ,.false.,.false.)
        call dmdf_write(crm_output%subcycle_factor(icrm)      ,myrank,'crmdata_3d_bug',trim('out_subcycle_factor')                                           ,.false.,.false.)
        call dmdf_write(crm_rad%qrad              (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('rad_qrad           '),(/'crm_nx_rad','crm_ny_rad','crm_nz    '/),.false.,.false.)
        call dmdf_write(crm_rad%temperature       (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('rad_temperature    '),(/'crm_nx_rad','crm_ny_rad','crm_nz    '/),.false.,.false.)
        call dmdf_write(crm_rad%qv                (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('rad_qv             '),(/'crm_nx_rad','crm_ny_rad','crm_nz    '/),.false.,.false.)
        call dmdf_write(crm_rad%qc                (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('rad_qc             '),(/'crm_nx_rad','crm_ny_rad','crm_nz    '/),.false.,.false.)
        call dmdf_write(crm_rad%qi                (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('rad_qi             '),(/'crm_nx_rad','crm_ny_rad','crm_nz    '/),.false.,.false.)
        call dmdf_write(crm_rad%cld               (icrm,:,:,:),myrank,'crmdata_3d_bug',trim('rad_cld            '),(/'crm_nx_rad','crm_ny_rad','crm_nz    '/),.false.,.true.)
      endif
    enddo
