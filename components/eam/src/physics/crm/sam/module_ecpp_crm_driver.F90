...
subroutine ecpp_crm_init(ncrms,dt_gl)
  ...
  !-----------------------------------------------------------------------------
  do icrm = 1 , ncrms
    call zero_out_sums1( qcloudsum1(:,:,:,icrm), &
                         qcloud_bfsum1(:,:,:,icrm), &
                         qrainsum1(:,:,:,icrm), &
                         qicesum1(:,:,:,icrm), &
                         qsnowsum1(:,:,:,icrm), &
    ...
    call zero_out_sums2( xkhvsum(:,icrm), &
                         wwqui_cen_sum(:,icrm), &
                         wwqui_bnd_sum(:,icrm), &
                         wwqui_cloudy_cen_sum(:,icrm), &
                         wwqui_cloudy_bnd_sum(:,icrm),  &
                         area_bnd_final(:,:,1:1+nup+ndn,:,icrm), &
                         area_bnd_sum(:,:,1:1+nup+ndn,:,icrm), &
                         area_cen_final(:,:,1:1+nup+ndn,:,icrm), &
                         area_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         mass_bnd_final(:,:,1:1+nup+ndn,:,icrm), &
                         mass_bnd_sum(:,:,1:1+nup+ndn,:,icrm), &
                         mass_cen_final(:,:,1:1+nup+ndn,:,icrm), &
                         mass_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         ent_bnd_sum(:,:,1:1+nup+ndn,:,icrm), &
                         rh_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qcloud_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qcloud_bf_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qrain_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qice_cen_sum(:,:,1:1+nup+ndn,:,icrm),  &
                         qsnow_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qgraup_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qlsink_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         precr_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         precsolid_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         precall_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qlsink_bf_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
                         qlsink_avg_cen_sum(:,:,1:1+nup+ndn,:,icrm), &
...
subroutine ecpp_crm_stat(ncrms)
  !-----------------------------------------------------------------------------
  ! Primary driver for collecting statistics used for ECPP
  !-----------------------------------------------------------------------------
