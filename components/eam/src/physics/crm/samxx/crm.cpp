...
extern "C" void crm(int ncrms_in, int pcols_in, real dt_gl, int plev, real *crm_input_bflxls_p, 
                    ...
                    real *crm_output_fluxsgs_qt_p, real *crm_output_tkez_p, real *crm_output_tkew_p, real *crm_output_tkeqc_p, real *crm_output_tkeqt_p, real *crm_output_tkeb_p, real *crm_output_tkesgsz_p, 
                    ...
                    real *crm_output_t_vt_tend_p, real *crm_output_q_vt_tend_p, real *crm_output_u_vt_tend_p,real *crm_output_bou_ls_p,
                    ...
                    real *crm_output_qci_p, real *crm_output_qpl_p, real *crm_output_qpi_p, real *crm_output_bou_p,
  ...
  copy_outputs(crm_state_u_wind_p, crm_state_v_wind_p, crm_state_w_wind_p, crm_state_temperature_p, 
               ...
               crm_output_fluxsgs_qt_p, crm_output_tkez_p, crm_output_tkew_p, crm_output_tkeqc_p, crm_output_tkeqt_p, crm_output_tkeb_p, crm_output_tkesgsz_p, crm_output_tkz_p, 
               ...
               crm_output_u_vt_tend_p, crm_output_bou_ls_p, crm_output_u_vt_ls_p,
#ifdef MMF_MOMENTUM_FEEDBACK
               crm_output_ultend_p, crm_output_vltend_p,
#endif
               crm_output_tk_p, crm_output_tkh_p, 
               crm_output_qcl_p, crm_output_qci_p, crm_output_qpl_p, crm_output_qpi_p, crm_output_bou_p,
  ...
  copy_outputs_and_destroy(crm_state_u_wind_p, crm_state_v_wind_p, crm_state_w_wind_p, crm_state_temperature_p, 
                           ...
                           crm_output_cltot_p, crm_output_clhgh_p, crm_output_clmed_p, crm_output_cllow_p, 
                           crm_output_sltend_p, crm_output_qltend_p, crm_output_qcltend_p, crm_output_qiltend_p, 
                           crm_output_t_vt_tend_p, crm_output_q_vt_tend_p, crm_output_u_vt_tend_p,crm_output_bou_ls_p,
