...
extern "C" void crm(int ncrms_in, int pcols_in, real dt_gl, int plev,
                    ...
                    real *crm_rad_qrad_p, real *crm_rad_temperature_p,
                    real *crm_rad_qv_p, real *crm_rad_qc_p, real *crm_rad_qi_p,
                    real *crm_rad_cld_p, real *crm_rad_nc_p, real *crm_rad_ni_p,
                    ...
                    real *crm_output_mu_crm_p, real *crm_output_md_crm_p,
                    real *crm_output_eu_crm_p, real *crm_output_du_crm_p, real *crm_output_ed_crm_p,
                    ...
                    real *crm_output_flux_qp_p, real *crm_output_precflux_p, real *crm_output_qt_trans_p, real *crm_output_qp_trans_p,
                    real *crm_output_qp_fall_p, real *crm_output_qp_evp_p, real *crm_output_qp_src_p, real *crm_output_qt_ls_p,
                    real *crm_output_t_ls_p, real *crm_output_jt_crm_p, real *crm_output_mx_crm_p, real *crm_output_cltot_p,
                    ...
                    char* microphysics_scheme_in, char* turbulence_scheme_in,
  ...
  create_and_copy_inputs(crm_input_bflxls_p, crm_input_wndls_p,
                         ...
                         crm_input_nccn_p, crm_input_nc_nuceat_tend_p, crm_input_ni_activated_p,
                         crm_state_u_wind_p, crm_state_v_wind_p, crm_state_w_wind_p,
                         crm_state_temperature_p, crm_state_qv_p, crm_state_qp_p, crm_state_qn_p,
                         crm_state_qc_p, crm_state_nc_p, crm_state_qr_p, crm_state_nr_p,
                         crm_state_qi_p, crm_state_ni_p, crm_state_qm_p, crm_state_bm_p,
                         crm_state_t_prev_p, crm_state_q_prev_p,
  ...
  copy_outputs(crm_state_u_wind_p, crm_state_v_wind_p, crm_state_w_wind_p, crm_state_temperature_p, 
               crm_state_qv_p, crm_state_qp_p, crm_state_qn_p, 
               crm_state_qc_p, crm_state_nc_p, crm_state_qr_p, crm_state_nr_p, 
               crm_state_qi_p, crm_state_ni_p, crm_state_qm_p, crm_state_bm_p,
               crm_state_t_prev_p, crm_state_q_prev_p,
               crm_rad_temperature_p, crm_rad_qv_p, crm_rad_qc_p, 
               crm_rad_qi_p, crm_rad_cld_p, crm_rad_nc_p, crm_rad_ni_p,
               crm_output_subcycle_factor_p,
               crm_output_cld_p, crm_output_cldtop_p,
