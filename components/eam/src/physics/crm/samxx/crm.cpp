...
extern "C" void crm(int ncrms_in, int pcols_in, real dt_gl, int plev, real *crm_input_bflxls_p, 
                    ...
                    real *crm_output_fluxsgs_qt_p, real *crm_output_tkez_p, real *crm_output_wtke_p, real *crm_output_tkesgsz_p, 
  ...
  copy_outputs(crm_state_u_wind_p, crm_state_v_wind_p, crm_state_w_wind_p, crm_state_temperature_p, 
               ...
               crm_output_fluxsgs_qt_p, crm_output_tkez_p, crm_output_wtke_p, crm_output_tkesgsz_p, crm_output_tkz_p, 
