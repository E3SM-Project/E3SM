...
module cpp_interface_mod
  ...
  interface
    ...
    subroutine crm(ncrms_in, pcols_in, dt_gl, plev, &
                   ...
                   crm_state_temperature, crm_state_qv, crm_state_qp, crm_state_qn, &
                   ...
                   crm_rad_qv, crm_rad_qc, crm_rad_qi, &
                   crm_rad_cld, crm_rad_nc, crm_rad_ni, &
                   crm_output_subcycle_factor, &
                   crm_output_cld, crm_output_cldtop, crm_output_gicewp, crm_output_gliqwp, &
                   crm_output_mctot, crm_output_mcup, crm_output_mcdn, &
                   crm_output_mcuup, crm_output_mcudn, &
                   crm_output_qc_mean, crm_output_qi_mean, &
                   crm_output_qs_mean, crm_output_qg_mean, crm_output_qr_mean, &
                   crm_output_nc_mean, crm_output_ni_mean, &
                   crm_output_mu_crm, crm_output_md_crm, &
                   crm_output_eu_crm, crm_output_du_crm, crm_output_ed_crm, &
