...
// Enable hyperdiffusion in SGS_TKE to limit grid-scale "noise" in 
...
// bool constexpr doMomentumHyperviscosity   = true;
// #else
// bool constexpr doMomentumHyperviscosity   = false;
// #endif
