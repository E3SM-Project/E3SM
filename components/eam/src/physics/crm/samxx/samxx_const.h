...
#else
real constexpr qcw0 = 1.e-3;    // ice autoconversion threshold
#endif

#ifdef MMF_QCI
real constexpr qci0 = MMF_QCI;
#else
real constexpr qci0 = 1.e-4;    // liq autoconversion threshold
#endif

#ifdef MMF_VTM
real constexpr vtice_min = MMF_VTM;
#else
real constexpr vtice_min = 0.4; // min ice fall velocity
#endif
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
