...
subroutine parampollu_1clm_set_opts(         &
  ...
  ! subr arguments
  integer, intent(in) :: xppopt_updn_prof_aa
  integer, intent(in) :: xppopt_quiescn_mf
  integer, intent(in) :: xppopt_quiescn_sosi
  integer, intent(in) :: xppopt_chemtend_wq
  integer, intent(in) :: xppopt_chemtend_dtsub
  integer, intent(in) :: xppopt_chemtend_updnfreq
