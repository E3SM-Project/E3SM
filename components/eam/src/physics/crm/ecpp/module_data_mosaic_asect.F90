module module_data_mosaic_asect
  ...
  !
  !-----------------------------------------------------------------------------
  ! dens_aer(c,t) = dry density (g/cm^3) of aerosol chemical component c of type t
  ...
  integer, allocatable :: nsize_aer (:)         ! number of size bins
  integer, allocatable :: ncomp_aer (:)         ! number of chemical components
  integer, allocatable :: massptr_aer(:,:,:,:)  ! index for mixing ratio
  integer, allocatable :: numptr_aer(:,:,:)     ! index for the number mixing ratio
  ...
  real, allocatable :: volumhi_sect(:,:)
  real, allocatable :: volumlo_sect(:,:)
  real, allocatable :: dcen_sect(:,:)
  real, allocatable :: dlo_sect(:,:)
  real, allocatable :: dhi_sect(:,:) 
