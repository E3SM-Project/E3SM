  ...
  Int nk)
{
  ...
  Kokkos::parallel_for(
    ...
    p3_main_part2(
      ...
      lookup_tables.dnu_table_vals, lookup_tables.ice_table_vals, lookup_tables.collect_table_vals, lookup_tables.revap_table_vals,
      opres, odpres, odz, onc_nuceat_tend, oinv_exner,
    ...
    rain_sedimentation(
      ...
      nk, ktop, kbot, kdir, infrastructure.dt, inv_dt, oqr,
