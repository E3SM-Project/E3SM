...
!-----------------------------------------------------------------------
    ...
    do i=1,stats_rad_zt%num_output_fields
      ...
      case ('T_in_K_rad')
        ...
        call stat_assign( var_index=iT_in_K_rad, var_name="T_in_K_rad", & ! intent(in)
      ...
      case ('rcil_rad')
        ...
        call stat_assign( var_index=ircil_rad, var_name="rcil_rad", & ! intent(in)
      ...
      case ('o3l_rad')
        ...
        call stat_assign( var_index=io3l_rad, var_name="o3l_rad", & ! intent(in)
      ...
      case ('rsm_rad')
        ...
        call stat_assign( var_index=irsm_rad, var_name="rsm_rad", & ! intent(in)
      ...
      case ('rcm_in_cloud_rad')
        ...
        call stat_assign( var_index=ircm_in_cloud_rad, var_name="rcm_in_cloud_rad", & ! intent(in)
      ...
      case ('cloud_frac_rad')
        ...
        call stat_assign( var_index=icloud_frac_rad, var_name="cloud_frac_rad", & ! intent(in)
      ...
      case ('ice_supersat_frac_rad')
        ...
        call stat_assign( var_index=iice_supersat_frac_rad, var_name="ice_supersat_frac_rad", & !In
      ...
      case ('radht_rad')
        ...
        call stat_assign( var_index=iradht_rad, var_name="radht_rad", & ! intent(in)
      ...
      case ('radht_LW_rad')
        ...
        call stat_assign( var_index=iradht_LW_rad, var_name="radht_LW_rad", & ! intent(in)
      ...
      case ('radht_SW_rad')
        ...
        call stat_assign( var_index=iradht_SW_rad, var_name="radht_SW_rad", & ! intent(in)
      ...
      case ('p_in_mb_rad')
        ...
        call stat_assign( var_index=ip_in_mb_rad, var_name="p_in_mb_rad", & ! intent(in)
      ...
      case ('sp_humidity_rad')
        ...
        call stat_assign( var_index=isp_humidity_rad, var_name="sp_humidity_rad", & ! intent(in)
