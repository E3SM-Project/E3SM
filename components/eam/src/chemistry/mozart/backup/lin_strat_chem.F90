...
module lin_strat_chem
  ...
  !
  public :: lin_strat_chem_inti, lin_strat_chem_solve, lin_strat_sfcsink,linv3_strat_chem_solve
...
! three parameters are applied to Linoz O3 for surface sink, O3l is not coupled to real O3
 ...
 !
   ...
   subroutine linv3_strat_sfcsink( ncol, lchnk, x_vmr, x_sfc, delta_t, pdel)
...
! loss in kg/m2 summed over boundary layers within one time step   
  ...
  end subroutine linv3_strat_sfcsink
