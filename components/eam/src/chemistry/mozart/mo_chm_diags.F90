    ...
    do m = 1,gas_pcnst
       ...
       if ( any( aer_species == m ) ) then
          ...
          if (history_gaschmbudget_2D_levels) then
             ...
             call addfld( trim(spc_name)//'_2DCMP_L1', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry production rate from top-of-model to 90 hPa')
             call addfld( trim(spc_name)//'_2DCML_L1', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from top-of-model to 90 hPa')
             ...
             call addfld( trim(spc_name)//'_2DCMP_L2', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry production rate from 90 to 300 hPa')
             call addfld( trim(spc_name)//'_2DCML_L2', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from 90 to 300 hPa')
             ...
             call addfld( trim(spc_name)//'_2DCMP_L3', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry prodction rate from 300 to 850 hPa')
             call addfld( trim(spc_name)//'_2DCML_L3', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from 300 to 850 hPa')
             ...
             call addfld( trim(spc_name)//'_2DCMP_L4', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry production rate from 850 hPa to surface')
             call addfld( trim(spc_name)//'_2DCML_L4', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from 850 hPa to surface')
