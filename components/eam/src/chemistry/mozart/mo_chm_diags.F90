    ...
    do m = 1,gas_pcnst
       ...
       if ( any( aer_species == m ) ) then
          ...
          if (history_gaschmbudget) then
             ...
             call addfld( trim(spc_name)//'_CMP', (/ 'lev' /), 'I', 'kg/m2', trim(attr)//' explicit chemisty production')
             call addfld( trim(spc_name)//'_CML', (/ 'lev' /), 'I', 'kg/m2', trim(attr)//' explicit chemisty loss')
          ...
          if (history_gaschmbudget_2D) then
             ...
             call addfld( trim(spc_name)//'_2DCMP', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated explicit chemistry production rate')
             call addfld( trim(spc_name)//'_2DCML', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated explicit chemistry loss rate')
          ...
          if (history_gaschmbudget_2D_levels) then
             ...
             call addfld( trim(spc_name)//'_2DCMP_L1', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry production rate from top-of-model to 100 hPa')
             call addfld( trim(spc_name)//'_2DCML_L1', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from top-of-model to 100 hPa')
             ...
             call addfld( trim(spc_name)//'_2DCMP_L2', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry production rate from 100 to 267 hPa')
             call addfld( trim(spc_name)//'_2DCML_L2', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from 100 to 267 hPa')
             ...
             call addfld( trim(spc_name)//'_2DCMP_L3', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry prodction rate from 267 to 856 hPa')
             call addfld( trim(spc_name)//'_2DCML_L3', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from 267 to 856 hPa')
             ...
             call addfld( trim(spc_name)//'_2DCMP_L4', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry production rate from 856 hPa to surface')
             call addfld( trim(spc_name)//'_2DCML_L4', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate from 856 hPa to surface')
             ...
             call addfld( trim(spc_name)//'_2DCMP_trop', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry production rate in troposphere')
             call addfld( trim(spc_name)//'_2DCML_trop', horiz_only, 'A', 'kg/m2/s', trim(attr)//' vertically integrated chemistry loss rate in troposphere')
       ...
       if ((m /= id_cly) .and. (m /= id_bry)) then
          ...
          if ( .not. any( aer_species == m ) ) then
             if (history_gaschmbudget) then
                ...
                call add_default( trim(spc_name)//'_CMP', 2, ' ' )
                call add_default( trim(spc_name)//'_CML', 2, ' ' )
             ...
             if (history_gaschmbudget_2D) then
                ...
                call add_default( trim(spc_name)//'_2DCMP', 1, ' ' )
                call add_default( trim(spc_name)//'_2DCML', 1, ' ' )
             ...
             if (history_gaschmbudget_2D_levels) then
                ...
                call add_default( trim(spc_name)//'_2DCMP_L1', 1, ' ' )
                call add_default( trim(spc_name)//'_2DCML_L1', 1, ' ' )
                ...
                call add_default( trim(spc_name)//'_2DCMP_L2', 1, ' ' )
                call add_default( trim(spc_name)//'_2DCML_L2', 1, ' ' )
                ...
                call add_default( trim(spc_name)//'_2DCMP_L3', 1, ' ' )
                call add_default( trim(spc_name)//'_2DCML_L3', 1, ' ' )
                ...
                call add_default( trim(spc_name)//'_2DCMP_L4', 1, ' ' )
                call add_default( trim(spc_name)//'_2DCML_L4', 1, ' ' )
    ...
    do m = 1,gas_pcnst
       ...
       if ( .not. any( aer_species == m ) .and. adv_mass(m) /= 0._r8 ) then
          if (flag(1:2) .ne. '2D') then
            ...
            if (flag(1:4)=='2DMS' .or. flag(1:4)=='2DCM') then
               ! kg/m2
               wrk(:ncol,:) = adv_mass(m)*vmr(:ncol,:,m)/mbar(:ncol,:) &
                                *pdeldry(:ncol,:)*rgrav
            else
