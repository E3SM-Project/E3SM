...
module dust_model 
  ...
  character(len=6), parameter :: dust_names(dust_nbin+dust_nnum) = (/ 'dst_a2', 'dst_a1', 'dst_a3', &
                                                                      'ca_a2 ', 'ca_a1 ', 'ca_a3 ', &
                                                                      'co3_a2', 'co3_a1', 'co3_a3', &
                                                                      'num_a2', 'num_a1', 'num_a3' /)
  real(r8),         parameter :: dust_dmt_grd(4) = (/ 0.01e-6_r8, 0.1e-6_r8, 1.0e-6_r8, 10.0e-6_r8/)
  real(r8),         parameter :: dust_emis_sclfctr(dust_nbin) = (/ 1.65E-05_r8, 0.011_r8, 0.989_r8, &
                                                                   1.65E-05_r8, 0.011_r8, 0.989_r8, &
                                                                   1.65E-05_r8, 0.011_r8, 0.989_r8 /)
...
#if ( defined MOSAIC_SPECIES )
  real(r8) :: dust_dmt_vwr(3)
  real(r8) :: dust_stk_crc(3)
#else
 ...
 contains
  ...
  ! local vars
    ...
    col_loop: do i =1,ncol
       ...
       idst = dust_indices(3)
       cflx(i,idst) = sum( -dust_flux_in(i,:) ) * 0.73_r8/0.87_r8 * frc_oin * dust_emis_sclfctr(3) * soil_erod(i)/soil_erod_fact*1.15_r8


       idst = dust_indices(4)
       cflx(i,idst) = sum( -dust_flux_in(i,:) ) * 0.73_r8/0.87_r8 * frc_ca  * dust_emis_sclfctr(4) * soil_erod(i)/soil_erod_fact*1.15_r8
       idst = dust_indices(5)
       cflx(i,idst) = sum( -dust_flux_in(i,:) ) * 0.73_r8/0.87_r8 * frc_ca  * dust_emis_sclfctr(5) * soil_erod(i)/soil_erod_fact*1.15_r8
       idst = dust_indices(6)
       cflx(i,idst) = sum( -dust_flux_in(i,:) ) * 0.73_r8/0.87_r8 * frc_ca  * dust_emis_sclfctr(6) * soil_erod(i)/soil_erod_fact*1.15_r8

       idst = dust_indices(7)
       cflx(i,idst) = sum( -dust_flux_in(i,:) ) * 0.73_r8/0.87_r8 * frc_co3 * dust_emis_sclfctr(7) * soil_erod(i)/soil_erod_fact*1.15_r8
       idst = dust_indices(8)
       cflx(i,idst) = sum( -dust_flux_in(i,:) ) * 0.73_r8/0.87_r8 * frc_co3 * dust_emis_sclfctr(8) * soil_erod(i)/soil_erod_fact*1.15_r8
       idst = dust_indices(9)
       cflx(i,idst) = sum( -dust_flux_in(i,:) ) * 0.73_r8/0.87_r8 * frc_co3 * dust_emis_sclfctr(9) * soil_erod(i)/soil_erod_fact*1.15_r8

       inum = dust_indices(dust_nbin+1)
       x_mton = 6._r8 / (pi * dust_density * (dust_dmt_vwr(1)**3._r8))
       cflx(i,inum) = ( cflx(i,dust_indices(1)) + cflx(i,dust_indices(4)) + cflx(i,dust_indices(7)) ) * x_mton

       inum = dust_indices(dust_nbin+2)
       x_mton = 6._r8 / (pi * dust_density * (dust_dmt_vwr(2)**3._r8))
       cflx(i,inum) = ( cflx(i,dust_indices(2)) + cflx(i,dust_indices(5)) + cflx(i,dust_indices(8)) ) * x_mton

       inum = dust_indices(dust_nbin+3)
       x_mton = 6._r8 / (pi * dust_density * (dust_dmt_vwr(3)**3._r8))
       cflx(i,inum) = ( cflx(i,dust_indices(3)) + cflx(i,dust_indices(6)) + cflx(i,dust_indices(9)) ) * x_mton                                                                                  
#else
