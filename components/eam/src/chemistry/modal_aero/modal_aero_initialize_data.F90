...
!kzm --
       ...
       xname_spectype(:nspec_amode(2),2)  = (/ 'sulfate   ', 'ammonium  ', &
            ...
            'm-poly    ', 'm-prot    ', 'm-lip     ' /)
!kzm 
#elif ( defined MODAL_AERO_4MODE_MOM || defined MODAL_AERO_4MODE_BRC )
...
#if (defined RAIN_EVAP_TO_COARSE_AERO)
          xname_massptr(:nspec_amode(3),3)   = &
          (/ 'dst_a3  ', 'ncl_a3  ', 'so4_a3  ', 'bc_a3   ','pom_a3  ','soa_a3  ', 'mom_a3  ', 'brc_a3  ' /)
          xname_massptrcw(:nspec_amode(3),3) = &
          (/ 'dst_c3  ', 'ncl_c3  ', 'so4_c3  ', 'bc_c3   ','pom_c3  ','soa_c3  ', 'mom_c3  ', 'brc_c3  ' /)
          xname_spectype(:nspec_amode(3),3)  = (/ 'dust      ', 'seasalt   ', 'sulfate   ', 'black-c   ','p-organic ', &
               's-organic ', 'm-organic ', 'b-organic ' /)
#else
          xname_massptr(:nspec_amode(3),3)   = (/ 'dst_a3  ', 'ncl_a3  ','so4_a3  ' /)
          xname_massptrcw(:nspec_amode(3),3) = (/ 'dst_c3  ', 'ncl_c3  ','so4_c3  ' /)
          xname_spectype(:nspec_amode(3),3)  = (/ 'dust      ', 'seasalt   ','sulfate   ' /)
...
!kzm ++
       ...
       xname_spectype(:nspec_amode(4),4)  = (/ 'p-organic ', 'black-c   ','m-organic ','b-organic '  /)
#endif
...
loop:    do i = icldphy+1, pcnst
     ...
     subroutine initaermodes_setspecptrs
       ...
       do m = 1, ntot_aspectype
          ...
          !kzm ++
          else if (specname_amode(m).eq.'b-organic ') then
             specdens_brc_amode = specdens_amode(m)
             specmw_brc_amode = specmw_amode(m)
          !kzm --
          end if
       enddo
