...
#if (defined MODAL_AERO_9MODE || MODAL_AERO_4MODE_MOM || defined MODAL_AERO_5MODE_AGEDCARBON || defined MODAL_AERO_6MODE_BB_ACARBON)
       dummy = 'SSTSFMBL_OM'
...
#if ( defined MODAL_AERO_3MODE ) || ( defined MODAL_AERO_4MODE ) || ( defined MODAL_AERO_4MODE_MOM ) || ( defined MODAL_AERO_5MODE_AGEDCARBON ) || ( defined MODAL_AERO_6MODE_BB_ACARBON )
       ntoo = modeptr_coarse
#else
...
#elif ( defined MODAL_AERO_6MODE_BB_ACARBON )
       if (ntot_amode == 6) then
          ! for mam6, do accum, aitken, pcarbon, acarbon,  
          ! pbb, then coarse 
          if (mtmp == ntot_amode) then
             m = modeptr_coarse
          else if (mtmp >= modeptr_coarse) then
