...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt    = 22, &    ! number of photolysis reactions
                            rxntot    = 104, &    ! number of total reactions
                            gascnt    = 82, &    ! number of gas phase reactions
                            nabscol   = 2, &      ! number of absorbing column densities
                            gas_pcnst = 73, &     ! number of "gas phase" species
                            nfs       = 9, &       ! number of "fixed" species
