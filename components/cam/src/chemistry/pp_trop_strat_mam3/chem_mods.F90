...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 81, & ! number of photolysis reactions
                            rxntot = 365, & ! number of total reactions
                            gascnt = 284, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 145, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1223, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 120, & ! number of species in implicit class
