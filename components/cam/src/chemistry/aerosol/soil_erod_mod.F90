...
!LXu@06/2019+++
!    use dust_model,       only: phos_dust_active
!LXu@06/2019---
...
!LXu@06/2019---
    ...
    if (masterproc) then
       write(iulog,*) 'soil_erodibility_col_data = ', soil_erodibility(:,10)
    end if
...
if (read_mam_sp) then
    ...
    if (masterproc) then
       write(iulog,*) 'frac_sol_p_dust_col_data = ', frac_sol_p_dust(:,10)
       write(iulog,*) 'frac_insol_p_dust_col_data = ', frac_insol_p_dust(:,10)
    end if
end if
#endif
!LXu@06/2019---
