...
#if (( defined MODAL_AERO_3MODE ) || ( defined MODAL_AERO_4MODE ) || ( defined MODAL_AERO_4MODE_MOA )) && ( defined RAIN_EVAP_TO_COARSE_AERO )
  ...
  character(len=*),parameter ::  specname_amode(ntot_aspectype) = (/ 'sulfate   ', 'ammonium  ', 'nitrate   ', &
    ...
    integer :: msectional = -1
      ...
      integer                                       &   !
          ...
          lptr_moa_a_amode(ntot_amode),  lptr_moa_cw_amode(ntot_amode),&   !
      ...
      real(r8) ::             &
          ...
          specmw_moa_amode,     specdens_moa_amode
