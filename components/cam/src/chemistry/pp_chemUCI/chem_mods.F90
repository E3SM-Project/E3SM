...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt    = 16, &    ! number of photolysis reactions
                            rxntot    = 83, &    ! number of total reactions
                            gascnt    = 67, &    ! number of gas phase reactions
                            ...
                            nzcnt     = 219, & ! number of non-zero matrix entries
                            ...
                            clscnt4   = 24, &   ! number of species in implicit class
