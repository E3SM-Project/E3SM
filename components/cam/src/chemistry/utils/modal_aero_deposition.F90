...
!kzm:should add BRC into deposition in the future 
#if( (defined MODAL_AERO_4MODE) || (defined MODAL_AERO_4MODE_MOM) || (defined MODAL_AERO_4MODE_BRC) )
      ! MAM4
...
#endif
!kzm : should add BRC in the future
#if( (defined MODAL_AERO_4MODE) || (defined MODAL_AERO_4MODE_MOM) || (defined MODAL_AERO_4MODE_BRC))
      ! MAM4
