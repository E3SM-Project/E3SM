...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 0, & ! number of photolysis reactions
                            rxntot = 5, & ! number of total reactions
                            gascnt = 5, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 5, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 6, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 5, & ! number of species in implicit class
