...
!==============================================================
      ...
      contains
       ...
       subroutine init_cph
          ...
          call addfld( 'CPH1',  'K/s ', pver, 'I', 'O + O3 -> 2*O2 + 93.46 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH2',  'K/s ', pver, 'I', 'O + O + M -> O2 + M + 119.12 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH3',  'K/s ', pver, 'I', 'O + OH -> H + O2 + 16.35 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH4',  'K/s ', pver, 'I', 'O + HO2 -> OH + O2 + 53.97 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH5',  'K/s ', pver, 'I', 'H + O2 + M -> HO2 + M + 48.8 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH6',  'K/s ', pver, 'I', 'O + O2 + M -> O3 + M + 25.66 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH7',  'K/s ', pver, 'I', 'H + O3 -> OH + O2 + 46.27 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH8',  'K/s ', pver, 'I', 'HO2 + NO -> NO2 + OH + 8.06 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH9',  'K/s ', pver, 'I', 'HO2 + O3 -> 2*O2 + OH + 28.31 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH10', 'K/s ', pver, 'I', 'HO2 + HO2 -> H2O2 + O2 + 39.08 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH11', 'K/s ', pver, 'I', 'OH + O3 -> HO2 + O2 + 39.49 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH12', 'K/s ', pver, 'I', 'NO + O3 -> NO2 + O2 + 47.55 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH13', 'K/s ', pver, 'I', 'NO2 + O -> NO + O2 + 45.91 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH14', 'K/s ', pver, 'I', 'OH + HO2 -> H2O + O2 + 69.99 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH15', 'K/s ', pver, 'I', 'H + HO2 -> H2 + O2 + 55.4 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH16', 'K/s ', pver, 'I', 'O1D + O2 -> O + O2_1S + 7.63 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH17', 'K/s ', pver, 'I', 'O1D + N2 -> O + N2 + 45.14 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH18', 'K/s ', pver, 'I', 'O2_1S + O -> O2_1D + O + 14.97 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH19', 'K/s ', pver, 'I', 'O2_1S + O2 -> O2_1D + O2 + 14.97 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH20', 'K/s ', pver, 'I', 'O2_1S + N2 -> O2_1D + N2 + 14.97 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH21', 'K/s ', pver, 'I', 'O2_1S + O3 -> O2_1D + O3 + 14.97 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH22', 'K/s ', pver, 'I', 'O2_1D + O -> O2 + O + 22.54 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH23', 'K/s ', pver, 'I', 'O2_1D + O2 -> 2*O2 + 22.54 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH24', 'K/s ', pver, 'I', 'O2_1D + N2 -> O2 + N2 + 22.54 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH25', 'K/s ', pver, 'I', 'N2D + O2 -> NO + O1D + 42.43 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH26', 'K/s ', pver, 'I', 'N2D + O -> N + O + 54.88 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH27', 'K/s ', pver, 'I', 'N + O2 -> NO + O + 32.28 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH28', 'K/s ', pver, 'I', 'N + NO -> N2 + O + 61.8 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH29', 'K/s ', pver, 'I', 'O1D + O2 -> O + O2 + 45.14 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH30', 'K/s ', pver, 'I', 'Op + O2 -> O2p + O + 35.878 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH31', 'K/s ', pver, 'I', 'Op + N2 -> NOp + N + 25.105 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH32', 'K/s ', pver, 'I', 'N2p + O -> NOp + N2D + 16.140 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH33', 'K/s ', pver, 'I', 'O2p + N -> NOp + O + 97.073 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH34', 'K/s ', pver, 'I', 'O2p + NO -> NOp + O2 + 64.862 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH35', 'K/s ', pver, 'I', 'Np + O2 -> O2p + N + 57.322 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH36', 'K/s ', pver, 'I', 'Np + O2 -> NOp + O + 154.46 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH37', 'K/s ', pver, 'I', 'Np + O -> Op + N + 22.597 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH38', 'K/s ', pver, 'I', 'N2p + O2 -> O2p + N2 + 81.164 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH39', 'K/s ', pver, 'I', 'NOp + e -> 19.691 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH40', 'K/s ', pver, 'I', 'O2p + e -> 121.65 kcal/mol chem pot heating rate', phys_decomp )
          call addfld( 'CPH41', 'K/s ', pver, 'I', 'N2p + e -> 84.807 kcal/mol chem pot heating rate', phys_decomp )
