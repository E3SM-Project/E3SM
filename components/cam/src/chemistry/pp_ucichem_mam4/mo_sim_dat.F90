...
!--------------------------------------------------------------
      ...
      solsym(: 61) = (/ 'O3              ','OH              ','HO2             ','H2O2            ','CH2O            ', &
                        ...
                        'O3S             ','ASAD            ','DMS             ','SO2             ','H2SO4           ', &
                        'SOAG            ','so4_a1          ','so4_a2          ','so4_a3          ','pom_a1          ', &
                        'pom_a3          ','pom_a4          ','soa_a1          ','soa_a2          ','soa_a3          ', &
                        'bc_a1           ','bc_a3           ','bc_a4           ','dst_a1          ','dst_a3          ', &
                        'ncl_a1          ','ncl_a2          ','ncl_a3          ','mom_a1          ','mom_a2          ', &
                        'mom_a3          ','mom_a4          ','num_a1          ','num_a2          ','num_a3          ', &
                        'num_a4          ' /)

      adv_mass(: 61) = (/      47.998200_r8,      17.006800_r8,      33.006200_r8,      34.013600_r8,      30.025200_r8, &
                              ...
                              108.010480_r8,      63.012340_r8,      79.011740_r8,     121.047940_r8,      28.010400_r8, &
                               16.040600_r8,      30.066400_r8,      44.092200_r8,      28.051600_r8,      49.005600_r8, &
                               58.076800_r8,      61.057800_r8,      62.065200_r8,      44.051000_r8,      75.042400_r8, &
                               68.114200_r8,     117.119800_r8,     102.050800_r8,     122.038600_r8,   0.493710E-01_r8, &
                               80.064200_r8,      32.066000_r8,      62.132400_r8,      64.064800_r8,      98.078400_r8, &
                               12.011000_r8,     115.107340_r8,     115.107340_r8,     115.107340_r8,      12.011000_r8, &
                               ...
                               58.442468_r8,      58.442468_r8,      58.442468_r8,  250092.672000_r8,  250092.672000_r8, &
                           250092.672000_r8,  250092.672000_r8,       1.007400_r8,       1.007400_r8,       1.007400_r8, &
                                1.007400_r8 /)

      crb_mass(: 61) = (/       0.000000_r8,       0.000000_r8,       0.000000_r8,       0.000000_r8,      12.011000_r8, &
                               ...
                               12.011000_r8,      24.022000_r8,      36.033000_r8,      24.022000_r8,       0.000000_r8, &
                               36.033000_r8,      24.022000_r8,      24.022000_r8,      24.022000_r8,      24.022000_r8, &
                               60.055000_r8,      60.055000_r8,      12.011000_r8,       0.000000_r8,       0.000000_r8, &
                               ...
                               12.011000_r8,      12.011000_r8,      12.011000_r8,       0.000000_r8,       0.000000_r8, &
                                0.000000_r8,       0.000000_r8,       0.000000_r8,  102333.720000_r8,  102333.720000_r8, &
                           102333.720000_r8,  102333.720000_r8,       0.000000_r8,       0.000000_r8,       0.000000_r8, &
                                0.000000_r8 /)

      fix_mass(:  5) = (/ 0.00000000_r8, 28.0134800_r8, 31.9988000_r8, 18.0142000_r8, 2.01480000_r8 /)

      clsmap(:  8,1) = (/   15,  16,  17,  18,  21,  30,  31,  32 /)
      ...
      rxt_tag_lst(:rxt_tag_cnt) = (/ 'j2ohA           ', 'j2ohB           ', 'j2ohC           ', 'jo2             ', &
                                     'jh2o2           ', 'jch2o_a         ', 'jch2o_b         ', 'jch3ooh         ', &
                                     'jc2h5ooh        ', 'jno2            ', 'jno3            ', 'jn2o5           ', &
                                     'jhno3           ', 'jho2no2         ', 'jch3cho         ', 'jpan            ', &
      ...
      pht_alias_lst(:,1) = (/ '                ', '                ', '                ', '                ', &
                              ...
                              '                ', '                ', '                ', '                ', &
                              '                ', '                ' /)
      pht_alias_lst(:,2) = (/ 'jo3_a           ', 'jo3_a           ', 'jo3_a           ', '                ', &
                              '                ', '                ', '                ', '                ', &
                              '                ', '                ', '                ', '                ', &
                              '                ', '                ', '                ', '                ', &
                              '                ', '                ' /)
