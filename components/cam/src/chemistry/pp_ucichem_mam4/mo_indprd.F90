...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,:,1) = (rxt(:,:,6) +rxt(:,:,7) +rxt(:,:,29)*y(:,:,2))*y(:,:,5) &
                  + (2.000_r8*rxt(:,:,73)*y(:,:,27) +rxt(:,:,78)*y(:,:,29))*y(:,:,3) &
                  + (rxt(:,:,15) +.500_r8*rxt(:,:,62)*y(:,:,2))*y(:,:,24) &
                  +rxt(:,:,26)*y(:,:,19)*y(:,:,1) +1.500_r8*rxt(:,:,18)*y(:,:,28)
