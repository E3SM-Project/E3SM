...
!--------------------------------------------------------------
      ...
      solsym(: 26) = (/ 'H2O2            ','H2SO4           ','SO2             ','DMS             ','SOAG            ', &
                        ...
                        'so4_a3          ','num_a3          ','pom_a4          ','bc_a4           ','moa_a4          ', &
                        'num_a4          ' /)
      ...
      adv_mass(: 26) = (/      34.013600_r8,      98.078400_r8,      64.064800_r8,      62.132400_r8,      12.011000_r8, &
                              ...
                              115.107340_r8,       1.007400_r8,      12.011000_r8,      12.011000_r8,  250092.672000_r8, &
                                1.007400_r8 /)
      ...
      crb_mass(: 26) = (/       0.000000_r8,       0.000000_r8,       0.000000_r8,      24.022000_r8,      12.011000_r8, &
                                ...
                                0.000000_r8,       0.000000_r8,      12.011000_r8,      12.011000_r8,  102333.720000_r8, &
                                0.000000_r8 /)
