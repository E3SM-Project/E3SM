module ncdio_atm
  ...
  interface infld
     ...
     module procedure infld_int_2d_2d
...
contains
  ...
  subroutine infld_int_1d_2d(varname, ncid, dimname1,                        &
    ...
    !
    ! !DESCRIPTION: 
    ! Netcdf I/O of initial int field from netCDF file
  ...
  !BOP
  !
  ! !IROUTINE: infld_int_2d_2d
  !
  ! !INTERFACE:
  subroutine infld_int_2d_2d(varname, ncid, dimname1, dimname2,              &
       dim1b, dim1e, dim2b, dim2e, field, readvar, gridname, timelevel)
    !
    ! !DESCRIPTION: 
    ! Netcdf I/O of initial integer field from netCDF file
    ...
    integer, pointer          :: tmp2d(:,:) ! input data for permutation

    logical                   :: readvar_tmp ! if true, variable is on tape
    character(len=32)         :: subname='INFLD_INT_2D_2D' ! subroutine name
    ...
    end if ! end of call infld_int_1d_2d instead

  end subroutine infld_int_2d_2d
