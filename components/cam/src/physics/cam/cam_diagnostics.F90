...
subroutine diag_init()
  ...
  ! Declare the history fields for which this module contains outfld calls.
   ...
   call addfld ('bc_bf_wetdep',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   call addfld ('bc_af_wetdep',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   call addfld ('bc_bf_drydep',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   call addfld ('bc_af_drydep',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   call addfld ('bc_bf_ndrop',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   call addfld ('bc_af_ndrop',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   call addfld ('bc_bf_chem',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   call addfld ('bc_af_chem',(/ 'lev' /), 'A','kg/kg','bc_c1 mass mixing ratio'                   )
   ...
   call addfld ('ps1',horiz_only,    'A','Pa','surface pressure'                                      )
   call addfld ('ps2',horiz_only,    'A','Pa','surface pressure'                                      )
   !Guangxing Lin, end
