...
!u before after dycore
   call addfld ('TBC',(/ 'lev' /), 'A','m/s','BZonal wind')
   call addfld ('TAC',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('UBC',(/ 'lev' /), 'A','m/s','AZonal wind')
   ...
   if (history_amwg) then
      ...
      call add_default ('TAC     ', 1, ' ')
      call add_default ('TBC     ', 1, ' ')
