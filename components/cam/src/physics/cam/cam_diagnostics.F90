...
!u before after dycore
   call addfld ('TbeforeH',(/ 'lev' /), 'A','m/s','BZonal wind')
   call addfld ('TafterH',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('UbeforeH',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('UafterH',(/ 'lev' /), 'A','m/s','AZonal wind')

   call addfld ('Uclubb1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Uclubb2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Usc1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Usc2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Uray1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Uray2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Uuni1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Uuni2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Uzm1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Uzm2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Udiff1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Udiff2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Ugw1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Ugw2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Ugw3',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Ugw4',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Ur1',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('Ur2',(/ 'lev' /), 'A','m/s','AZonal wind')
   call addfld ('UbeginAC',(/ 'lev' /), 'A','m/s','AZonal wind')
   ...
   if (history_amwg) then
      ...
      call add_default ('UbeforeH', 1, ' ')
      call add_default ('UafterH ', 1, ' ')
      call add_default ('TafterH ', 1, ' ')
      call add_default ('TbeforeH', 1, ' ')

      call add_default ('Uclubb1 ', 1, ' ')
      call add_default ('Uclubb2 ', 1, ' ')
      call add_default ('Usc1    ', 1, ' ')
      call add_default ('Usc2    ', 1, ' ')
      call add_default ('Uray1   ', 1, ' ')
      call add_default ('Uray2   ', 1, ' ')
      call add_default ('Uuni1   ', 1, ' ')
      call add_default ('Uuni2   ', 1, ' ')
      call add_default ('Uzm1    ', 1, ' ')
      call add_default ('Uzm2    ', 1, ' ')
      call add_default ('Udiff1  ', 1, ' ')
      call add_default ('Udiff2  ', 1, ' ')
      call add_default ('Ugw1    ', 1, ' ')
      call add_default ('Ugw2    ', 1, ' ')
      call add_default ('Ugw3    ', 1, ' ')
      call add_default ('Ugw4    ', 1, ' ')
      call add_default ('Ur1     ', 1, ' ')
      call add_default ('Ur2     ', 1, ' ')
      call add_default ('UbeginAC', 1, ' ')
