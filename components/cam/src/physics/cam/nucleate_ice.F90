...
!   It changes answers so needs climate validation.
   ...
   if (dem_in) then      ! DeMott, use particles number with D>0.5 um
      ...
      if(clim_modal_aero) then
         ...
         elseif(cam_chempkg_is('trop_mam3') .or. cam_chempkg_is('trop_mam4') .or. cam_chempkg_is('trop_mam4_resus') .or. cam_chempkg_is('trop_mam4_mom') .or. cam_chempkg_is('trop_mam4_resus_mom')) then !ASK Hailong about trop_mam4 
