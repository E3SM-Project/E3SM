...
! Local variables
  ...
  call linear_interp(zt_grid,zi_grid,thetal,thetal_zi,nlev,nlevi,shcol,largeneg)
...
subroutine shoc_tke(&
  ...
  do i=1,shcol
    shear_prod(i,1) = uw_sfc(i)**2 + vw_sfc(i)**2 
  enddo
...
subroutine linear_interp(x1,x2,y1,y2,km1,km2,ncol,minval)
  implicit none
