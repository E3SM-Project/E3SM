...
#if defined(MMF_ESMT)
  do k=1,nzm
    u_esmt(:,:,:,k) = crm_input_ul_esmt(icrm,plev-k+1)
    v_esmt(:,:,:,k) = crm_input_vl_esmt(icrm,plev-k+1)
  end do
#endif
...
#elif defined(_OPENMP)
  !$omp taskwait
  call update_host_micro()
  call update_host_sgs()
  call update_host_output()
  call update_host_crm()
  call update_host_vars()
  call update_host_micro_params()
#endif
...
#if defined( MMF_ESMT )
  uln_esmt(1:ptop-1,:)  = crm_input_ul_esmt(:,1:ptop-1)
  vln_esmt(1:ptop-1,:)  = crm_input_vl_esmt(:,1:ptop-1)
