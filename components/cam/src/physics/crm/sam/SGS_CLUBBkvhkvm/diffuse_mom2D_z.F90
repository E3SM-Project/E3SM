...
!tktemp(:, :, :) = tk_clubb   ! We need this  for the vertical diffuseion of verttical velocity 
...
tktemp(:, :, :) = tk_clubb * 0.2 ! use 0.2 here, as 0.4 is found too large for 
                                 ...
                                 ! 
!tktemp(:, :, :) = tk_clubb * 0.00 ! follow what is done in clubb_sgs.
!tktemp(:, :, :) = tk
else
tktemp(:, :, :) = tk(:, :, :)
endif
...
end subroutine diffuse_mom2D_z
