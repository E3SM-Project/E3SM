!-----------------------------------------------------------------------
! $Id: parameters_tunable.F90 5997 2012-12-18 20:47:09Z raut@uwm.edu $
!===============================================================================
module parameters_tunable
  ...
  real( kind = core_rknd ), public :: & 
    ...
    C2rt        = 1.500000_core_rknd,    & ! C2 coefficient for the rtp2_dp1 term.
    ...
    C6rt        = 2.300000_core_rknd,    & ! Low Skewness in C6rt Skewness Function.
    ...
    C7          = 0.320000_core_rknd,    & ! Low Skewness in C7 Skewness Function.
