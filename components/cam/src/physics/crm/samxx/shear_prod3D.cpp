  ...
  parallel_for(
      Bounds<4>(nzm, ny, nx, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
        ...
        if (k >= 1 && k <= nzm - 2) {
          ...
          tmp1 = (u(kc, j + offy_u, ic + offx_u, icrm) - u0(kc, icrm) - u(k, j + offy_u, ic + offx_u, icrm) +
                  u0(k, icrm)) *
                     rdzw_up +
                 (w(kc, j + offy_w, ic + offx_w, icrm) - w(kc, j + offy_w, i + offx_w, icrm)) * rdx_up;
          tmp2 =
              (u(kc, j + offy_u, i + offx_u, icrm) - u0(kc, icrm) - u(k, j + offy_u, i + offx_u, icrm) + u0(k, icrm)) *
                  rdzw_up +
              (w(kc, j + offy_w, i + offx_w, icrm) - w(kc, j + offy_w, ib + offx_w, icrm)) * rdx_up;
          tmp3 = (u(k, j + offy_u, ic + offx_u, icrm) - u0(k, icrm) - u(kb, j + offy_u, ic + offx_u, icrm) +
                  u0(kb, icrm)) *
                     rdzw_dn +
                 (w(k, j + offy_w, ic + offx_w, icrm) - w(k, j + offy_w, i + offx_w, icrm)) * rdx_dn;
          tmp4 =
              (u(k, j + offy_u, i + offx_u, icrm) - u0(k, icrm) - u(kb, j + offy_u, i + offx_u, icrm) + u0(kb, icrm)) *
                  rdzw_dn +
          ...
          tmp1 = (v(kc, jc + offy_v, i + offx_v, icrm) - v0(kc, icrm) - v(k, jc + offy_v, i + offx_v, icrm) +
                  v0(k, icrm)) *
                     rdzw_up +
                 (w(kc, jc + offy_w, i + offx_w, icrm) - w(kc, j + offy_w, i + offx_w, icrm)) * rdy_up;
          tmp2 =
              (v(kc, j + offy_v, i + offx_v, icrm) - v0(kc, icrm) - v(k, j + offy_v, i + offx_v, icrm) + v0(k, icrm)) *
                  rdzw_up +
              (w(kc, j + offy_w, i + offx_w, icrm) - w(kc, jb + offy_w, i + offx_w, icrm)) * rdy_up;
          tmp3 = (v(k, jc + offy_v, i + offx_v, icrm) - v0(k, icrm) - v(kb, jc + offy_v, i + offx_v, icrm) +
                  v0(kb, icrm)) *
                     rdzw_dn +
                 (w(k, jc + offy_w, i + offx_w, icrm) - w(k, j + offy_w, i + offx_w, icrm)) * rdy_dn;
          tmp4 =
              (v(k, j + offy_v, i + offx_v, icrm) - v0(k, icrm) - v(kb, j + offy_v, i + offx_v, icrm) + v0(kb, icrm)) *
                  rdzw_dn +
          ...
          real tmp7 = (u(k, j + offy_u, i + offx_u, icrm) - u(k, jb + offy_u, i + offx_u, icrm)) * rdy +
                      (v(k, j + offy_v, i + offx_v, icrm) - v(k, j + offy_v, ib + offx_v, icrm)) * rdx;
          real tmp8 = (v(kc, jc + offy_v, i + offx_v, icrm) - v0(kc, icrm) - v(k, jc + offy_v, i + offx_v, icrm) +
                       v0(k, icrm)) *
                          rdzw_up +
                      (w(kc, jc + offy_w, i + offx_w, icrm) - w(kc, j + offy_w, i + offx_w, icrm)) * rdy_up;
          real tmp9 =
              (v(kc, j + offy_v, i + offx_v, icrm) - v0(kc, icrm) - v(k, j + offy_v, i + offx_v, icrm) + v0(k, icrm)) *
                  rdzw_up +
              (w(kc, j + offy_w, i + offx_w, icrm) - w(kc, jb + offy_w, i + offx_w, icrm)) * rdy_up;
          real tmp10 = (u(kc, j + offy_u, ic + offx_u, icrm) - u0(kc, icrm) - u(k, j + offy_u, ic + offx_u, icrm) +
                        u0(k, icrm)) *
                           rdzw_up +
                       (w(kc, j + offy_w, ic + offx_w, icrm) - w(kc, j + offy_w, i + offx_w, icrm)) * rdx_up;
          real tmp11 =
          ...
          real tmp7 = (u(k, j + offy_u, i + offx_u, icrm) - u(k, jb + offy_u, i + offx_u, icrm)) * rdy +
                      (v(k, j + offy_v, i + offx_v, icrm) - v(k, j + offy_v, ib + offx_v, icrm)) * rdx;
          real tmp8 = (v(k, jc + offy_v, i + offx_v, icrm) - v0(k, icrm) - v(kb, jc + offy_v, i + offx_v, icrm) +
                       v0(kb, icrm)) *
                          rdzw_dn +
                      (w(k, jc + offy_w, i + offx_w, icrm) - w(k, j + offy_w, i + offx_w, icrm)) * rdy_dn;
          real tmp9 =
              (v(k, j + offy_v, i + offx_v, icrm) - v0(k, icrm) - v(kb, j + offy_v, i + offx_v, icrm) + v0(kb, icrm)) *
                  rdzw_dn +
              (w(k, j + offy_w, i + offx_w, icrm) - w(k, jb + offy_w, i + offx_w, icrm)) * rdy_dn;
          real tmp10 = (u(k, j + offy_u, ic + offx_u, icrm) - u0(k, icrm) - u(kb, j + offy_u, ic + offx_u, icrm) +
                        u0(kb, icrm)) *
                           rdzw_dn +
                       (w(k, j + offy_w, ic + offx_w, icrm) - w(k, j + offy_w, i + offx_w, icrm)) * rdx_dn;
          real tmp11 =
