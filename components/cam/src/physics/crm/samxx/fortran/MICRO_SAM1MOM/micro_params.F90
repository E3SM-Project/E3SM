module micro_params
  ...
  real(crm_rknd), bind(C) :: gam3       ! Gamma function of 3
  real(crm_rknd), bind(C) :: gams1      ! Gamma function of (3 + b_snow)
  real(crm_rknd), bind(C) :: gams2      ! Gamma function of (5 + b_snow)/2
  real(crm_rknd), bind(C) :: gams3      ! Gamma function of (4 + b_snow)
  real(crm_rknd), bind(C) :: gamg1      ! Gamma function of (3 + b_grau)
  real(crm_rknd), bind(C) :: gamg2      ! Gamma function of (5 + b_grau)/2
  real(crm_rknd), bind(C) :: gamg3      ! Gamma function of (4 + b_grau)
  real(crm_rknd), bind(C) :: gamr1      ! Gamma function of (3 + b_rain)
