module crm_state_module
   ...
   type crm_state_type
      ...
      real(crm_rknd), pointer, contiguous :: u_wind(:,:,:,:)       ! CRM u-wind component
      real(crm_rknd), pointer, contiguous :: v_wind(:,:,:,:)       ! CRM v-wind component
      real(crm_rknd), pointer, contiguous :: w_wind(:,:,:,:)       ! CRM w-wind component
      real(crm_rknd), pointer, contiguous :: temperature(:,:,:,:)  ! CRM temperuture

      ! Microphysics
      real(crm_rknd), pointer, contiguous :: qt(:,:,:,:) 
      ...
      ! for sam1mom...
      real(crm_rknd), pointer, contiguous :: qp(:,:,:,:)
      real(crm_rknd), pointer, contiguous :: qn(:,:,:,:)
