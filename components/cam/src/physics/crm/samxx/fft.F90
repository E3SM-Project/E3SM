...
contains
      ...
      subroutine fft991_crm(a,work,trigs,ifax,inc,jump,n,lot,isign) bind(C,name="fft991_crm")
      !$acc routine seq
      use params, only: crm_rknd, crm_iknd
      ! dimension a(*),work(*),trigs(*),ifax(*)
      integer, dimension(*) :: ifax
      real(crm_rknd), dimension(*) :: a, work, trigs
      integer, value :: inc, jump, n, lot, isign
!
...
!
  140 continue
      ...
      subroutine fftfax_crm(n,ifax,trigs) bind(C,name="fftfax_crm")
      !$acc routine seq
