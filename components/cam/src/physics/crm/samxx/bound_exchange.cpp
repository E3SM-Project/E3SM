...
void bound_exchange(real4d &f, int dimz, int i_1, int i_2, int j_1, int j_2, int id) {
  ...
  if (RUN3D) {
    ...
    parallel_for(
        Bounds<4>(dimz, j1p, nx, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
          int jStart = ny - j1 - 1;
          int jInd = ny - j1 - 1 + j;
          int jEnd = ny - 1;
    ...
    //       for (int icrm=0; icrm<ncrms; icrm++) {
    parallel_for(
        Bounds<4>(dimz, j1p, i1p, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
          int jStart = ny - j1 - 1;
          int jInd = ny - j1 - 1 + j;
          int jEnd = ny - 1;
          int iStart = nx - i1 - 1;
    ...
    //       for (int icrm=0; icrm<ncrms; icrm++) {
    parallel_for(
        Bounds<4>(dimz, j2p, i1p, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
          int jStart = 1 - 1;
          int jInd = 1 - 1 + j;
          int jEnd = 1 + j2 - 1;
          int iStart = nx - i1 - 1;
    ...
    //       for (int icrm=0; icrm<ncrms; icrm++) {
    parallel_for(
        Bounds<4>(dimz, j2p, nx, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
          int jStart = 1 - 1;
          int jInd = 1 - 1 + j;
          int jEnd = 1 + j2 - 1;
          int n = _IDX(0, ncrms - 1, icrm, 0, nx - 1, i, jStart, jEnd, jInd, 0, dimz - 1, k);
    ...
    //       for (int icrm=0; icrm<ncrms; icrm++) {
    parallel_for(
        Bounds<4>(dimz, j2p, i2p, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
          int jStart = 1 - 1;
          int jInd = 1 - 1 + j;
          int jEnd = 1 + j2 - 1;
          int iStart = 1 - 1;
    ...
    //       for (int icrm=0; icrm<ncrms; icrm++) {
    parallel_for(
        Bounds<4>(dimz, j1p, i2p, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
          int jStart = ny - j1 - 1;
          int jInd = ny - j1 - 1 + j;
          int jEnd = ny - 1;
          int iStart = 1 - 1;
  ...
  //       for (int icrm=0; icrm<ncrms; icrm++) {
  parallel_for(
      Bounds<4>(dimz, ny, i1p, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
        int iStart = nx - i1 - 1;
        int iInd = nx - i1 - 1 + i;
        int iEnd = nx - 1;
  ...
  //       for (int icrm=0; icrm<ncrms; icrm++) {
  parallel_for(
      Bounds<4>(dimz, ny, i2p, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
        int iStart = 1 - 1;
        int iInd = 1 - 1 + i;
        int iEnd = 1 + i2 - 1;
        int n = _IDX(0, ncrms - 1, icrm, iStart, iEnd, iInd, 0, ny - 1, j, 0, dimz - 1, k);
