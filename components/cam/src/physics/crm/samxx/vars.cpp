...
void create_and_copy_inputs(real *crm_input_bflxls_p, real *crm_input_wndls_p, real *crm_input_zmid_p, real *crm_input_zint_p, 
  ...
  realHost1d crm_input_bflxls          = realHost1d( "crm_input_bflxls        ",crm_input_bflxls_p                                        , ncrms);
  realHost1d crm_input_wndls           = realHost1d( "crm_input_wndls         ",crm_input_wndls_p                                         , ncrms);
  realHost2d crm_input_zmid            = realHost2d( "crm_input_zmid          ",crm_input_zmid_p                              , plev      , ncrms); 
  realHost2d crm_input_zint            = realHost2d( "crm_input_zint          ",crm_input_zint_p                              , plev+1    , ncrms); 
  realHost2d crm_input_pmid            = realHost2d( "crm_input_pmid          ",crm_input_pmid_p                              , plev      , ncrms); 
  realHost2d crm_input_pint            = realHost2d( "crm_input_pint          ",crm_input_pint_p                              , plev+1    , ncrms); 
  realHost2d crm_input_pdel            = realHost2d( "crm_input_pdel          ",crm_input_pdel_p                              , plev      , ncrms); 
  realHost2d crm_input_ul              = realHost2d( "crm_input_ul            ",crm_input_ul_p                                , plev      , ncrms); 
  realHost2d crm_input_vl              = realHost2d( "crm_input_vl            ",crm_input_vl_p                                , plev      , ncrms); 
  realHost2d crm_input_tl              = realHost2d( "crm_input_tl            ",crm_input_tl_p                                , plev      , ncrms); 
  realHost2d crm_input_qccl            = realHost2d( "crm_input_qccl          ",crm_input_qccl_p                              , plev      , ncrms); 
  realHost2d crm_input_qiil            = realHost2d( "crm_input_qiil          ",crm_input_qiil_p                              , plev      , ncrms); 
  realHost2d crm_input_ql              = realHost2d( "crm_input_ql            ",crm_input_ql_p                                , plev      , ncrms); 
  realHost1d crm_input_tau00           = realHost1d( "crm_input_tau00         ",crm_input_tau00_p                                         , ncrms); 
  realHost4d crm_state_u_wind          = realHost4d( "crm_state_u_wind        ",crm_state_u_wind_p         , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_state_v_wind          = realHost4d( "crm_state_v_wind        ",crm_state_v_wind_p         , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_state_w_wind          = realHost4d( "crm_state_w_wind        ",crm_state_w_wind_p         , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_state_temperature     = realHost4d( "crm_state_temperature   ",crm_state_temperature_p    , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_state_qt              = realHost4d( "crm_state_qt            ",crm_state_qt_p             , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_state_qp              = realHost4d( "crm_state_qp            ",crm_state_qp_p             , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_state_qn              = realHost4d( "crm_state_qn            ",crm_state_qn_p             , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_rad_qrad              = realHost4d( "crm_rad_qrad            ",crm_rad_qrad_p             , crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  realHost1d crm_output_timing_factor  = realHost1d( "crm_output_timing_factor",crm_output_timing_factor_p                                , ncrms); 
  ...
  realHost1d crm_output_cltot          = realHost1d( "crm_output_cltot        ",crm_output_cltot_p                                        , ncrms); 
  realHost1d crm_output_clhgh          = realHost1d( "crm_output_clhgh        ",crm_output_clhgh_p                                        , ncrms); 
  realHost1d crm_output_clmed          = realHost1d( "crm_output_clmed        ",crm_output_clmed_p                                        , ncrms); 
  realHost1d crm_output_cllow          = realHost1d( "crm_output_cllow        ",crm_output_cllow_p                                        , ncrms); 

  // Allocate space for all of the variables
  ::crm_input_bflxls          = real1d( "crm_input_bflxls        "                               , ncrms);
  ::crm_input_wndls           = real1d( "crm_input_wndls         "                               , ncrms);
  ::crm_input_zmid            = real2d( "crm_input_zmid          "                   , plev      , ncrms); 
  ::crm_input_zint            = real2d( "crm_input_zint          "                   , plev+1    , ncrms); 
  ::crm_input_pmid            = real2d( "crm_input_pmid          "                   , plev      , ncrms); 
  ::crm_input_pint            = real2d( "crm_input_pint          "                   , plev+1    , ncrms); 
  ::crm_input_pdel            = real2d( "crm_input_pdel          "                   , plev      , ncrms); 
  ::crm_input_ul              = real2d( "crm_input_ul            "                   , plev      , ncrms); 
  ::crm_input_vl              = real2d( "crm_input_vl            "                   , plev      , ncrms); 
  ::crm_input_tl              = real2d( "crm_input_tl            "                   , plev      , ncrms); 
  ::crm_input_qccl            = real2d( "crm_input_qccl          "                   , plev      , ncrms); 
  ::crm_input_qiil            = real2d( "crm_input_qiil          "                   , plev      , ncrms); 
  ::crm_input_ql              = real2d( "crm_input_ql            "                   , plev      , ncrms); 
  ::crm_input_tau00           = real1d( "crm_input_tau00         "                               , ncrms); 
  ::crm_state_u_wind          = real4d( "crm_state_u_wind        ", crm_nz, crm_ny    , crm_nx    , ncrms);
  ::crm_state_v_wind          = real4d( "crm_state_v_wind        ", crm_nz, crm_ny    , crm_nx    , ncrms);
  ::crm_state_w_wind          = real4d( "crm_state_w_wind        ", crm_nz, crm_ny    , crm_nx    , ncrms);
  ::crm_state_temperature     = real4d( "crm_state_temperature   ", crm_nz, crm_ny    , crm_nx    , ncrms);
  ::crm_state_qt              = real4d( "crm_state_qt            ", crm_nz, crm_ny    , crm_nx    , ncrms);
  ::crm_state_qp              = real4d( "crm_state_qp            ", crm_nz, crm_ny    , crm_nx    , ncrms);
  ::crm_state_qn              = real4d( "crm_state_qn            ", crm_nz, crm_ny    , crm_nx    , ncrms);
  ::crm_rad_qrad              = real4d( "crm_rad_qrad            ", crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  ::crm_rad_temperature       = real4d( "crm_rad_temperature     ", crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  ::crm_rad_qv                = real4d( "crm_rad_qv              ", crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  ::crm_rad_qc                = real4d( "crm_rad_qc              ", crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  ::crm_rad_qi                = real4d( "crm_rad_qi              ", crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  ::crm_rad_cld               = real4d( "crm_rad_cld             ", crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  ::crm_output_timing_factor  = real1d( "crm_output_timing_factor"                               , ncrms); 
  ::crm_output_prectend       = real1d( "crm_output_prectend     "                               , ncrms); 
  ::crm_output_precstend      = real1d( "crm_output_precstend    "                               , ncrms); 
  ::crm_output_cld            = real2d( "crm_output_cld          "                   , plev      , ncrms); 
  ::crm_output_cldtop         = real2d( "crm_output_cldtop       "                   , plev      , ncrms); 
  ::crm_output_gicewp         = real2d( "crm_output_gicewp       "                   , plev      , ncrms); 
  ::crm_output_gliqwp         = real2d( "crm_output_gliqwp       "                   , plev      , ncrms); 
  ::crm_output_mctot          = real2d( "crm_output_mctot        "                   , plev      , ncrms); 
  ::crm_output_mcup           = real2d( "crm_output_mcup         "                   , plev      , ncrms); 
  ::crm_output_mcdn           = real2d( "crm_output_mcdn         "                   , plev      , ncrms); 
  ::crm_output_mcuup          = real2d( "crm_output_mcuup        "                   , plev      , ncrms); 
  ::crm_output_mcudn          = real2d( "crm_output_mcudn        "                   , plev      , ncrms); 
  ::crm_output_qc_mean        = real2d( "crm_output_qc_mean      "                   , plev      , ncrms); 
  ::crm_output_qi_mean        = real2d( "crm_output_qi_mean      "                   , plev      , ncrms); 
  ::crm_output_qs_mean        = real2d( "crm_output_qs_mean      "                   , plev      , ncrms); 
  ::crm_output_qg_mean        = real2d( "crm_output_qg_mean      "                   , plev      , ncrms); 
  ::crm_output_qr_mean        = real2d( "crm_output_qr_mean      "                   , plev      , ncrms); 
  ::crm_output_mu_crm         = real2d( "crm_output_mu_crm       "                   , plev      , ncrms); 
  ::crm_output_md_crm         = real2d( "crm_output_md_crm       "                   , plev      , ncrms); 
  ::crm_output_eu_crm         = real2d( "crm_output_eu_crm       "                   , plev      , ncrms); 
  ::crm_output_du_crm         = real2d( "crm_output_du_crm       "                   , plev      , ncrms); 
  ::crm_output_ed_crm         = real2d( "crm_output_ed_crm       "                   , plev      , ncrms); 
  ::crm_output_flux_qt        = real2d( "crm_output_flux_qt      "                   , plev      , ncrms); 
  ::crm_output_flux_u         = real2d( "crm_output_flux_u       "                   , plev      , ncrms); 
  ::crm_output_flux_v         = real2d( "crm_output_flux_v       "                   , plev      , ncrms); 
  ::crm_output_fluxsgs_qt     = real2d( "crm_output_fluxsgs_qt   "                   , plev      , ncrms); 
  ::crm_output_tkez           = real2d( "crm_output_tkez         "                   , plev      , ncrms); 
  ::crm_output_tkesgsz        = real2d( "crm_output_tkesgsz      "                   , plev      , ncrms); 
  ::crm_output_tkz            = real2d( "crm_output_tkz          "                   , plev      , ncrms); 
  ::crm_output_flux_qp        = real2d( "crm_output_flux_qp      "                   , plev      , ncrms); 
  ::crm_output_precflux       = real2d( "crm_output_precflux     "                   , plev      , ncrms); 
  ::crm_output_qt_trans       = real2d( "crm_output_qt_trans     "                   , plev      , ncrms); 
  ::crm_output_qp_trans       = real2d( "crm_output_qp_trans     "                   , plev      , ncrms); 
  ::crm_output_qp_fall        = real2d( "crm_output_qp_fall      "                   , plev      , ncrms); 
  ::crm_output_qp_evp         = real2d( "crm_output_qp_evp       "                   , plev      , ncrms); 
  ::crm_output_qp_src         = real2d( "crm_output_qp_src       "                   , plev      , ncrms); 
  ::crm_output_qt_ls          = real2d( "crm_output_qt_ls        "                   , plev      , ncrms); 
  ::crm_output_t_ls           = real2d( "crm_output_t_ls         "                   , plev      , ncrms); 
  ::crm_output_jt_crm         = real1d( "crm_output_jt_crm       "                               , ncrms); 
  ::crm_output_mx_crm         = real1d( "crm_output_mx_crm       "                               , ncrms); 
  ::crm_output_cltot          = real1d( "crm_output_cltot        "                               , ncrms); 
  ::crm_output_clhgh          = real1d( "crm_output_clhgh        "                               , ncrms); 
  ::crm_output_clmed          = real1d( "crm_output_clmed        "                               , ncrms); 
  ::crm_output_cllow          = real1d( "crm_output_cllow        "                               , ncrms); 
  ::crm_output_sltend         = real2d( "crm_output_sltend       "                   , plev      , ncrms); 
  ::crm_output_qltend         = real2d( "crm_output_qltend       "                   , plev      , ncrms); 
  ::crm_output_qcltend        = real2d( "crm_output_qcltend      "                   , plev      , ncrms); 
  ::crm_output_qiltend        = real2d( "crm_output_qiltend      "                   , plev      , ncrms); 
  ::crm_output_tk             = real4d( "crm_output_tk           ",   crm_nz, crm_ny    , crm_nx , ncrms); 
  ::crm_output_tkh            = real4d( "crm_output_tkh          ",   crm_nz, crm_ny    , crm_nx , ncrms);
  ::crm_output_qcl            = real4d( "crm_output_qcl          ",   crm_nz, crm_ny    , crm_nx , ncrms);
  ::crm_output_qci            = real4d( "crm_output_qci          ",   crm_nz, crm_ny    , crm_nx , ncrms);
  ::crm_output_qpl            = real4d( "crm_output_qpl          ",   crm_nz, crm_ny    , crm_nx , ncrms);
  ::crm_output_qpi            = real4d( "crm_output_qpi          ",   crm_nz, crm_ny    , crm_nx , ncrms);
  ::crm_output_z0m            = real1d( "crm_output_z0m          "                               , ncrms); 
  ::crm_output_taux           = real1d( "crm_output_taux         "                               , ncrms); 
  ::crm_output_tauy           = real1d( "crm_output_tauy         "                               , ncrms); 
  ::crm_output_precc          = real1d( "crm_output_precc        "                               , ncrms); 
  ::crm_output_precl          = real1d( "crm_output_precl        "                               , ncrms); 
  ::crm_output_precsc         = real1d( "crm_output_precsc       "                               , ncrms); 
  ::crm_output_precsl         = real1d( "crm_output_precsl       "                               , ncrms); 
  ::crm_output_prec_crm       = real3d( "crm_output_prec_crm     "          , crm_ny    , crm_nx , ncrms);  
  ...
  crm_output_timing_factor.deep_copy_to(::crm_output_timing_factor);
...
void copy_outputs_and_destroy(real *crm_state_u_wind_p, real *crm_state_v_wind_p, real *crm_state_w_wind_p, real *crm_state_temperature_p, 
                              ...
                              real *crm_rad_qv_p, real *crm_rad_qc_p, real *crm_rad_qi_p, real *crm_rad_cld_p, real *crm_output_timing_factor_p, 
  ...
  realHost4d crm_state_qp              = realHost4d( "crm_state_qp            ",crm_state_qp_p             , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_state_qn              = realHost4d( "crm_state_qn            ",crm_state_qn_p             , crm_nz, crm_ny    , crm_nx    , ncrms);
  realHost4d crm_rad_temperature       = realHost4d( "crm_rad_temperature     ",crm_rad_temperature_p      , crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  realHost4d crm_rad_qv                = realHost4d( "crm_rad_qv              ",crm_rad_qv_p               , crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  realHost4d crm_rad_qc                = realHost4d( "crm_rad_qc              ",crm_rad_qc_p               , crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  realHost4d crm_rad_qi                = realHost4d( "crm_rad_qi              ",crm_rad_qi_p               , crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  realHost4d crm_rad_cld               = realHost4d( "crm_rad_cld             ",crm_rad_cld_p              , crm_nz, crm_ny_rad, crm_nx_rad, ncrms);
  realHost1d crm_output_timing_factor  = realHost1d( "crm_output_timing_factor",crm_output_timing_factor_p                                , ncrms); 
  realHost1d crm_output_prectend       = realHost1d( "crm_output_prectend     ",crm_output_prectend_p                                     , ncrms); 
  realHost1d crm_output_precstend      = realHost1d( "crm_output_precstend    ",crm_output_precstend_p                                    , ncrms); 
  realHost2d crm_output_cld            = realHost2d( "crm_output_cld          ",crm_output_cld_p                              , plev      , ncrms); 
  realHost2d crm_output_cldtop         = realHost2d( "crm_output_cldtop       ",crm_output_cldtop_p                           , plev      , ncrms); 
  realHost2d crm_output_gicewp         = realHost2d( "crm_output_gicewp       ",crm_output_gicewp_p                           , plev      , ncrms); 
  realHost2d crm_output_gliqwp         = realHost2d( "crm_output_gliqwp       ",crm_output_gliqwp_p                           , plev      , ncrms); 
  realHost2d crm_output_mctot          = realHost2d( "crm_output_mctot        ",crm_output_mctot_p                            , plev      , ncrms); 
  realHost2d crm_output_mcup           = realHost2d( "crm_output_mcup         ",crm_output_mcup_p                             , plev      , ncrms); 
  realHost2d crm_output_mcdn           = realHost2d( "crm_output_mcdn         ",crm_output_mcdn_p                             , plev      , ncrms); 
  realHost2d crm_output_mcuup          = realHost2d( "crm_output_mcuup        ",crm_output_mcuup_p                            , plev      , ncrms); 
  realHost2d crm_output_mcudn          = realHost2d( "crm_output_mcudn        ",crm_output_mcudn_p                            , plev      , ncrms); 
  realHost2d crm_output_qc_mean        = realHost2d( "crm_output_qc_mean      ",crm_output_qc_mean_p                          , plev      , ncrms); 
  realHost2d crm_output_qi_mean        = realHost2d( "crm_output_qi_mean      ",crm_output_qi_mean_p                          , plev      , ncrms); 
  realHost2d crm_output_qs_mean        = realHost2d( "crm_output_qs_mean      ",crm_output_qs_mean_p                          , plev      , ncrms); 
  realHost2d crm_output_qg_mean        = realHost2d( "crm_output_qg_mean      ",crm_output_qg_mean_p                          , plev      , ncrms); 
  realHost2d crm_output_qr_mean        = realHost2d( "crm_output_qr_mean      ",crm_output_qr_mean_p                          , plev      , ncrms); 
  realHost2d crm_output_mu_crm         = realHost2d( "crm_output_mu_crm       ",crm_output_mu_crm_p                           , plev      , ncrms); 
  realHost2d crm_output_md_crm         = realHost2d( "crm_output_md_crm       ",crm_output_md_crm_p                           , plev      , ncrms); 
  realHost2d crm_output_eu_crm         = realHost2d( "crm_output_eu_crm       ",crm_output_eu_crm_p                           , plev      , ncrms); 
  realHost2d crm_output_du_crm         = realHost2d( "crm_output_du_crm       ",crm_output_du_crm_p                           , plev      , ncrms); 
  realHost2d crm_output_ed_crm         = realHost2d( "crm_output_ed_crm       ",crm_output_ed_crm_p                           , plev      , ncrms); 
  realHost2d crm_output_flux_qt        = realHost2d( "crm_output_flux_qt      ",crm_output_flux_qt_p                          , plev      , ncrms); 
  realHost2d crm_output_flux_u         = realHost2d( "crm_output_flux_u       ",crm_output_flux_u_p                           , plev      , ncrms); 
  realHost2d crm_output_flux_v         = realHost2d( "crm_output_flux_v       ",crm_output_flux_v_p                           , plev      , ncrms); 
  realHost2d crm_output_fluxsgs_qt     = realHost2d( "crm_output_fluxsgs_qt   ",crm_output_fluxsgs_qt_p                       , plev      , ncrms); 
  realHost2d crm_output_tkez           = realHost2d( "crm_output_tkez         ",crm_output_tkez_p                             , plev      , ncrms); 
  realHost2d crm_output_tkesgsz        = realHost2d( "crm_output_tkesgsz      ",crm_output_tkesgsz_p                          , plev      , ncrms); 
  realHost2d crm_output_tkz            = realHost2d( "crm_output_tkz          ",crm_output_tkz_p                              , plev      , ncrms); 
  realHost2d crm_output_flux_qp        = realHost2d( "crm_output_flux_qp      ",crm_output_flux_qp_p                          , plev      , ncrms); 
  realHost2d crm_output_precflux       = realHost2d( "crm_output_precflux     ",crm_output_precflux_p                         , plev      , ncrms); 
  realHost2d crm_output_qt_trans       = realHost2d( "crm_output_qt_trans     ",crm_output_qt_trans_p                         , plev      , ncrms); 
  realHost2d crm_output_qp_trans       = realHost2d( "crm_output_qp_trans     ",crm_output_qp_trans_p                         , plev      , ncrms); 
  realHost2d crm_output_qp_fall        = realHost2d( "crm_output_qp_fall      ",crm_output_qp_fall_p                          , plev      , ncrms); 
  realHost2d crm_output_qp_evp         = realHost2d( "crm_output_qp_evp       ",crm_output_qp_evp_p                           , plev      , ncrms); 
  realHost2d crm_output_qp_src         = realHost2d( "crm_output_qp_src       ",crm_output_qp_src_p                           , plev      , ncrms); 
  realHost2d crm_output_qt_ls          = realHost2d( "crm_output_qt_ls        ",crm_output_qt_ls_p                            , plev      , ncrms); 
  realHost2d crm_output_t_ls           = realHost2d( "crm_output_t_ls         ",crm_output_t_ls_p                             , plev      , ncrms); 
  realHost1d crm_output_jt_crm         = realHost1d( "crm_output_jt_crm       ",crm_output_jt_crm_p                                       , ncrms); 
  realHost1d crm_output_mx_crm         = realHost1d( "crm_output_mx_crm       ",crm_output_mx_crm_p                                       , ncrms); 
  realHost1d crm_output_cltot          = realHost1d( "crm_output_cltot        ",crm_output_cltot_p                                        , ncrms); 
  realHost1d crm_output_clhgh          = realHost1d( "crm_output_clhgh        ",crm_output_clhgh_p                                        , ncrms); 
  realHost1d crm_output_clmed          = realHost1d( "crm_output_clmed        ",crm_output_clmed_p                                        , ncrms); 
  realHost1d crm_output_cllow          = realHost1d( "crm_output_cllow        ",crm_output_cllow_p                                        , ncrms); 
  realHost2d crm_output_sltend         = realHost2d( "crm_output_sltend       ",crm_output_sltend_p                           , plev      , ncrms); 
  realHost2d crm_output_qltend         = realHost2d( "crm_output_qltend       ",crm_output_qltend_p                           , plev      , ncrms); 
  realHost2d crm_output_qcltend        = realHost2d( "crm_output_qcltend      ",crm_output_qcltend_p                          , plev      , ncrms); 
  realHost2d crm_output_qiltend        = realHost2d( "crm_output_qiltend      ",crm_output_qiltend_p                          , plev      , ncrms); 
  realHost4d crm_output_tk             = realHost4d( "crm_output_tk           ",crm_output_tk_p            ,   crm_nz, crm_ny    , crm_nx , ncrms); 
  realHost4d crm_output_tkh            = realHost4d( "crm_output_tkh          ",crm_output_tkh_p           ,   crm_nz, crm_ny    , crm_nx , ncrms);
  realHost4d crm_output_qcl            = realHost4d( "crm_output_qcl          ",crm_output_qcl_p           ,   crm_nz, crm_ny    , crm_nx , ncrms);
  realHost4d crm_output_qci            = realHost4d( "crm_output_qci          ",crm_output_qci_p           ,   crm_nz, crm_ny    , crm_nx , ncrms);
  realHost4d crm_output_qpl            = realHost4d( "crm_output_qpl          ",crm_output_qpl_p           ,   crm_nz, crm_ny    , crm_nx , ncrms);
  realHost4d crm_output_qpi            = realHost4d( "crm_output_qpi          ",crm_output_qpi_p           ,   crm_nz, crm_ny    , crm_nx , ncrms);
  realHost1d crm_output_z0m            = realHost1d( "crm_output_z0m          ",crm_output_z0m_p                                          , ncrms); 
  realHost1d crm_output_taux           = realHost1d( "crm_output_taux         ",crm_output_taux_p                                         , ncrms); 
  realHost1d crm_output_tauy           = realHost1d( "crm_output_tauy         ",crm_output_tauy_p                                         , ncrms); 
  realHost1d crm_output_precc          = realHost1d( "crm_output_precc        ",crm_output_precc_p                                        , ncrms); 
  realHost1d crm_output_precl          = realHost1d( "crm_output_precl        ",crm_output_precl_p                                        , ncrms); 
  realHost1d crm_output_precsc         = realHost1d( "crm_output_precsc       ",crm_output_precsc_p                                       , ncrms); 
  realHost1d crm_output_precsl         = realHost1d( "crm_output_precsl       ",crm_output_precsl_p                                       , ncrms); 
  realHost3d crm_output_prec_crm       = realHost3d( "crm_output_prec_crm     ",crm_output_prec_crm_p                , crm_ny    , crm_nx , ncrms);  
  ...
  ::crm_rad_qi                = real4d();
  ::crm_rad_cld               = real4d();
  ::crm_output_timing_factor  = real1d();
...
real4d crm_rad_qi; 
real4d crm_rad_cld; 
real1d crm_output_timing_factor;
