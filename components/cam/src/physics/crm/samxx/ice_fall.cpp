...
void ice_fall() {
  ...
  //       for (int icrm=0; icrm<ncrms; icrm++) {
  parallel_for(
      Bounds<4>(nz, ny, nx, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) { fz(k, j, i, icrm) = 0.0; });
  ...
  //       for (int icrm=0; icrm<ncrms; icrm++) {
  parallel_for(
      Bounds<4>(nz, ny, nx, ncrms), YAKL_LAMBDA(int k, int j, int i, int icrm) {
  ...
  //    for (int icrm=0; icrm<ncrms; icrm++) {
  parallel_for(
      Bounds<3>(ny, nx, ncrms), YAKL_LAMBDA(int j, int i, int icrm) { fz(nz - 1, j, i, icrm) = 0.0; });
