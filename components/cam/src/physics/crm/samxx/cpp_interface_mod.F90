...
module cpp_interface_mod
  ...
  interface
    ...
    subroutine crm(ncrms_in, dt_gl, plev, crm_input_bflxls, crm_input_wndls, crm_input_zmid, crm_input_zint, &
                   ...
                   crm_output_precsl, crm_output_prec_crm, lat0, long0, gcolp, igstep) bind(C,name="crm")
      use params, only: crm_rknd, crm_iknd, crm_lknd
      implicit none
      integer(crm_iknd), value :: ncrms_in, plev, igstep
      real(crm_rknd), value :: dt_gl
