  ...
  parallel_for(
      Bounds<3>(nzm, nx, ncrms), YAKL_LAMBDA(int k, int i, int icrm) {
        ...
        if (k >= 1 && k <= nzm - 2) {
          ...
          real tmp5 = ((u(kc, j + offy_u, ic + offx_u, icrm) - u0(kc, icrm) - u(k, j + offy_u, ic + offx_u, icrm) +
                        u0(k, icrm)) *
                           rdzw_up +
          ...
          real tmp7 = ((u(k, j + offy_u, ic + offx_u, icrm) - u0(k, icrm) - u(kb, j + offy_u, ic + offx_u, icrm) +
                        u0(kb, icrm)) *
                           rdzw_dn +
          ...
          real tmp10 =
              ((v(k, j + offy_v, i + offx_v, icrm) - v0(k, icrm) - v(kb, j + offy_v, i + offx_v, icrm) + v0(kb, icrm)) *
               rdzw_dn);
          def2(k, j, i, icrm) =
              2.0 * (tmp1 * tmp1 + tmp2 * tmp2) + 0.5 * (tmp3 * tmp3 + tmp4 * tmp4 + tmp5 * tmp5 + tmp6 * tmp6 +
          ...
          real tmp5 =
              ((v(kc, j + offy_v, i + offx_v, icrm) - v0(kc, icrm) - v(k, j + offy_v, i + offx_v, icrm) + v0(k, icrm)) *
               rdzw_up);
          real tmp6 = ((u(kc, j + offy_u, ic + offx_u, icrm) - u0(kc, icrm) - u(k, j + offy_u, ic + offx_u, icrm) +
                        u0(k, icrm)) *
                           rdzw_up +
                       (w(kc, j + offy_w, ic + offx_w, icrm) - w(kc, j + offy_w, i + offx_w, icrm)) * rdx_up);
          real tmp7 =
          ...
          real tmp5 =
              ((v(k, j + offy_v, i + offx_v, icrm) - v0(k, icrm) - v(kb, j + offy_v, i + offx_v, icrm) + v0(kb, icrm)) *
               rdzw_dn);
          real tmp6 = ((u(k, j + offy_u, ic + offx_u, icrm) - u0(k, icrm) - u(kb, j + offy_u, ic + offx_u, icrm) +
                        u0(kb, icrm)) *
                       rdzw_dn);
