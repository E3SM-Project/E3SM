...
subroutine crm_history_init(species_class)
   ...
   call addfld('SPQTLS   ',(/'lev'/), 'A','kg/kg/s','L.S. Total Water Forcing in CRM' )
   call addfld('SPTLS    ',(/'lev'/), 'A','kg/kg/s','L.S. LIWSE Forcing in CRM' )
   ...
   call addfld('SPKVH     ',(/'ilev'/),'A','m2/s',  'Vertical diffusivity in dropmixnuc for MMF')
