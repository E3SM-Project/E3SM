!-----------------------------------------------------------------------
! $Id: parameters_tunable.F90 7893 2015-08-26 19:03:58Z raut@uwm.edu $
!===============================================================================
...
!$omp threadprivate(l_prescribed_avg_deltaz)
  ...
  subroutine clubb_param_readnl(filename)
    ...
    clubb_lambda0_stability_coef = init_value
   ...
   call mpibcast(clubb_lambda0_stability_coef,      1, mpir8,  0, mpicom)
#endif
...
!    write(*,nml=initvars) ! %% debug
  ...
  subroutine read_parameters( iunit, filename, params )
    ...
    if (clubb_lambda0_stability_coef /= init_value) lambda0_stability_coef = clubb_lambda0_stability_coef
