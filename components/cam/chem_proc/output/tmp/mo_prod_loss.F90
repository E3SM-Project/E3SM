...
!--------------------------------------------------------------------
         ...
         prod(33) = 0._r8
         loss(34) = ( + het_rates(35))* y(35)
         prod(34) = 0._r8
         loss(35) = ( + het_rates(36))* y(36)
         prod(35) = 0._r8
         loss(36) = ( + het_rates(37))* y(37)
         prod(36) = 0._r8
         loss(37) = ( + het_rates(38))* y(38)
         prod(37) = 0._r8
         loss(38) = ( + het_rates(39))* y(39)
         prod(38) = 0._r8
         loss(39) = ( + het_rates(40))* y(40)
         prod(39) = 0._r8
         loss(40) = ( + het_rates(41))* y(41)
         prod(40) = 0._r8
         loss(41) = ( + het_rates(42))* y(42)
         prod(41) = 0._r8
         loss(42) = ( + het_rates(43))* y(43)
         prod(42) = 0._r8
         loss(43) = ( + het_rates(44))* y(44)
         prod(43) = 0._r8
         loss(44) = ( + het_rates(45))* y(45)
         prod(44) = 0._r8
         loss(45) = ( + het_rates(46))* y(46)
         prod(45) = 0._r8
         loss(46) = ( + het_rates(47))* y(47)
         prod(46) = 0._r8
         loss(47) = ( + het_rates(48))* y(48)
         prod(47) = 0._r8
         loss(48) = ( + het_rates(49))* y(49)
         prod(48) = 0._r8
         loss(49) = ( + het_rates(50))* y(50)
         prod(49) = 0._r8
         loss(50) = ( + het_rates(51))* y(51)
         prod(50) = 0._r8
         loss(51) = ( + het_rates(52))* y(52)
         prod(51) = 0._r8
         loss(52) = ( + het_rates(53))* y(53)
         prod(52) = 0._r8
         loss(53) = ( + het_rates(54))* y(54)
         prod(53) = 0._r8
         loss(54) = ( + het_rates(55))* y(55)
         prod(54) = 0._r8
         loss(55) = ( + het_rates(56))* y(56)
         prod(55) = 0._r8
