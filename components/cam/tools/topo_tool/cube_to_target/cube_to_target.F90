...
subroutine usage()
   ...
   print *, '  --target-grid <filename>            Target grid template in SCRIP format   '
   ...
   print *, '                                                                             '
   print *, 'DESCRIPTION:                                                                 '
   print *, 'This code generates topography on a target grid from a high resolution USGS  '
   print *, 'topography on a cube-sphere grid. The code is documented in:                 '
   print *, '                                                                             '
