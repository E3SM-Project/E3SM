module ColumnDataType
  ...
  type, public :: column_carbon_state
    ...
    real(r8), pointer :: dyn_nonconserved_cflux (:)  => null() ! (gC/m2) carbon in/out of a special-landunit column during dynamic column area adjustments
  ...
  type, public :: column_nitrogen_state
    ...
    real(r8), pointer :: dyn_nonconserved_nflux   (:)     => null() ! (gN/m2) nitrogen in/out of a special-landunit column during dynamic column area adjustments
  ...
  type, public :: column_phosphorus_state
    ...
    real(r8), pointer :: dyn_nonconserved_pflux   (:)      => null() ! (gP/m2) phosphorus in/out of a special-landunit column during dynamic column area adjustments
