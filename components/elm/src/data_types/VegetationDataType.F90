module VegetationDataType
    ...
    if (use_fates) then
       ...
       if (crop_prog) then
          ...
          call hist_addfld1d (fname='GRAINC', units='gC/m^2', &
                ...
                ptr_patch=this%grainc, default='active')
    ...
    if (use_fates) then
       ...
       if (crop_prog) then
          ...
          call hist_addfld1d (fname='GRAINC_TO_FOOD', units='gC/m^2/s', &
               ...
               ptr_patch=this%grainc_to_food, default='active')
       end if
  ...
  subroutine veg_pf_init(this, begp, endp)
    ...
    allocate(this%sminp_to_plant_trans                (begp:endp)) ; this%sminp_to_plant_trans                (:) = spval
