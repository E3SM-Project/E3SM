...
contains
  ...
  !-----------------------------------------------------------------------
  subroutine NitrogenStateUpdate3Soil(num_soilc, filter_soilc, num_soilp, filter_soilp, dt)
    !
    ! !DESCRIPTION:
  ...
  !-----------------------------------------------------------------------
  subroutine NitrogenStateUpdate3Veg(num_soilc, filter_soilc, num_soilp, filter_soilp, dt)
    !
    ! !DESCRIPTION:
    ! On the radiation time step, update all the prognostic nitrogen state
    ! variables affected by gap-phase mortality fluxes. Also the Sminn leaching flux.
  ...
  subroutine NitrogenStateUpdate3(num_soilc, filter_soilc, num_soilp, filter_soilp, dt)
    ...
    call NitrogenStateUpdate3Soil(num_soilc, filter_soilc, num_soilp, filter_soilp, dt)
