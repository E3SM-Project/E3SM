...
!/
      ...
      REAL                    :: BETA, CM,ZCO,UCO,UCN,ZCN, &
                                 Z0VISC
      REAL                   :: HSBLOW, ABJSEA, FACTOR
      REAL XI,DELI1,DELI2
      REAL XJ,DELJ1,DELJ2
      REAL XK,DELK1,DELK2
      REAL                    :: CONST, CONST0, CONST1, CONST2, CONST3,  TAU1
...
!/ ------------------------------------------------------------------- /
      ...
      USE W3GDATMD,  ONLY: SIG, DSIP, NK, NTH,  &
...
!/ ------------------------------------------------------------------- /
      USE CONSTANTS
      USE W3GDATMD, ONLY: NSPEC, NTH, NK, DDELTA1, DDEN, DDELTA2,   &
                          SSDSC1, SIG, SSDSP, ECOS, ESIN, DTH, DSIP
!
      IMPLICIT NONE
!/
!/ ------------------------------------------------------------------- /
...
!/ Local parameters
!/
      INTEGER                 :: IS, IS2, IS0, IA, J, IKL, ITOT, NTOT, ID, NKL
      INTEGER                 :: IK, ITH, I_INT, IK2, ITH2, IKIND, L, IKHS, IKD
      REAL                    :: FACTOR, FACTOR2
