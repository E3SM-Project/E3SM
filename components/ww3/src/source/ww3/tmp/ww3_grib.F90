...
!
      CALL NEXTLN ( COMSTR , NDSI , NDSE )
      READ (NDSI,*,END=801,ERR=802) FTIME, CID, PID, GID, GDS
!
...
!
 1002 FORMAT (/' *** WAVEWATCH III ERROR IN W3GRIB : '/               &
               ...
               '     IOSTAT =',I5/)
!
 1005 FORMAT (/' *** WAVEWATCH III ERROR IN W3GRIB : '/               &
               '     OUTPUT REQUESTED FOR FIELDS THAT SHARE KPDS(5)'/ &
               '     FIRST FIELD  : ',A/                              &
               '     SECOND FIELD : ',A/)
!
