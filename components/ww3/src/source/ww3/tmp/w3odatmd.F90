...
!/
      TYPE OUTPUT
        ...
        INTEGER               :: NOSWLL
        INTEGER               :: TOFRST(2), TONEXT(2,7), TOLAST(2,7), &
...
!/
      ...
      INTEGER, POINTER        :: IRQGO(:), IRQGO2(:)
      LOGICAL, POINTER        :: FLOGRD(:,:), FLOGR2(:,:), FLOGD(:), &
                                 FLOG2(:), WRITE1
!/
!/ Type 2 ...
!/
...
!
      NOGE(4) = 8
!
      IDOUT( 4, 1)  = 'Part. wave heigt    '
      IDOUT( 4, 2)  = 'Part. peak period   '
      IDOUT( 4, 3)  = 'Part. peak wave l.  '
      IDOUT( 4, 4)  = 'Part. mean direction'
      IDOUT( 4, 5)  = 'Part. dir. spread   '
      IDOUT( 4, 6)  = 'Part. wind sea frac.'
      IDOUT( 4, 7)  = 'Total wind sea frac.'
      IDOUT( 4, 8)  = 'Number of partitions'
!
...
!      IDOUT( 5,11)  = 'Breaker passage rate'
!
! 6) Wave-ocean layer
!
      NOGE(6) = 9
