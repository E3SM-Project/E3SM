...
!/
      ...
      INTEGER   IX, IY, ISEA, I,JJ,IP,IP1,IP2,J,K,ITIME,          &
                NDSI,NDSM, NDSI2,NDSS,NDSB, NDSTRC, NTRACE, &
                NK1,NTH1,NSPEC1, NBI, NBI2,           &
                NKI, NTHI, NBO, NBO2, IERR, INTERP, N3, OVER, ILOOP, &
               IFMIN, IFMIN2, IFMAX, VERBOSE
      INTEGER     np,npar,Jfp, IBO
      INTEGER     iostat,finished
      INTEGER(KIND=4) Jday,Jdays,Jdayend,Jdayfile
      REAL   , DIMENSION(:),     ALLOCATABLE :: SPEC, LATS, LONS
      REAL   , DIMENSION(:,:),   ALLOCATABLE :: SPEC2D
      REAL   , DIMENSION(:),     ALLOCATABLE :: FREQ, THETA
      REAL   XFRI, FR1I, TH1I, DTH1
      ...
      DOUBLE PRECISION timemod,timeobs1,timeobs2
      INTEGER(KIND=4), DIMENSION(:,:),  ALLOCATABLE ::  Jdayobs
      DOUBLE PRECISION, DIMENSION(:,:),  ALLOCATABLE ::  Dateobs
      CHARACTER(120) string1,string2,buoyname
      CHARACTER space
