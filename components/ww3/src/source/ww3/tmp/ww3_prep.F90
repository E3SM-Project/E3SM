...
!/
      ...
      INTEGER                 :: NXT, NYT, GTYPET, FILLER(2), TFLAGT
      INTEGER                 :: NYB
      INTEGER                 :: ILAND = -999
...
!
 ...
 1037 FORMAT (/' *** WAVEWATCH III ERROR IN W3PREP : '/               &
