...
!====================================================================================
  ...
  subroutine rof_import_mct( x2r_r)
    ...
    do n = begr,endr
       ...
       rtmCTL%dunm(n,nliq) = x2r_r%rAttr(index_x2r_Flrl_demand_unmet,n2) * (rtmCTL%area(n)*0.001_r8)
       rtmCTL%dtot(n,nliq) = x2r_r%rAttr(index_x2r_Flrl_demand_total,n2) * (rtmCTL%area(n)*0.001_r8)
