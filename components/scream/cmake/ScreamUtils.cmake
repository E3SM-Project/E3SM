  ...
  while (CURR_RANKS LESS_EQUAL ${MPI_END_RANK})
    while (CURR_THREADS LESS_EQUAL ${THREAD_END})
      ...
      IF (${CURR_RANKS} GREATER 1)
        ADD_TEST(${target_name}_ut_np${CURR_RANKS}_omp${CURR_THREADS} mpiexec -np ${CURR_RANKS} ${SCREAM_MPI_EXTRA_ARGS} ${target_name} ENVIRONMENT OMP_NUM_THREADS=${CURR_THREADS})
      ELSE()
        ADD_TEST(${target_name}_ut_np1_omp${CURR_THREADS} ${target_name} ENVIRONMENT OMP_NUM_THREADS=${CURR_THREADS})
      ENDIF()
