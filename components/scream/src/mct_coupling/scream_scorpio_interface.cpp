...
// Fortran routines to be called from C++
  ...
  void grid_write_data_array_c_real_2d(const std::string &filename, const std::string &varname, const Int dim1_length, const Int dim2_length, const Real hbuf[dim1_length][dim2_length]);
  void grid_write_data_array_c_real_3d(const std::string &filename, const std::string &varname, const Int dim1_length, const Int dim2_length, const Int dim3_length, const Real hbuf[dim1_length][dim2_length][dim3_length]);
  void grid_write_data_array_c_real_4d(const std::string &filename, const std::string &varname, const Int dim1_length, const Int dim2_length, const Int dim3_length, const Int dim4_length, const Real hbuf[dim1_length][dim2_length][dim3_length][dim4_length]);
  ...
  void grid_write_data_array_c_int_2d(const std::string &filename, const std::string &varname, const Int dim1_length, const Int dim2_length, const Int hbuf[dim1_length][dim2_length]);
  void grid_write_data_array_c_int_3d(const std::string &filename, const std::string &varname, const Int dim1_length, const Int dim2_length, const Int dim3_length, const Int hbuf[dim1_length][dim2_length][dim3_length]);
  void grid_write_data_array_c_int_4d(const std::string &filename, const std::string &varname, const Int dim1_length, const Int dim2_length, const Int dim3_length, const Int dim4_length, const Int hbuf[dim1_length][dim2_length][dim3_length][dim4_length]);
  ...
  void register_variable_c(const std::string& filename,const std::string& shortname, const std::string& longname, const int numdims, const std::string (&var_dimensions)[numdims], const int dtype, const std::string& pio_decomp_tag);
