...
void SHOCMacrophysics::initialize_impl (const RunType /* run_type */)
{
  ...
  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("T_mid"),140.0,500.0);
  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("qv"),1e-13,0.2);
  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("qc"),0.0,0.1);
  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("horiz_winds"),-400.0,400.0);
  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("pbl_height"),0.0,3000.0);
  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("cldfrac_liq"),0.0,1.0);
