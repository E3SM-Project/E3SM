...
{
  SHOCPblintdCldCheckData cldcheck_data_f90[] = {
    //                      shcol, nlev, nlevi
    SHOCPblintdCldCheckData(36,  128, 129),
    SHOCPblintdCldCheckData(72,  128, 129),
    SHOCPblintdCldCheckData(128, 128, 129),
    SHOCPblintdCldCheckData(256, 128, 129),
  };

  static constexpr Int num_runs = sizeof(cldcheck_data_f90) / sizeof(SHOCPblintdCldCheckData);

  for (auto& d : cldcheck_data_f90) {
    d.randomize();
  }

  SHOCPblintdCldCheckData cldcheck_data_cxx[] = {
    SHOCPblintdCldCheckData(cldcheck_data_f90[0]),
    SHOCPblintdCldCheckData(cldcheck_data_f90[1]),
    SHOCPblintdCldCheckData(cldcheck_data_f90[2]),
    SHOCPblintdCldCheckData(cldcheck_data_f90[3]),
  };
