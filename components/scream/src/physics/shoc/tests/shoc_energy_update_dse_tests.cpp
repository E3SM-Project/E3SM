...
TEST_CASE("shoc_energy_host_dse", "shoc") {
  ...
  Real thlm[nlev] = {350.0, 325.0, 315.0, 310.0, 300.0};
  // Exner function [-]
  Real exner[nlev] = {0.1, 0.3, 0.5, 0.7, 1.0};
  // Cloud condensate [g/kg] (converted to kg/kg when input)
  Real shoc_ql[nlev] = {0.005, 0.08, 0.04, 0.03, 0.001};
  // Mid-point heights [m]
  Real zt_grid[nlev] = {9000.0, 6000.0, 4000.0, 2000.0, 1000.0};
