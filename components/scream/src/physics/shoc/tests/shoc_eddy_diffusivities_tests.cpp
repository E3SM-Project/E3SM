...
TEST_CASE("shoc_tke_eddy_diffusivities", "shoc") {
  ...
  Real shoc_mix_reg = 1000.0;
  // Shear term [s-2]
  Real sterm_zt_reg = 0.1;
  ...
  // SHOC Mixing length [m]
  Real shoc_mix_stab[shcol] = {500.0, 550.0};
  // Shear term [s-2]
  Real sterm_zt_stab[shcol] = {0.1, 0.2};
  // Return to isotropy timescale [s]
  ...
  // SHOC Mixing length [m]
  Real shoc_mix_ustab = 500.0;
  // Shear term [s-2]
  Real sterm_zt_ustab = 0.1;
  // Return to isotropy timescale [s]
