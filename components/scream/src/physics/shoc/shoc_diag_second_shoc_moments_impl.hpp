...
KOKKOS_FUNCTION
void Functions<S,D>::diag_second_shoc_moments(const Int& shcol, const Int& nlev, const Int& nlevi, 
                          ...
                          const uview_1d<const Spack>& wthl_sfc, const uview_1d<const Spack>& wqw_sfc, const uview_1d<const Spack>& uw_sfc, 
                          const uview_1d<const Spack>& vw_sfc, const uview_1d<Spack>& thl_sec, const uview_1d<Spack>& qw_sec, 
