...
struct Functions
{
  ...
  KOKKOS_FUNCTION
  static void compute_shr_prod(const Int& nlevi, const Int& nlev, const Int& shcol, const uview_1d<const Spack>& dz_zi, const uview_1d<const Spack>& u_wind, const uview_1d<const Spack>& v_wind, const uview_1d<Spack>& sterm);
}; // struct Functions
