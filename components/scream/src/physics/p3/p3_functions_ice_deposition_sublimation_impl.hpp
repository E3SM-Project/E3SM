#ifndef P3_FUNCTIONS_ICE_DEPOSITION_SUBLIMATION_IMPL_HPP
#define P3_FUNCTIONS_ICE_DEPOSITION_SUBLIMATION_IMPL_HPP
                             ...
                             const Smask& context)
{
  ...
  qiberg.set(!qitot_incld_not_small && context, 0);
  qidep.set(!qitot_incld_not_small  && context, 0);
  qisub.set(!qitot_incld_not_small  && context, 0);
  nisub.set(!qitot_incld_not_small  && context, 0);
}
