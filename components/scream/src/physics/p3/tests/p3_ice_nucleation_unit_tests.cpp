...
struct UnitWrap::UnitTest<D>::TestIceNucleation {
  ...
  static void run_ice_nucleation_bfb()
  {
    ...
    constexpr bool   do_predict_nc = false;
    ...
    Kokkos::parallel_for(num_test_itrs, KOKKOS_LAMBDA(const Int& i) {
      ...
      Functions::ice_nucleation(temp, inv_rho, ni, ni_activated, qv_supersat_i, self_device(0).inv_dt, do_predict_nc, qv2qi_nucleat_tend, ni_nucleat_tend);
