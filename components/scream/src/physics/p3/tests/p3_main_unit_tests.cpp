...
static void run_bfb_p3_main_pre_loop()
{
  ...
  P3MainPreLoopData isds_fortran[] = {
    ...
    P3MainPreLoopData(1,  72,   27,   72,   -1, 1.800E+03, 5.556E-04,     0.0, ranges),
    P3MainPreLoopData(1,  72,   72,   27,    1, 1.800E+03, 5.556E-04,     1.0, ranges),
    P3MainPreLoopData(1,  72,   27,   27,   -1, 1.800E+03, 5.556E-04,     0.0, ranges),
    P3MainPreLoopData(1,  72,   27,   27,    1, 1.800E+03, 5.556E-04,     2.0, ranges),
  };
