...
struct Constants
{
  ...
  static constexpr Scalar INV_RHOW    = 1/RHOW;
  ...
  static constexpr Scalar INV_RHO_RIMEMAX  =  1/RHO_RIMEMAX; // Inverse for limits for rime density [kg m-3]
  ...
  static constexpr Scalar CONS3       = 1/(CONS2*sp(1.562500000000000e-14)); // 1./(CONS2*pow(25.e-6,3.0));
  static constexpr Scalar CONS5       = PIOV6*BIMM;
  static constexpr Scalar CONS6       = PIOV6*PIOV6*RHOW*BIMM;
  static constexpr Scalar CONS7       = 4*PIOV3*RHOW*sp(1.e-18);
  ...
  static constexpr Scalar INV_CP      = 1/CP;
