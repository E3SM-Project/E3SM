#ifndef P3_FUNCTIONS_ICE_CLDLIQ_WET_GROWTH_IMPL_HPP
                        ...
                        Smask& log_wetgrowth, Spack& qrcol, Spack& qccol, Spack& qwgrth, Spack& nrshdr, Spack& qcshd)
{
   ...
   const auto any_if     = qitot_incld_ge_small && qc_qr_incld_ge_small && t_is_negative;
   ...
   if (any_if.any()) {
      ...
      auto const dum_ge_small = dum >= sp(1.0e-10);
