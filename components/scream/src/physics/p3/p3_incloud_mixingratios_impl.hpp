  ...
  const Smask& context)
{
   ...
   qi_incld.set(any_gt_limit,
                   pack::min(qi_incld, incloud_limit));
   bm_incld.set(any_gt_limit,
                   pack::min(bm_incld, incloud_limit));
