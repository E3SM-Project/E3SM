...
void Functions<S,D>::
get_cloud_dsd2(const Spack& qc, Spack& nc, Spack& mu_c, const Spack& rho, Spack& nu,
               const view_dnu_table& dnu, Spack& lamc, Spack& cdist, Spack& cdist1, const Spack& lcldm, const Smask& context)
{
  lamc.set(context, 0);
  cdist.set(context, 0);
