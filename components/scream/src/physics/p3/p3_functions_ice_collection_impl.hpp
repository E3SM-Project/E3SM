                        ...
                        const Smask& context)
{
  ...
  const auto both_gt_small        = qitot_incld_gt_small && qc_incld_gt_small;
  ...
  qccol.set(both_gt_small && t_is_negative && context,
            rhofaci*f1pr04*qc_incld*eci*rho*nitot_incld);
  nccol.set(both_gt_small && context, rhofaci*f1pr04*nc_incld*eci*rho*nitot_incld);
  ...
  qcshd.set(both_gt_small_pos_t && context, rhofaci*f1pr04*qc_incld*eci*rho*nitot_incld);
  nccol.set(both_gt_small_pos_t && context, rhofaci*f1pr04*nc_incld*eci*rho*nitot_incld);
  // source for rain number, assume 1 mm drops are shed
  ncshdc.set(both_gt_small_pos_t && context, qcshd*inv_dropmass);
}
                      ...
                      const Smask& context)
{
   ...
   const auto both_gt_small        = qitot_incld_ge_small && qr_incld_ge_small;
   ...
   qrcol.set(both_gt_small_neg_t && context, pack::pow(ten, f1pr08+logn0r)*rho*rhofaci*eri*nitot_incld);
   nrcol.set(both_gt_small_neg_t && context, pack::pow(ten, f1pr07+logn0r)*rho*rhofaci*eri*nitot_incld);
   ...
   nrcol.set(both_gt_small && !t_is_negative && context,
