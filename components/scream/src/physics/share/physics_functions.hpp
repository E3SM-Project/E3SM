...
struct Functions
{
  ...
  KOKKOS_FUNCTION
  static Spack polysvp1(const Spack& t, const bool ice, const Smask& range_mask, const char* caller="");
  ...
  //  ice refers to saturation with respect to liquid (false) or ice (true)
  KOKKOS_FUNCTION
  static Spack MurphyKoop_svp(const Spack& t, const bool ice, const Smask& range_mask, const char* caller="");

  // Calls a function to obtain the saturation vapor pressure, and then computes
  // and returns the saturation mixing ratio, with respect to either liquid or ice,
  // depending on value of 'ice'
  KOKKOS_FUNCTION
  static Spack qv_sat(const Spack& t_atm, const Spack& p_atm, const bool ice, const Smask& range_mask, const SaturationFcn func_idx = MurphyKoop, const char* caller="");
