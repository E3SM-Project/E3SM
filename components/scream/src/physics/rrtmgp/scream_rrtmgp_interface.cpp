...
namespace scream {
    namespace rrtmgp {
         ...
         */
        std::string coefficients_file_sw = SCREAM_DATA_DIR "/rrtmgp-data-sw-g224-2018-12-04.nc";
        std::string coefficients_file_lw = SCREAM_DATA_DIR "/rrtmgp-data-lw-g256-2018-12-04.nc";
        std::string cloud_optics_file_sw = SCREAM_DATA_DIR "/rrtmgp-cloud-optics-coeffs-sw.nc";
        std::string cloud_optics_file_lw = SCREAM_DATA_DIR "/rrtmgp-cloud-optics-coeffs-lw.nc";
