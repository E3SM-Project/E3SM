...
// Fortran routines to be called from C++
  ...
  void grid_read_data_array_c2f_real(const char*&& filename, const char*&& varname, const Int time_index, Real *&hbuf);
  void grid_read_data_array_c2f_int(const char*&& filename, const char*&& varname, const Int time_index, Int *&hbuf);
...
/* ----------------------------------------------------------------- */
void grid_read_data_array(const std::string &filename, const std::string &varname, const int time_index, Int *hbuf) {
  grid_read_data_array_c2f_int(filename.c_str(),varname.c_str(),time_index,hbuf);
}
/* ----------------------------------------------------------------- */
void grid_read_data_array(const std::string &filename, const std::string &varname, const int time_index, Real *hbuf) {
  grid_read_data_array_c2f_real(filename.c_str(),varname.c_str(),time_index,hbuf);
}
/* ----------------------------------------------------------------- */
