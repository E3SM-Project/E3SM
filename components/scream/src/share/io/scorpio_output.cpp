...
void AtmosphereOutput::init()
{
  ...
  EKAT_REQUIRE_MSG(m_grid_name=="Physics" || m_grid_name=="Physics GLL","Error with output grid! scorpio_output.hpp class only supports output on a Physics grid for now.\n");
