...
TEST_CASE("cld_fraction-stand-alone", "") {
  ...
  const auto& liq_cld_frac_field = field_repo.get_field("cldfrac_liq","Physics");  //TODO: This FM name will probably change soon.
  ...
  const auto& ice_cld_frac_field = field_repo.get_field("cldfrac_ice","Physics");  //TODO: This FM name will probably change soon.
  const auto& tot_cld_frac_field = field_repo.get_field("cldfrac_tot","Physics");   //TODO: This FM name will probably change soon.
