...
sum(sum(crop2_2deg.*cellarea_2deg))-sum(sum(crop1_2deg.*cellarea_2deg))-(sum(sum(crop2.*cellarea_half_deg))-sum(sum(crop1.*cellarea_half_deg)))
    ...
    % check that neither crop nor pasture nor urban exceeds 1 and compute the "unmet"
    % amount
    ...
    % amount
    eval(['exceed_avail_land_',num2str(years(ind+1)),'=GLMcrop',num2str(years(ind+1)),'_2deg+GLMpast',num2str(years(ind+1)),'_2deg+GLMurbn',num2str(years(ind+1)),'_2deg-landarea;'])
    eval(['unmetcrop',num2str(years(ind+1)),'=GLMcrop',num2str(years(ind+1)),'_2deg./(GLMcrop',num2str(years(ind+1)),'_2deg+GLMpast',num2str(years(ind+1)),'_2deg+1e-12).*exceed_avail_land_',num2str(years(ind+1)),'.*(exceed_avail_land_',num2str(years(ind+1)),'>0);'])
    eval(['unmetpast',num2str(years(ind+1)),'=GLMpast',num2str(years(ind+1)),'_2deg./(GLMcrop',num2str(years(ind+1)),'_2deg+GLMpast',num2str(years(ind+1)),'_2deg+1e-12).*exceed_avail_land_',num2str(years(ind+1)),'.*(exceed_avail_land_',num2str(years(ind+1)),'>0);'])
    ...
    eval(['GLMcrop',num2str(years(ind+1)),'_2deg=GLMcrop',num2str(years(ind+1)),'_2deg-unmetcrop',num2str(years(ind+1)),'.*(exceed_avail_land_',num2str(years(ind+1)),'>0);'])
    eval(['GLMpast',num2str(years(ind+1)),'_2deg=GLMpast',num2str(years(ind+1)),'_2deg-unmetpast',num2str(years(ind+1)),'.*(exceed_avail_land_',num2str(years(ind+1)),'>0);'])
    ...
    eval(['GLMurbn',num2str(years(ind+1)),'=GLMurbn',num2str(years(ind)),';'])
    ...
    for i=1:90
        for j=1:180
            ...
            eval(['avail_land = landarea_halfdeg(4*i-(0:3),4*j-3:4*j)-GLMcrop',num2str(years(ind)),'(4*i-(0:3),4*j-3:4*j)-GLMpast',num2str(years(ind)),'(4*i-(0:3),4*j-3:4*j)-GLMurbn',num2str(years(ind)),'(4*i-(0:3),4*j-3:4*j);'])
            ...
            if crop_d<=0
                ...
                if (sum(sum(avail_land.*cellarea_half_deg(4*i-(0:3),4*j-3:4*j)))<sum(sum(crop_d.*cellarea_2deg(i,j))))&(past_d<0)
                    ...
                    eval(['avail_land_crop = landarea_halfdeg(4*i-(0:3),4*j-3:4*j)-GLMcrop',num2str(years(ind)),'(4*i-(0:3),4*j-3:4*j)-GLMpast',num2str(years(ind+1)),'(4*i-(0:3),4*j-3:4*j)-GLMurbn',num2str(years(ind+1)),'(4*i-(0:3),4*j-3:4*j);'])
...
%interpolate to annual grids
    ...
    for k=1:(length(annual)-1)
        ...
        dlmwrite(['processed/urban/gurbn.', num2str(annual(k)), '.txt'], eval(['GLMurbn',num2str(years(ind+1))]) ,'precision','%.6f','delimiter',' ');
        dlmwrite(['processed/urban/gothr.', num2str(annual(k)), '.txt'], eval(['landarea_halfdeg-GLMpast',num2str(annual(k)),'-GLMcrop',num2str(annual(k)),'-GLMurbn',num2str(years(ind+1))]) ,'precision','%.6f','delimiter',' ');
    end;
