...
for ind=1:(length(years)-1)
    ...
    if years(ind)==2005
        ...
        urbn1_2000=importdata('Built301/BU2000A2.asc',' ',5);
        urbn1_2010=importdata('Built301/BU2010A2.asc',' ',5);
        urbn1_2000=urbn1_2000.data/100;
        urbn1_2010=urbn1_2010.data/100;
        urbn1=(urbn1_2000+urbn1_2010)/2;
        
        urbn2=importdata('Built301/BU2010A2.asc',' ',5);
        urbn2=urbn2.data/100;
        ...
        urbn1=importdata(['Built301/BU',num2str(years(ind)),'A2.asc'],' ',5);
        urbn2=importdata(['Built301/BU',num2str(years(ind+1)),'A2.asc'],' ',5);
