...
#ifndef _CCSM_SCENARIO_RUNNER_H_
#define _CCSM_SCENARIO_RUNNER_H_
#if defined(_MSC_VER)
#pragma once
#endif

/*! 
 * \file ccsm_scenario_runner.h
 * \ingroup Objects
 * \brief The CcsmScenarioRunner class header file.
 * \author Josh Lurz
 */
...
/*! 
 * \ingroup Object
 * \brief A class which is responsible for running a ccsm scenario.
 * \details This class is responsible for running a ccsm scenario. The
 *          CcsmScenarioRunner will initialize a new Scenario each time
 ...
 * \author Josh Lurz
 */
class CcsmRunner: public IScenarioRunner {
    friend class ScenarioRunnerFactory;
    friend class CCSM_GCAM_interface;
public:
    ...
    void writeRestart(const int aPeriod,const int aYear) const;
...
#endif // _CCSM_SCENARIO_RUNNER_H_
