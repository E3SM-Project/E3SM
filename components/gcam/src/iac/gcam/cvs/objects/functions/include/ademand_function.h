#ifndef _ADEMAND_FUNCTION_H_
#define _ADEMAND_FUNCTION_H_
#if defined(_MSC_VER)
#pragma once
#endif
...
/*! 
* \file ademand_function.h
* \ingroup Objects
* \brief ADemandFunction abstract class header file.
*
...
public:
	...
	virtual double calcDemand( InputSet& input, double consumption,
	...
	double changeElasticity( InputSet& input, const std::string& aRegionName,
    ...
    double calcProfits( InputSet& input,const std::string& regionName, 
