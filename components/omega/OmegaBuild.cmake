...
macro(update_variables)
  ...
  if("${MPILIB_NAME}" STREQUAL "mpich")
    if(OMEGA_MPI_ON_DEVICE AND OMEGA_TARGET_DEVICE)
      file(APPEND ${_EnvScript} "export MPICH_GPU_SUPPORT_ENABLED=1\n\n")
    else()
      file(APPEND ${_EnvScript} "export MPICH_GPU_SUPPORT_ENABLED=0\n\n")
    endif()
  endif()
