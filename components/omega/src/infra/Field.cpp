...
// array.
int Field::setTypeLocation(
    const std::type_info &InType // [in] Typeid of data array
) {
   // Initialize return code and set type and location to unknown
   int Err  = 0;
   DataType = FieldType::Unknown;
   MemLoc   = FieldMemLoc::Unknown;

   std::type_index InTypeIndx = std::type_index(InType);

   // Determine data type - arrays of type Real will be equivalent
   // to R4 or R8 depending on setting in DataTypes.
   if (InTypeIndx == std::type_index(typeid(Array1DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array1DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array1DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array1DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array2DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array2DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array2DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array2DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array3DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array3DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array3DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array3DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array4DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array4DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array4DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array4DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array5DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array5DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array5DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(Array5DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Device;
   } else if (InTypeIndx == std::type_index(typeid(HostArray1DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray1DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray1DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray1DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray2DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray2DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray2DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray2DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray3DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray3DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray3DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray3DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray4DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray4DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray4DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray4DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray5DI4))) {
      DataType = FieldType::I4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray5DI8))) {
      DataType = FieldType::I8;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray5DR4))) {
      DataType = FieldType::R4;
      MemLoc   = FieldMemLoc::Host;
   } else if (InTypeIndx == std::type_index(typeid(HostArray5DR8))) {
      DataType = FieldType::R8;
      MemLoc   = FieldMemLoc::Host;
   } else { // Unknown data array
      LOG_ERROR("Unable to determine data type or location for Field {}",
                FldName);
      Err = -1;
   }

   // For some machines, the host and device locations are the same
   // so reset to Both
   if (std::type_index(typeid(HostArray1DI4)) ==
       std::type_index(typeid(Array1DI4)))
      MemLoc = FieldMemLoc::Both;
   return Err;
}
