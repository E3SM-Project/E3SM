...
class Config {
 ...
 public:
   ...
   static void
   readAll(const std::string &FileName ///< [in] input omega config file
   );
   ...
   Error get(Config &SubConfig ///< [inout] sub-configuration to retrieve
   );
   ...
   static Error
   getName(Iter ConfigIter,        ///< [in] iterator for this entry
   ...
   /// Returns a non-zero error code if the variable does not exist
   Error get(const std::string &VarName,      ///< [in] name of list to get
   ...
   void set(const std::string &VarName, ///< [in] name of variable to set
   ...
   /// Aborts if the variable is not found.
   void set(const std::string &VarName,   ///< [in] name of vector to set
            const std::vector<I4> &Vector ///< [in] vector to reset
   );

   /// Resets the value of a vector in the config
   /// Aborts if the variable is not found.
   void set(const std::string &VarName,   ///< [in] name of vector to set
            const std::vector<I8> &Vector ///< [in] vector to reset
   );

   /// Resets the value of a vector in the config
   /// Aborts if the variable is not found.
   void set(const std::string &VarName,   ///< [in] name of vector to set
            const std::vector<R4> &Vector ///< [in] vector to reset
   );

   /// Resets the value of a vector in the config
   /// Aborts if the variable is not found.
   void set(const std::string &VarName,   ///< [in] name of vector to set
            const std::vector<R8> &Vector ///< [in] vector to reset
   );

   /// Resets the value of a vector in the config
   /// Aborts if the variable is not found.
   void set(const std::string &VarName,     ///< [in] name of vector to set
            const std::vector<bool> &Vector ///< [in] vector to reset
   );

   /// Resets the value of a list in the config
   /// Aborts if the variable is not found.
   void set(const std::string &VarName,          ///< [in] name of list to set
   ...
   void add(const Config SubConfig ///< [in] Config to add
   );

   /// Adds a new variable to a configuration
   /// Aborts if the variable already exists
   void add(const std::string &VarName, ///< [in] name of variable to add
            I4 Value                    ///< [in] value of the variable
   );
   ...
   /// Aborts if the variable already exists
   void add(const std::string &VarName,   ///< [in] name of vector to add
   ...
   /// Aborts if the variable already exists
   void add(const std::string &VarName,            ///< [in] name of list to add
   ...
   void remove(const std::string &VarName ///< [in] name of variable to remove
   );
   ...
   void write(const std::string &FileName /// name of file for config
   );
