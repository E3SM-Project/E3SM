...
int main(int argc, char *argv[]) {
   ...
   OMEGA::ArrayHost1DI4 Init1DI4Cell("Init1DI4Cell", DefDecomp->NCellsSize);
   OMEGA::ArrayHost1DI4 Test1DI4Cell("Test1DI4Cell", DefDecomp->NCellsSize);
   ...
   OMEGA::ArrayHost1DI4 Init1DI4Edge("Init1DI4Edge", DefDecomp->NEdgesSize);
   OMEGA::ArrayHost1DI4 Test1DI4Edge("Test1DI4Edge", DefDecomp->NEdgesSize);
   ...
   OMEGA::ArrayHost1DI8 Init1DI8("Init1DI8", NumAll);
   OMEGA::ArrayHost1DR4 Init1DR4("Init1DR4", NumAll);
   OMEGA::ArrayHost1DR8 Init1DR8("Init1DR8", NumAll);
   OMEGA::ArrayHost2DI4 Init2DI4("Init2DI4", NumAll, N2);
   OMEGA::ArrayHost2DI8 Init2DI8("Init2DI8", NumAll, N2);
   OMEGA::ArrayHost2DR4 Init2DR4("Init2DR4", NumAll, N2);
   OMEGA::ArrayHost2DR8 Init2DR8("Init2DR8", NumAll, N2);
   OMEGA::ArrayHost3DI4 Init3DI4("Init3DI4", N3, NumAll, N2);
   OMEGA::ArrayHost3DI8 Init3DI8("Init3DI8", N3, NumAll, N2);
   OMEGA::ArrayHost3DR4 Init3DR4("Init3DR4", N3, NumAll, N2);
   OMEGA::ArrayHost3DR8 Init3DR8("Init3DR8", N3, NumAll, N2);
   OMEGA::ArrayHost4DI4 Init4DI4("Init4DI4", N4, N3, NumAll, N2);
   OMEGA::ArrayHost4DI8 Init4DI8("Init4DI8", N4, N3, NumAll, N2);
   OMEGA::ArrayHost4DR4 Init4DR4("Init4DR4", N4, N3, NumAll, N2);
   OMEGA::ArrayHost4DR8 Init4DR8("Init4DR8", N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DI4 Init5DI4("Init5DI4", N5, N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DI8 Init5DI8("Init5DI8", N5, N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DR4 Init5DR4("Init5DR4", N5, N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DR8 Init5DR8("Init5DR8", N5, N4, N3, NumAll, N2);
   OMEGA::ArrayHost1DI8 Test1DI8("Test1DI8", NumAll);
   OMEGA::ArrayHost1DR4 Test1DR4("Test1DR4", NumAll);
   OMEGA::ArrayHost1DR8 Test1DR8("Test1DR8", NumAll);
   OMEGA::ArrayHost2DI4 Test2DI4("Test2DI4", NumAll, N2);
   OMEGA::ArrayHost2DI8 Test2DI8("Test2DI8", NumAll, N2);
   OMEGA::ArrayHost2DR4 Test2DR4("Test2DR4", NumAll, N2);
   OMEGA::ArrayHost2DR8 Test2DR8("Test2DR8", NumAll, N2);
   OMEGA::ArrayHost3DI4 Test3DI4("Test3DI4", N3, NumAll, N2);
   OMEGA::ArrayHost3DI8 Test3DI8("Test3DI8", N3, NumAll, N2);
   OMEGA::ArrayHost3DR4 Test3DR4("Test3DR4", N3, NumAll, N2);
   OMEGA::ArrayHost3DR8 Test3DR8("Test3DR8", N3, NumAll, N2);
   OMEGA::ArrayHost4DI4 Test4DI4("Test4DI4", N4, N3, NumAll, N2);
   OMEGA::ArrayHost4DI8 Test4DI8("Test4DI8", N4, N3, NumAll, N2);
   OMEGA::ArrayHost4DR4 Test4DR4("Test4DR4", N4, N3, NumAll, N2);
   OMEGA::ArrayHost4DR8 Test4DR8("Test4DR8", N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DI4 Test5DI4("Test5DI4", N5, N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DI8 Test5DI8("Test5DI8", N5, N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DR4 Test5DR4("Test5DR4", N5, N4, N3, NumAll, N2);
   OMEGA::ArrayHost5DR8 Test5DR8("Test5DR8", N5, N4, N3, NumAll, N2);
