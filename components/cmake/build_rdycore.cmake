function(build_rdycore)
  ...
  if (COMP_NAMES MATCHES ".*rdycore.*")
    ...
    set(ENV{PETSC_DIR} "/global/cfs/projectdirs/m4267/petsc/petsc_v3.24.1")
    if (MACH STREQUAL "pm-cpu")
      set(ENV{PETSC_ARCH} "pm-cpu-opt-32bit-gcc-13-2-1-b522cb8c110")
    elseif (MACH STREQUAL "pm-gpu")
      set(ENV{PETSC_ARCH} "pm-gpu-hdf5_1_14_3-kokkos_4_6_00-opt-32bit-gcc-13-2-1-b522cb8c110")
    elseif (MACH STREQUAL "aqua")
      set(ENV{PETSC_DIR} "/home/gbisht/projects/petsc/petsc_master")
      set(ENV{PETSC_ARCH} "openmpi11-netcdf481-b522cb8c110-2025-10-29")
    else()
