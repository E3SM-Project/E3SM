function(build_model COMP_CLASS COMP_NAME)
  ...
  if (COMP_NAME STREQUAL "cpl")
    ...
    if (COMP_NAME STREQUAL "eam")
      ...
      if (USE_CLDERA_PROFILING)
        message ("CLDERA_PATH: ${CLDERA_PATH}")
        find_package(Cldera REQUIRED PATHS ${CLDERA_PATH})
        target_link_libraries(${TARGET_NAME} PRIVATE cldera-profiling)
        target_compile_definitions(${TARGET_NAME} PRIVATE CLDERA_PROFILING)
        # target_link_directories(${TARGET_NAME} PRIVATE ${CLDERA_PATH})
      endif()
    endif()
    if (USE_KOKKOS)
