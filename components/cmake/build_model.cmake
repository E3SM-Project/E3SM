...
macro(build_model COMP_CLASS COMP_NAME)
  ...
  if (COMP_NAME STREQUAL "cpl")
    ...
    if (COMP_NAME STREQUAL "csm_share")
      ...
      if (COMP_NAME STREQUAL "rdycore")
        target_include_directories(${TARGET_NAME} PRIVATE "$ENV{PETSC_DIR}/include")
        target_include_directories(${TARGET_NAME} PRIVATE "$ENV{PETSC_DIR}/$ENV{PETSC_ARCH}/include")
        target_link_libraries(${TARGET_NAME} PRIVATE rdycore_f90)
      endif()
      if (COMP_NAME STREQUAL "ww3")
