...
function (GetNetcdfLibs)
  ...
  if (NETCDF_C_PATH)
    ...
    # Find the libraries
    find_library(netcdf_c_lib netcdf  REQUIRED HINTS ${NETCDF_C_PATH}/lib ${NETCDF_C_PATH}/lib64)
    find_library(netcdf_f_lib netcdff REQUIRED HINTS ${NETCDF_FORTRAN_PATH}/lib ${NETCDF_FORTRAN_PATH}/lib64)
  ...
  elseif (NETCDF_PATH)
    ...
    find_library(netcdf_c_lib netcdf  REQUIRED HINTS ${NETCDF_PATH}/lib ${NETCDF_PATH}/lib64)
    find_library(netcdf_f_lib netcdff REQUIRED HINTS ${NETCDF_PATH}/lib ${NETCDF_PATH}/lib64)
