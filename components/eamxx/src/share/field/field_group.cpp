...
FieldGroup::FieldGroup(const std::string &name) : m_info(new FieldGroupInfo(name)) {
  // Nothing to do here
}

FieldGroup::FieldGroup(const FieldGroupInfo &info) : m_info(new FieldGroupInfo(info)) {
  // Nothing to do here
}
