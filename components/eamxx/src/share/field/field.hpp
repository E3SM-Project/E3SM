...
public:
  ...
  void scale (const Field& beta, const Field& mask);
...
protected:
  ...
  template<CombineMode CM, typename ST, typename STX, bool masked>
  void update_impl (const Field& x, const ST alpha, const ST beta, const Field* mask = nullptr);
