...
FieldLayout FieldLayout::clone() const { return *this; }
...
void FieldLayout::compute_type() {
  ...
  auto is_lev_tag = [](const FieldTag t) { return t == LEV or t == ILEV; };
  switch (size) {
  case 0:
