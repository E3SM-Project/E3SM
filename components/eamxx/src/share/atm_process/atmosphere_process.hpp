...
public:
  ...
  bool has_field (const std::string& name, const std::string& grid, const int usage_mask = Updated) const;
  bool has_group (const std::string& name, const std::string& grid, const int usage_mask = Updated) const;
