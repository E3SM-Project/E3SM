...
struct SCDataManager {
...
#endif
  Real get_field_data_view_entry(const int i, const int f) { return m_field_data(i, f); }
  ...
  int *get_field_vector_components_ptr() const { return m_field_vector_components.data(); }

  Real *get_field_constant_multiple_ptr() const { return m_field_constant_multiple.data(); }

  bool *get_field_transfer_during_init_ptr() const { return m_field_transfer_during_init.data(); }
