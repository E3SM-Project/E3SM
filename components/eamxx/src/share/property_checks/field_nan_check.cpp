...
template <typename ST> PropertyCheck::ResultAndMsg FieldNaNCheck::check_impl() const {
  ...
  default:
    EKAT_ERROR_MSG("Internal error in FieldNaNCheck: unsupported field rank.\n"
...
PropertyCheck::ResultAndMsg FieldNaNCheck::check() const {
  ...
  default:
    EKAT_ERROR_MSG("Internal error in FieldNaNCheck: unsupported field data type.\n"
                   "You should not have reached this line. Please, contact developers.\n");
  }
  return ResultAndMsg{};
}
