...
public:
  ...
  MassAndEnergyColumnConservationCheck(
      ...
      const Field &pseudo_density_ptr, const Field &ps_ptr,
      const Field &phis_ptr, const Field &horiz_winds_ptr,
  ...
  std::string name() const override {
    return "Mass and energy column conservation check";
  }
...
protected:
  ...
  static Real compute_total_mass_on_column(
      ...
      const uview_1d<const Real> &qi, const uview_1d<const Real> &qr);
  ...
  static Real compute_total_energy_on_column(
      ...
      const uview_2d<const Real> &horiz_winds, const uview_1d<const Real> &qv,
      const uview_1d<const Real> &qc, const uview_1d<const Real> &qr,
