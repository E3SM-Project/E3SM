...
public:
  PointGrid(const std::string &grid_name, const int num_my_cols,
  ...
  FieldTag get_partitioned_dim_tag() const override { return FieldTag::Column; }
...
std::shared_ptr<PointGrid> create_point_grid(const std::string &name,
