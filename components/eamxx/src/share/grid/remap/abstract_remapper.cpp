...
AbstractRemapper::AbstractRemapper(const grid_ptr_type &src_grid, const grid_ptr_type &tgt_grid) {
...
void AbstractRemapper::register_field(const Field &src, const Field &tgt) {
  ...
  EKAT_REQUIRE_MSG(is_valid_src_layout(src_layout), "Error! Source field has an invalid layout.\n"
                                                    " - field name  : " +
                                                        src.name() +
                                                        "\n"
                                                        " - field layout: " +
                                                        src_layout.to_string() + "\n");
  EKAT_REQUIRE_MSG(is_valid_tgt_layout(tgt_layout), "Error! Source field has an invalid layout.\n"
                                                    " - field name  : " +
                                                        tgt.name() +
                                                        "\n"
                                                        " - field layout: " +
...
void AbstractRemapper::set_grids(const grid_ptr_type &src_grid, const grid_ptr_type &tgt_grid) {
...
bool AbstractRemapper::compatible_layouts(const FieldLayout &src, const FieldLayout &tgt) const {
