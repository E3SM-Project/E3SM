...
public:
  ...
  VerticalRemapper(const grid_ptr_type &src_grid, const grid_ptr_type &tgt_grid);
  ...
  Field get_source_pressure(bool midpoints) const { return midpoints ? m_src_pmid : m_src_pint; }
