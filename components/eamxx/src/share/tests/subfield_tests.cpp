  ...
  SECTION ("multi-sliced subfield") {
    ...
    SECTION ("2D multi-slice") {
      ...
      for (int ens = 0; ens < 2; ens++) {
        ...
        auto sv_h = sf.get_multi_sliced_view<Real, 2, Host>();
        i1 = (ens == 0) ? sl_beg[0] : 0;
    ...
    SECTION ("3D multi-slice") {
      ...
      for (int ens = 0; ens < 3; ens++) {
        ...
        auto sv_h = sf.get_multi_sliced_view<Real, 3, Host>();
        i1 = (ens == 0) ? sl_beg[0] : 0;
    ...
    SECTION ("5D multi-slice") {
      ...
      for (int ens = 0; ens < 5; ens++) {
        ...
        auto sv_h = sf.get_multi_sliced_view<Real, 5, Host>();
        i1 = (ens == 0) ? sl_beg[0] : 0;
    ...
    SECTION ("6D multi-slice") {
      ...
      for (int ens = 0; ens < 6; ens++) {
        ...
        auto sv_h = sf.get_multi_sliced_view<Real, 6, Host>();
        i1 = (ens == 0) ? sl_beg[0] : 0;
