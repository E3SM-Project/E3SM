...
template <typename DeviceT>
template <typename ScalarT>
KOKKOS_INLINE_FUNCTION ScalarT PhysicsFunctions<DeviceT>::exner_function(const ScalarT &pressure) {
  using C = scream::physics::Constants<Real>;
...
template <typename DeviceT>
template <typename ScalarT>
KOKKOS_INLINE_FUNCTION ScalarT PhysicsFunctions<DeviceT>::calculate_wetmmr_from_drymmr_dp_based(
    const ScalarT &drymmr, const ScalarT &pseudo_density, const ScalarT &pseudo_density_dry) {
...
KOKKOS_INLINE_FUNCTION void PhysicsFunctions<DeviceT>::calculate_wetmmr_from_drymmr_dp_based(
...
template <typename DeviceT>
template <typename ScalarT>
KOKKOS_INLINE_FUNCTION ScalarT PhysicsFunctions<DeviceT>::calculate_drymmr_from_wetmmr_dp_based(
    const ScalarT &wetmmr, const ScalarT &pseudo_density, const ScalarT &pseudo_density_dry) {
  return wetmmr * pseudo_density / pseudo_density_dry;
}

template <typename DeviceT>
template <typename ScalarT, typename InputProviderX, typename InputProviderPD>
KOKKOS_INLINE_FUNCTION void PhysicsFunctions<DeviceT>::calculate_drymmr_from_wetmmr_dp_based(
