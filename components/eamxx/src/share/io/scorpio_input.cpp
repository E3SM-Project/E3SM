...
AtmosphereInput::AtmosphereInput(const std::vector<std::string> &fields_names,
                                 const std::shared_ptr<const grid_type> &grid) {
  set_grid(grid);
...
void AtmosphereInput::set_fields(const std::vector<Field> &fields) {
...
void AtmosphereInput::reset_filename(const std::string &filename) {
  if (m_filename != "") {
