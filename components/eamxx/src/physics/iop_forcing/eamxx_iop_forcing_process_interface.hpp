...
class IOPForcing : public scream::AtmosphereProcess {
  ...
  template <typename T> using view_1d  = KT::view_1d<T>;
  template <typename T> using view_2d  = KT::view_2d<T>;
  template <typename T> using uview_1d = ekat::Unmanaged<view_1d<T>>;
  template <typename T> using uview_2d = ekat::Unmanaged<view_2d<T>>;
