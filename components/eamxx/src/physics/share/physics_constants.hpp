...
template <typename Scalar> constexpr Scalar Constants<Scalar>::NSMALL;

template <typename Scalar> constexpr Scalar Constants<Scalar>::QSMALL;

template <typename Scalar> constexpr Scalar Constants<Scalar>::QTENDSMALL;

template <typename Scalar> constexpr Scalar Constants<Scalar>::ZERO;

template <typename Scalar> constexpr Scalar Constants<Scalar>::Tmelt;

template <typename Scalar> constexpr Scalar Constants<Scalar>::macheps;
