...
/*
 * Unit test infrastructure for shared physics unit tests.
 *
 * These entities can friend scream::physics::unit_test::UnitWrap to give unit
 * tests access to private members.
 *
