...
#ifdef EAMXX_HAS_P3
  proc_factory.register_product("p3",
                                &create_atmosphere_process<P3Microphysics>);
#endif
#ifdef EAMXX_HAS_SHOC
  proc_factory.register_product("SHOC",
                                &create_atmosphere_process<SHOCMacrophysics>);
#endif
#ifdef EAMXX_HAS_CLD_FRACTION
  proc_factory.register_product("cld_fraction",
                                &create_atmosphere_process<CldFraction>);
#endif
#ifdef EAMXX_HAS_RRTMGP
  proc_factory.register_product("RRTMGP",
                                &create_atmosphere_process<RRTMGPRadiation>);
#endif
#ifdef EAMXX_HAS_SPA
...
#endif
#ifdef EAMXX_HAS_MAM
  proc_factory.register_product("mam4_aero_microphys",
                                &create_atmosphere_process<MAMMicrophysics>);
  proc_factory.register_product("mam4_optics",
                                &create_atmosphere_process<MAMOptics>);
  proc_factory.register_product("mam4_drydep",
                                &create_atmosphere_process<MAMDryDep>);
  proc_factory.register_product("mam4_aci", &create_atmosphere_process<MAMAci>);
  proc_factory.register_product("mam4_wetscav",
                                &create_atmosphere_process<MAMWetscav>);
...
#ifdef EAMXX_HAS_TMS
  proc_factory.register_product(
      "tms", &create_atmosphere_process<TurbulentMountainStress>);
#endif
#ifdef EAMXX_HAS_ML_CORRECTION
...
#endif
#ifdef EAMXX_HAS_IOP_FORCING
  proc_factory.register_product("iop_forcing",
                                &create_atmosphere_process<IOPForcing>);
#endif
