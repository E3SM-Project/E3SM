...
KOKKOS_FUNCTION void Functions<S, D>::cloud_water_autoconversion(
  ...
  const Scalar autoconversion_prefactor   = runtime_options.autoconversion_prefactor;
  const Scalar autoconversion_qc_exponent = runtime_options.autoconversion_qc_exponent;
  const Scalar autoconversion_nc_exponent = runtime_options.autoconversion_nc_exponent;
