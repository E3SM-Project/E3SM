  ...
  if (use_hetfrz_classnuc) {
    ...
    bm.set(context, bm + (qr2qi_collect_tend * INV_RHO_RIMEMAX + qc2qi_collect_tend / rho_qm_cloud +
                          (qr2qi_immers_freeze_tend + qcheti_cnt + qicnt) * INV_RHO_RIMEMAX) *
                             dt);
    ni.set(context, ni + (ni_nucleat_tend - ni2nr_melt_tend - ni_sublim_tend - ni_selfcollect_tend +
    ...
    qm.set(context, qm + dum);
    bm.set(context, bm + (qr2qi_collect_tend * INV_RHO_RIMEMAX + qc2qi_collect_tend / rho_qm_cloud +
                          (qr2qi_immers_freeze_tend + qc2qi_hetero_freeze_tend) * INV_RHO_RIMEMAX) *
                             dt);
    ni.set(context, ni + (ni_nucleat_tend - ni2nr_melt_tend - ni_sublim_tend - ni_selfcollect_tend +
                          nr2ni_immers_freeze_tend + nc2ni_immers_freeze_tend) *
                             dt);
  }
