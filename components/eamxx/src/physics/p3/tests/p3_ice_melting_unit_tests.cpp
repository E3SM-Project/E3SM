...
struct UnitWrap::UnitTest<D>::TestP3IceMelting
  ...
  void ice_melting_bfb() {
    ...
    // make array of input data (why not pass actual variables?). Copied 1st 4
    // rows 4x to fill pack size.
    IceMeltingData IceMelt[max_pack_size] = {
        // rho,     T_atm,        pres,     rhofaci,  table_val_qi2qr_melting,
        // table_val_qi2qr_vent_melt,
        // latent_heat_vapor,     latent_heat_fusion,      dv,       sc, mu,
        // kap, qv,
        // qi_incld,ni_incld
        {0.117E+01, 0.299E+03, 0.101E+06, 0.829E+00, 0.122E+01, 0.562E-01,
         latvap, latice, 0.263E-04, 0.601E+00, 0.185E-04, 0.261E-01, 0.160E-01,
         0.510E-02, 0.195E-12},
        {0.114E+01, 0.296E+03, 0.973E+05, 0.842E+00, 0.122E+01, 0.562E-01,
         latvap, latice, 0.268E-04, 0.601E+00, 0.183E-04, 0.259E-01, 0.149E-01,
         0.510E-02, 0.195E-12},
        {0.977E+00, 0.287E+03, 0.809E+05, 0.913E+00, 0.122E+01, 0.562E-01,
         latvap, latice, 0.306E-04, 0.599E+00, 0.179E-04, 0.253E-01, 0.827E-02,
         0.000E+00, 0.000E+00},
        {0.103E+01, 0.289E+03, 0.862E+05, 0.887E+00, 0.636E-03, 0.281E-04,
         latvap, latice, 0.291E-04, 0.600E+00, 0.180E-04, 0.254E-01, 0.107E-01,
         0.510E-02, 0.336E+05},
    ...
    Kokkos::parallel_for(
        num_test_itrs, KOKKOS_LAMBDA(const Int &i) {
          ...
          // Init pack inputs
          Spack rho, T_atm, pres, rhofaci, table_val_qi2qr_melting,
              table_val_qi2qr_vent_melt, dv, sc, mu, kap, qv, qi_incld,
              ni_incld, qi2qr_melt_tend, ni2nr_melt_tend;
          for (Int s = 0, vs = offset; s < Spack::n; ++s, ++vs) {
            ...
            table_val_qi2qr_melting[s] =
                IceMelt_device(vs).table_val_qi2qr_melting;
            table_val_qi2qr_vent_melt[s] =
                IceMelt_device(vs).table_val_qi2qr_vent_melt;
...
TEST_CASE("p3_ice_melting_test", "[p3_ice_melting_test]") {
  using T = scream::p3::unit_test::UnitWrap::UnitTest<
      scream::DefaultDevice>::TestP3IceMelting;
