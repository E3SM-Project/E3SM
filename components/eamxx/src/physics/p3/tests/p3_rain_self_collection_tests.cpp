...
struct UnitWrap::UnitTest<D>::TestRainSelfCollection : public UnitWrap::UnitTest<D>::Base {
  ...
  void run_rain_self_collection_bfb_tests() {
    ...
    RainSelfCollectionData dc[max_pack_size] = {
        ...
        {1.060E+00, 1.354E-03, 1.401E+04, 0.000E+00}, {1.136E+00, 1.319E-04, 4.210E+03, 0.000E+00},
        {1.166E+00, 5.339E-03, 1.804E+04, 0.000E+00}, {1.120E+00, 5.650E-05, 8.277E+05, 0.000E+00},
  ...
  void run_bfb() { run_rain_self_collection_bfb_tests(); }
