...
struct UnitWrap::UnitTest<D>::TestCalcRimeDensity
  ...
  void run_bfb() {
    ...
    constexpr Scalar table_val_qi_fallspd1 = 0.125,
                     table_val_qi_fallspd2 = 0.875;
    ...
    CalcRimeDensityData calc_rime_density_data[max_pack_size] = {
        // T_atm, rhofaci, table_val_qi_fallspd1, acn, lamc, mu_c, qc_incld,
        // qc2qi_collect_tend
        {t_not_freezing, rhofaci1, table_val_qi_fallspd1, acn1, lamc1, mu_c1,
         qc_incld_small, qc2qi_collect_tend_small},
        {t_not_freezing, rhofaci2, table_val_qi_fallspd2, acn2, lamc2, mu_c2,
         qc_incld_small, qc2qi_collect_tend_small},

        {t_not_freezing, rhofaci1, table_val_qi_fallspd1, acn1, lamc1, mu_c1,
         qc_incld_small, qc2qi_collect_tend_not_small},
        {t_not_freezing, rhofaci2, table_val_qi_fallspd2, acn2, lamc2, mu_c2,
         qc_incld_small, qc2qi_collect_tend_not_small},

        {t_not_freezing, rhofaci1, table_val_qi_fallspd1, acn1, lamc1, mu_c1,
         qc_incld_not_small, qc2qi_collect_tend_small},
        {t_not_freezing, rhofaci2, table_val_qi_fallspd2, acn2, lamc2, mu_c2,
         qc_incld_not_small, qc2qi_collect_tend_small},

        {t_not_freezing, rhofaci1, table_val_qi_fallspd1, acn1, lamc1, mu_c1,
         qc_incld_not_small, qc2qi_collect_tend_not_small},
        {t_not_freezing, rhofaci2, table_val_qi_fallspd2, acn2, lamc2, mu_c2,
         qc_incld_not_small, qc2qi_collect_tend_not_small},

        {t_freezing, rhofaci1, table_val_qi_fallspd1, acn1, lamc1, mu_c1,
         qc_incld_small, qc2qi_collect_tend_small},
        {t_freezing, rhofaci2, table_val_qi_fallspd2, acn2, lamc2, mu_c2,
         qc_incld_small, qc2qi_collect_tend_small},
    ...
    // Sync to device
    view_1d<CalcRimeDensityData> device_data("calc_rime_density",
                                             max_pack_size);
    const auto host_data = Kokkos::create_mirror_view(device_data);
    std::copy(&calc_rime_density_data[0],
              &calc_rime_density_data[0] + max_pack_size, host_data.data());
    ...
    Kokkos::parallel_for(
        num_test_itrs, KOKKOS_LAMBDA(const Int &i) {
          ...
          // Init pack inputs
          Spack T_atm, rhofaci, table_val_qi_fallspd, acn, lamc, mu_c, qc_incld,
              qc2qi_collect_tend;
          ...
          Functions::calc_rime_density(
              T_atm, rhofaci, table_val_qi_fallspd, acn, lamc, mu_c, qc_incld,
    ...
    if (SCREAM_BFB_TESTING && this->m_baseline_action == COMPARE) {
      for (Int s = 0; s < max_pack_size; ++s) {
        ...
        REQUIRE(calc_rime_density_data[s].rho_qm_cloud ==
...
TEST_CASE("p3_calc_rime_density", "[p3_functions]") {
  using T = scream::p3::unit_test::UnitWrap::UnitTest<
      scream::DefaultDevice>::TestCalcRimeDensity;
