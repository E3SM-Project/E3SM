...
struct BackToCellAverageData {
  ...
  // in/out
  Real qc2qr_accret_tend, qr2qv_evap_tend, qc2qr_autoconv_tend, nc_accret_tend,
      nc_selfcollect_tend, nc2nr_autoconv_tend, nr_selfcollect_tend,
      nr_evap_tend, ncautr, qcnuc, nc_nuceat_tend, qi2qv_sublim_tend,
      nr_ice_shed_tend, qc2qi_hetero_freeze_tend, qr2qi_collect_tend,
      qc2qr_ice_shed_tend, qi2qr_melt_tend, qc2qi_collect_tend,
      qr2qi_immers_freeze_tend, ni2nr_melt_tend, nc_collect_tend, ncshdc,
      nc2ni_immers_freeze_tend, nr_collect_tend, ni_selfcollect_tend,
      qv2qi_vapdep_tend, nr2ni_immers_freeze_tend, ni_sublim_tend,
      qv2qi_nucleat_tend, ni_nucleat_tend, qc2qi_berg_tend;
  Real ncheti_cnt = 0, qcheti_cnt = 0, nicnt = 0, qicnt = 0, ninuc_cnt = 0,
       qinuc_cnt           = 0;
  ...
  PTD_RW_SCALARS_ONLY(31, qc2qr_accret_tend, qr2qv_evap_tend,
                      qc2qr_autoconv_tend, nc_accret_tend, nc_selfcollect_tend,
                      nc2nr_autoconv_tend, nr_selfcollect_tend, nr_evap_tend,
                      ncautr, qcnuc, nc_nuceat_tend, qi2qv_sublim_tend,
                      nr_ice_shed_tend, qc2qi_hetero_freeze_tend,
                      qr2qi_collect_tend, qc2qr_ice_shed_tend, qi2qr_melt_tend,
                      qc2qi_collect_tend, qr2qi_immers_freeze_tend,
                      ni2nr_melt_tend, nc_collect_tend, ncshdc,
                      nc2ni_immers_freeze_tend, nr_collect_tend,
                      ni_selfcollect_tend, qv2qi_vapdep_tend,
...
struct CloudWaterConservationData {
  ...
  // output
  Real qc2qr_autoconv_tend, qc2qr_accret_tend, qc2qi_collect_tend,
      qc2qi_hetero_freeze_tend, qc2qr_ice_shed_tend, qc2qi_berg_tend,
      qi2qv_sublim_tend, qv2qi_vapdep_tend;
  Real qcheti_cnt = 0, qicnt = 0;
  bool use_hetfrz_classnuc = false, context = true;

  PTD_RW_SCALARS_ONLY(8, qc2qr_autoconv_tend, qc2qr_accret_tend,
                      qc2qi_collect_tend, qc2qi_hetero_freeze_tend,
...
struct RainWaterConservationData {
  // inputs
  Real qr, qc2qr_autoconv_tend, qc2qr_accret_tend, qi2qr_melt_tend,
      qc2qr_ice_shed_tend, dt;

  // output
  Real qr2qv_evap_tend, qr2qi_collect_tend, qr2qi_immers_freeze_tend;

  PTD_RW_SCALARS_ONLY(3, qr2qv_evap_tend, qr2qi_collect_tend,
                      qr2qi_immers_freeze_tend);
};

struct IceWaterConservationData {
  // inputs
  Real qi, qv2qi_vapdep_tend, qv2qi_nucleat_tend, qc2qi_berg_tend,
      qr2qi_collect_tend, qc2qi_collect_tend, qr2qi_immers_freeze_tend,
      qc2qi_hetero_freeze_tend, dt;
  // output
...
struct CalcRimeDensityData {
  // inputs
  Real T_atm, rhofaci, table_val_qi_fallspd, acn, lamc, mu_c, qc_incld,
      qc2qi_collect_tend;
...
struct IceMeltingData {
  // inputs
  Real rho, T_atm, pres, rhofaci, table_val_qi2qr_melting,
      table_val_qi2qr_vent_melt, latent_heat_vapor, latent_heat_fusion, dv, sc,
      mu, kap, qv, qi_incld, ni_incld;
...
struct CalcUpwindData : public PhysicsTestData {
  ...
  CalcUpwindData(Int kts_, Int kte_, Int kdir_, Int kbot_, Int k_qxtop_,
                 Int num_arrays_, Real dt_sub_);

  PTD_STD_DEF(CalcUpwindData, 7, kts, kte, kdir, kbot, k_qxtop, num_arrays,
              dt_sub);

  Int nk() const { return (kte - kts) + 1; }

  void convert_to_ptr_arr(std::vector<Real *> &mem_space, Real **&fluxes_,
                          Real **&vs_, Real **&qnx_);
};
...
struct GenSedData : public CalcUpwindData {
  ...
  GenSedData(Int kts_, Int kte_, Int kdir_, Int k_qxtop_, Int k_qxbot_,
             Int kbot_, Real Co_max_, Real dt_left_, Real prt_accum_,
             Int num_arrays_);

  PTD_DATA_COPY_CTOR(GenSedData, 10);
  PTD_ASSIGN_OP(GenSedData, 11, kts, kte, kdir, kbot, k_qxtop, num_arrays,
                dt_sub, Co_max, k_qxbot, dt_left, prt_accum);
  PTD_RW();
  PTD_RW_SCALARS(11, kts, kte, kdir, kbot, k_qxtop, num_arrays, dt_sub, Co_max,
                 k_qxbot, dt_left, prt_accum);
};
...
struct CloudSedData : public PhysicsTestData {
  ...
  CloudSedData(Int kts_, Int kte_, Int ktop_, Int kbot_, Int kdir_, Real dt_,
               Real inv_dt_, bool do_predict_nc_, Real precip_liq_surf_);

  PTD_STD_DEF(CloudSedData, 9, kts, kte, ktop, kbot, kdir, dt, inv_dt,
              do_predict_nc, precip_liq_surf);
...
struct IceSedData : public PhysicsTestData {
  ...
  // In/out
  Real *qi, *qi_incld, *ni, *ni_incld, *qm, *qm_incld, *bm, *bm_incld, *qi_tend,
      *ni_tend;
  Real precip_ice_surf;

  IceSedData(Int kts_, Int kte_, Int ktop_, Int kbot_, Int kdir_, Real dt_,
             Real inv_dt_, Real precip_ice_surf_);

  PTD_STD_DEF(IceSedData, 8, kts, kte, ktop, kbot, kdir, dt, inv_dt,
              precip_ice_surf);
...
struct RainSedData : public PhysicsTestData {
  ...
  RainSedData(Int kts_, Int kte_, Int ktop_, Int kbot_, Int kdir_, Real dt_,
              Real inv_dt_, Real precip_liq_surf_);

  PTD_STD_DEF(RainSedData, 8, kts, kte, ktop, kbot, kdir, dt, inv_dt,
              precip_liq_surf);
...
struct GetTimeSpacePhysVarsData {
  // Inputs
  Real T_atm, pres, rho, latent_heat_vapor, latent_heat_sublim, qv_sat_l,
      qv_sat_i;
...
struct P3UpdatePrognosticIceData {
  // Inputs
  Real qc2qi_hetero_freeze_tend, qc2qi_collect_tend, qc2qr_ice_shed_tend,
      nc_collect_tend, nc2ni_immers_freeze_tend, ncshdc, qr2qi_collect_tend,
      nr_collect_tend, qr2qi_immers_freeze_tend, nr2ni_immers_freeze_tend,
      nr_ice_shed_tend, qi2qr_melt_tend, ni2nr_melt_tend, qi2qv_sublim_tend,
      qv2qi_vapdep_tend, qv2qi_nucleat_tend, ni_nucleat_tend,
      ni_selfcollect_tend, ni_sublim_tend, qc2qi_berg_tend, inv_exner,
      latent_heat_sublim, latent_heat_fusion;
  bool do_predict_nc, log_wetgrowth;
  Real dt, nmltratio, rho_qm_cloud;
  Real ncheti_cnt = 0, nicnt = 0, ninuc_cnt = 0, qcheti_cnt = 0, qicnt = 0,
       qinuc_cnt = 0;
...
struct EvapRainData {
  // Inputs
  Real qr_incld, qc_incld, nr_incld, qi_incld, cld_frac_l, cld_frac_r, qv,
      qv_prev, qv_sat_l, qv_sat_i, ab, abi, epsr, epsi_tot, t, t_prev,
      latent_heat_sublim, dqsdt, dt;
...
struct P3UpdatePrognosticLiqData {
  // Inputs
  Real qc2qr_accret_tend, nc_accret_tend, qc2qr_autoconv_tend,
...
struct IceDepositionSublimationData {
  ...
  PTD_RW_SCALARS_ONLY(4, qv2qi_vapdep_tend, qi2qv_sublim_tend, ni_sublim_tend,
                      qc2qi_berg_tend);
};
...
struct IceCldliqCollectionData {
  ...
  PTD_RW_SCALARS_ONLY(4, qc2qi_collect_tend, nc_collect_tend,
                      qc2qr_ice_shed_tend, ncshdc);
};

struct IceRainCollectionData {
  // Inputs
  Real rho, temp, rhofaci, logn0r, table_val_nr_collect,
      table_val_qr2qi_collect, qi_incld;
...
struct IceRelaxationData {
  // Inputs
  Real rho, temp, rhofaci, table_val_qi2qr_melting, table_val_qi2qr_vent_melt,
...
struct IceWetGrowthData {
  // Inputs
  Real rho, temp, pres, rhofaci, table_val_qi2qr_melting,
      table_val_qi2qr_vent_melt, latent_heat_vapor, latent_heat_fusion, dv, kap,
      mu, sc, qv, qc_incld;
  ...
  PTD_RW_SCALARS_ONLY(6, log_wetgrowth, qr2qi_collect_tend, qc2qi_collect_tend,
                      qc_growth_rate, nr_ice_shed_tend, qc2qr_ice_shed_tend);
};
...
struct CheckValuesData : public PhysicsTestData {
  ...
  CheckValuesData(Int kts_, Int kte_, Int timestepcount_, Int source_ind_,
                  bool force_abort_);

  // deep copy
  PTD_STD_DEF(CheckValuesData, 5, kts, kte, timestepcount, source_ind,
              force_abort);
...
struct IncloudMixingData {
  // Inputs
  Real qc, qr, qi, qm, nc, nr, ni, bm, inv_cld_frac_l, inv_cld_frac_i,
      inv_cld_frac_r;

  // Outputs
  Real qc_incld, qr_incld, qi_incld, qm_incld, nc_incld, nr_incld, ni_incld,
      bm_incld;

  PTD_RW_SCALARS_ONLY(8, qc_incld, qr_incld, qi_incld, qm_incld, nc_incld,
...
struct P3MainPart1Data : public PhysicsTestData {
  ...
  bool do_predict_nc, do_prescribed_CCN;
  Real dt;
  Real *pres, *dpres, *dz, *nc_nuceat_tend, *inv_exner, *exner, *inv_cld_frac_l,
      *inv_cld_frac_i, *inv_cld_frac_r, *latent_heat_vapor, *latent_heat_sublim,
      *latent_heat_fusion, *nccn_prescribed;

  // In/out
  Real *T_atm, *rho, *inv_rho, *qv_sat_l, *qv_sat_i, *qv_supersat_i, *rhofacr,
      *rhofaci, *acn, *qv, *th_atm, *qc, *nc, *qr, *nr, *qi, *ni, *qm, *bm,
      *qc_incld, *qr_incld, *qi_incld, *qm_incld, *nc_incld, *nr_incld,
      *ni_incld, *bm_incld;
  ...
  PTD_STD_DEF(P3MainPart1Data, 10, kts, kte, kbot, ktop, kdir, do_predict_nc,
              do_prescribed_CCN, dt, is_nucleat_possible, is_hydromet_present);
...
struct P3MainPart2Data : public PhysicsTestData {
  ...
  Real dt, inv_dt;
  Real *pres, *dpres, *dz, *nc_nuceat_tend, *inv_exner, *exner, *inv_cld_frac_l,
      *inv_cld_frac_i, *inv_cld_frac_r, *ni_activated, *inv_qc_relvar,
      *cld_frac_i, *cld_frac_l, *cld_frac_r, *qv_prev, *t_prev;

  // In/out
  Real *T_atm, *rho, *inv_rho, *qv_sat_l, *qv_sat_i, *qv_supersat_i, *rhofacr,
      *rhofaci, *acn, *qv, *th_atm, *qc, *nc, *qr, *nr, *qi, *ni, *qm, *bm,
      *latent_heat_vapor, *latent_heat_sublim, *latent_heat_fusion, *qc_incld,
      *qr_incld, *qi_incld, *qm_incld, *nc_incld, *nr_incld, *ni_incld,
      *bm_incld, *mu_c, *nu, *lamc, *cdist, *cdist1, *cdistr, *mu_r, *lamr,
      *logn0r, *qv2qi_depos_tend, *precip_total_tend, *nevapr, *qr_evap_tend,
      *vap_liq_exchange, *vap_ice_exchange, *liq_ice_exchange, *pratot, *prctot;
  ...
  PTD_STD_DEF(P3MainPart2Data, 10, kts, kte, kbot, ktop, kdir, do_predict_nc,
              do_prescribed_CCN, dt, inv_dt, is_hydromet_present);
...
struct P3MainPart3Data : public PhysicsTestData {
  ...
  // In/out
  Real *rho, *inv_rho, *rhofaci, *qv, *th_atm, *qc, *nc, *qr, *nr, *qi, *ni,
      *qm, *bm, *latent_heat_vapor, *latent_heat_sublim, *mu_c, *nu, *lamc,
      *mu_r, *lamr, *vap_liq_exchange, *ze_rain, *ze_ice, *diag_vm_qi,
      *diag_eff_radius_qi, *diag_diam_qi, *rho_qi, *diag_equiv_reflectivity,
...
struct P3MainData : public PhysicsTestData {
  ...
  Real *pres, *dz, *nc_nuceat_tend, *nccn_prescribed, *ni_activated, *dpres,
      *inv_exner, *cld_frac_i, *cld_frac_l, *cld_frac_r, *inv_qc_relvar,
      *qv_prev, *t_prev;
  Real dt;
  bool do_predict_nc, do_prescribed_CCN;
  ...
  // Out
  Real *diag_eff_radius_qc, *diag_eff_radius_qi, *diag_eff_radius_qr, *rho_qi,
      *mu_c, *lamc, *qv2qi_depos_tend, *precip_total_tend, *nevapr,
  ...
  P3MainData(Int its_, Int ite_, Int kts_, Int kte_, Int it_, Real dt_,
             bool do_predict_nc_, bool do_prescribed_CCN_, Real = 0.);

  PTD_STD_DEF(P3MainData, 9, its, ite, kts, kte, it, dt, do_predict_nc,
              do_prescribed_CCN, elapsed_s);
};
...
struct NcConservationData {
  ...
  // Inputs/Outputs
  Real nc_collect_tend, nc2ni_immers_freeze_tend, nc_accret_tend,
      nc2nr_autoconv_tend;
  ...
  PTD_RW_SCALARS_ONLY(4, nc_collect_tend, nc2ni_immers_freeze_tend,
...
struct NrConservationData {
  ...
  // Inputs/Outputs
  Real nr_collect_tend, nr2ni_immers_freeze_tend, nr_selfcollect_tend,
      nr_evap_tend;

  void randomize(std::mt19937_64 &engine);

  PTD_RW_SCALARS_ONLY(4, nr_collect_tend, nr2ni_immers_freeze_tend,
                      nr_selfcollect_tend, nr_evap_tend);
};

struct NiConservationData {
  // Inputs
  Real ni, ni_nucleat_tend, nr2ni_immers_freeze_tend, nc2ni_immers_freeze_tend,
      dt;
