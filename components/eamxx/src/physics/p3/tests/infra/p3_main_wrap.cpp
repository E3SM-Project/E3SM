...
Int p3_main_wrap(const P3Data &d) {
  ...
  return p3_main_host(
      d.qc.data(), d.nc.data(), d.qr.data(), d.nr.data(), d.th_atm.data(),
      d.qv.data(), d.dt, d.qi.data(), d.qm.data(), d.ni.data(), d.bm.data(),
      d.pres.data(), d.dz.data(), d.nc_nuceat_tend.data(),
      d.nccn_prescribed.data(), d.ni_activated.data(), d.inv_qc_relvar.data(),
      d.it, d.precip_liq_surf.data(), d.precip_ice_surf.data(), 1, d.ncol, 1,
      d.nlev, d.diag_eff_radius_qc.data(), d.diag_eff_radius_qi.data(),
      d.diag_eff_radius_qr.data(), d.rho_qi.data(), d.do_predict_nc,
      d.do_prescribed_CCN, d.use_hetfrz_classnuc, d.dpres.data(),
