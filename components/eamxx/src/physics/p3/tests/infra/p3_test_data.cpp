...
P3MainPart1Data::P3MainPart1Data(Int kts_, Int kte_, Int kbot_, Int ktop_, Int kdir_,
    ...
    : PhysicsTestData({{(kte_ - kts_) + 1}}, {{&pres,
                                               ...
                                               &ni_incld,
                                               &bm_incld}}),
      kts(kts_), kte(kte_), kbot(kbot_), ktop(ktop_), kdir(kdir_), do_predict_nc(do_predict_nc_),
      do_prescribed_CCN(do_prescribed_CCN_), dt(dt_) {}
...
P3MainPart2Data::P3MainPart2Data(Int kts_, Int kte_, Int kbot_, Int ktop_, Int kdir_,
    ...
    : PhysicsTestData({{(kte_ - kts_) + 1}}, {{&pres,
                                               ...
                                               &prctot}}),
      kts(kts_), kte(kte_), kbot(kbot_), ktop(ktop_), kdir(kdir_), do_predict_nc(do_predict_nc_),
      do_prescribed_CCN(do_prescribed_CCN_), dt(dt_), inv_dt(1 / dt) {}

///////////////////////////////////////////////////////////////////////////////

P3MainPart3Data::P3MainPart3Data(Int kts_, Int kte_, Int kbot_, Int ktop_, Int kdir_)
...
void p3_main_part2_host(
  ...
  view_1d hetfrz_immersion_nucleation_tend_d(temp_d[current_index++]),
      ...
      qr2qi_collect_d(temp_d[current_index++]), qc2qi_hetero_freeze_d(temp_d[current_index++]),
      qr2qi_immers_freeze_d(temp_d[current_index++]), qi2qr_melt_d(temp_d[current_index++]);
...
Int p3_main_host(Real *qc, Real *nc, Real *qr, Real *nr, Real *th_atm, Real *qv, Real dt, Real *qi,
  ...
  view_2d pres_d(temp_d[counter++]), // 0
      ...
      precip_liq_surf_temp_d(temp_d[counter++]), precip_ice_surf_temp_d(temp_d[counter++]);
  ...
  std::vector<const Real *> pointers = {hetfrz_immersion_nucleation_tend.data(),
  ...
  P3F::P3PrognosticState prog_state{qc_d, nc_d, qr_d, nr_d, qi_d, qm_d, ni_d, bm_d, qv_d, th_atm_d};
