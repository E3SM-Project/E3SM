  ...
  const P3Runtime& runtime_options)
{
  ...
  Kokkos::parallel_for(
    ...
    p3_main_part2(
      ...
      ekat::subview(P3_qr2qv_evap, i), ekat::subview(P3_qi2qv_sublim, i), ekat::subview(P3_qc2qr_accret, i), ekat::subview(P3_qc2qr_autoconv, i),
      ekat::subview(P3_qv2qi_vapdep, i), ekat::subview(P3_qc2qi_berg, i), ekat::subview(P3_qc2qr_ice_shed, i), ekat::subview(P3_qc2qi_collect, i),
      ekat::subview(P3_qr2qi_collect, i), ekat::subview(P3_qc2qi_hetero_freeze, i), ekat::subview(P3_qr2qi_immers_freeze, i),
      ekat::subview(P3_qi2qr_melt, i),
