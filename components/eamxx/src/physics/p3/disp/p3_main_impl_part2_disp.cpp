  ...
  const P3Runtime& runtime_options)
{
  ...
  Kokkos::parallel_for(
    ...
    p3_main_part2(
      ...
      ekat::subview(rhofaci, i), ekat::subview(acn, i), ekat::subview(qv, i), ekat::subview(th_atm, i), ekat::subview(qc, i), ekat::subview(nc, ri),
      ekat::subview(qr, i), ekat::subview(nr, i), ekat::subview(qi, i), ekat::subview(ni, i), ekat::subview(qm, i), ekat::subview(qmr, i), ekat::subview(bm, i),
