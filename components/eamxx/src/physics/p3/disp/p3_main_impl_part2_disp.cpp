  ...
  const P3Runtime& runtime_options)
{
  ...
  Kokkos::parallel_for(
    ...
    p3_main_part2(
      ...
      ekat::subview(cld_frac_r, i), ekat::subview(qv_prev, i), ekat::subview(t_prev, i), ekat::subview(omega_mp, i), ekat::subview(tke_mp, i), ekat::subview(T_atm, i), ekat::subview(rho, i),
