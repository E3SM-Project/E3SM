  ...
  Int nk)
{
  ...
  auto otke_mp                = diagnostic_inputs.tke_mp;
  ...
  p3_main_part2_disp(
      ...
      cld_frac_l, cld_frac_r, qv_prev, t_prev, oomega_mp, otke_mp, T_atm, rho, inv_rho, qv_sat_l, qv_sat_i, qv_supersat_i, rhofacr, rhofaci, acn,
