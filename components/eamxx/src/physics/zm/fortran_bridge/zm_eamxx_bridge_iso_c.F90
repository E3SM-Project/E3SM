...
! subroutine zm_eamxx_bridge_init_c( pcols, ncol, pver, num_msg, msemax_top_k, pergro_active, temperature, zmid, sp_humidity, msemax_klev, mse_max_val ) bind(C)
...
! subroutine zm_eamxx_bridge_run_c()

! end subroutine zm_eamxx_bridge_run_c

! !===================================================================================================

! end module zm_eamxx_bridge_iso_c
