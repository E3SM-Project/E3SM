...
subroutine zm_transport_tracer_bridge_f(pcols, ncol, pver, doconvtran, q, ncnst, mu, md, du, eu, ed, dp, jt, mx, ideep, il1g, il2g, fracis, dqdt, dpdry, dt) bind(C)
  use zm_transport, only : zm_transport_tracer

  integer(kind=c_int) , value, intent(in) :: pcols, ncol, pver, ncnst, il1g, il2g
  ...
  call zm_transport_tracer(pcols, ncol, pver, doconvtran, q, ncnst, mu, md, du, eu, ed, dp, jt, mx, ideep, il1g, il2g, fracis, dqdt, dpdry, dt)
