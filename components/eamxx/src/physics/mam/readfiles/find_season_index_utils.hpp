...
inline void find_season_index_reader(const std::string &season_wes_file, const const_view_1d &clat,
  ...
  mam4::mo_drydep::find_season_index(clat_host, lat_lai, nlat_lai, wk_lai, index_season_lai_host);
