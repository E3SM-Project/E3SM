...
const char *aero_mode_name(const int mode) {
  static const char *mode_names[mam4::AeroConfig::num_modes()] = {
      "1",
      "2",
      "3",
      "4",
...
const char *aero_species_name(const int species_id) {
  static const char *species_names[mam4::AeroConfig::num_aerosol_ids()] = {
...
constexpr std::array<std::string_view, mam4::AeroConfig::num_gas_ids()> gas_mmr_name= {"O3",  "H2O2", "H2SO4", "SO2", "DMS",  "SOAG"};
...
char *int_aero_nmr_names(int mode) {
  static char int_aero_nmr_names_[mam4::AeroConfig::num_modes()][max_field_name_len()] = {};
  return int_aero_nmr_names_[mode];
}

KOKKOS_INLINE_FUNCTION
char *cld_aero_nmr_names(int mode) {
  static char cld_aero_nmr_names_[mam4::AeroConfig::num_modes()][max_field_name_len()] = {};
  return cld_aero_nmr_names_[mode];
}

KOKKOS_INLINE_FUNCTION
char *int_aero_mmr_names(int mode, int species) {
  static char int_aero_mmr_names_[mam4::AeroConfig::num_modes()][mam4::AeroConfig::num_aerosol_ids()]
                                 [max_field_name_len()] = {};
...
char *cld_aero_mmr_names(int mode, int species) {
  static char cld_aero_mmr_names_[mam4::AeroConfig::num_modes()][mam4::AeroConfig::num_aerosol_ids()]
                                 [max_field_name_len()] = {};
...
// mam4::AeroConfig.
struct AerosolState {
  view_2d int_aero_nmr[mam4::AeroConfig::num_modes()];  // modal interstitial aerosol number
                                           // mixing ratios [# / kg air]
  view_2d cld_aero_nmr[mam4::AeroConfig::num_modes()];  // modal cloudborne aerosol number
                                           // mixing ratios [# / kg air]
  view_2d int_aero_mmr[mam4::AeroConfig::num_modes()]
                      [mam4::AeroConfig::num_aerosol_ids()];  // interstitial aerosol mass mixing
                                             // ratios [kg aerosol / kg air]
  view_2d cld_aero_mmr[mam4::AeroConfig::num_modes()]
                      [mam4::AeroConfig::num_aerosol_ids()];  // cloudborne aerosol mass mixing
                                             // ratios [kg aerosol / kg air]
  view_2d
      gas_mmr[mam4::AeroConfig::num_gas_ids()];  // gas mass mixing ratios [kg gas / kg air]
};
...
struct Buffer {
  ...
  static constexpr int min_num_2d_mid =
      ...
      2 * (mam4::AeroConfig::num_modes() + num_aero_tracers()) + mam4::AeroConfig::num_gas_ids();
  // +
  // num_2d_scratch;
  ...
  //  be used)
  uview_2d dry_int_aero_nmr[mam4::AeroConfig::num_modes()];
  uview_2d dry_cld_aero_nmr[mam4::AeroConfig::num_modes()];
  uview_2d dry_int_aero_mmr[mam4::AeroConfig::num_modes()][mam4::AeroConfig::num_aerosol_ids()];
  uview_2d dry_cld_aero_mmr[mam4::AeroConfig::num_modes()][mam4::AeroConfig::num_aerosol_ids()];

  // aerosol-related dry gas mass mixing ratios
  uview_2d dry_gas_mmr[mam4::AeroConfig::num_gas_ids()];
