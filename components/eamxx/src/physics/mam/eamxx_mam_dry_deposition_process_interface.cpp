...
/*void init_frac_landuse_file_read(
    ...
    FracLandUseInput &SrfEmissData_start, FracLandUseInput &SrfEmissData_end,
  ...
  SrfEmissData_end   = FracLandUseInput(ncol, nclass);
  SrfEmissData_out.init(ncol, nclass, true);
