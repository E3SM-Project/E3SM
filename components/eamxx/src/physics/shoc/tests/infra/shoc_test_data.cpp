...
void shoc_grid(ShocGridData &d) {
  shoc_grid_host(d.shcol, d.nlev, d.nlevi, d.zt_grid, d.zi_grid, d.pdel,
                 d.dz_zt, d.dz_zi, d.rho_zt);
}

void shoc_diag_obklen(ShocDiagObklenData &d) {
  shoc_diag_obklen_host(d.shcol, d.uw_sfc, d.vw_sfc, d.wthl_sfc, d.wqw_sfc,
                        d.thl_sfc, d.cldliq_sfc, d.qv_sfc, d.ustar, d.kbfs,
                        d.obklen);
}

void update_host_dse(UpdateHostDseData &d) {
  update_host_dse_host(d.shcol, d.nlev, d.thlm, d.shoc_ql, d.inv_exner,
                       d.zt_grid, d.phis, d.host_dse);
}

void shoc_energy_fixer(ShocEnergyFixerData &d) {
  shoc_energy_fixer_host(d.shcol, d.nlev, d.nlevi, d.dtime, d.nadv, d.zt_grid,
                         d.zi_grid, d.se_b, d.ke_b, d.wv_b, d.wl_b, d.se_a,
                         d.ke_a, d.wv_a, d.wl_a, d.wthl_sfc, d.wqw_sfc,
                         d.rho_zt, d.tke, d.pint, d.host_dse);
}

void shoc_energy_integrals(ShocEnergyIntegralsData &d) {
  shoc_energy_integrals_host(d.shcol, d.nlev, d.host_dse, d.pdel, d.rtm, d.rcm,
                             d.u_wind, d.v_wind, d.se_int, d.ke_int, d.wv_int,
                             d.wl_int);
}

void calc_shoc_vertflux(CalcShocVertfluxData &d) {
  calc_shoc_vertflux_host(d.shcol, d.nlev, d.nlevi, d.tkh_zi, d.dz_zi, d.invar,
                          d.vertflux);
}

void calc_shoc_varorcovar(CalcShocVarorcovarData &d) {
  calc_shoc_varorcovar_host(d.shcol, d.nlev, d.nlevi, d.tunefac, d.isotropy_zi,
                            d.tkh_zi, d.dz_zi, d.invar1, d.invar2,
                            d.varorcovar);
}
...
void integ_column_stability(IntegColumnStabilityData &d) {
  integ_column_stability_host(d.nlev, d.shcol, d.dz_zt, d.pres, d.brunt,
                              d.brunt_int);
}
...
void shoc_tke(ShocTkeData &d) {
  shoc_tke_host(d.shcol, d.nlev, d.nlevi, d.dtime, d.wthv_sec, d.shoc_mix,
                d.dz_zi, d.dz_zt, d.pres, d.tabs, d.u_wind, d.v_wind, d.brunt,
                d.zt_grid, d.zi_grid, d.pblh, d.tke, d.tk, d.tkh, d.isotropy);
}

void compute_shr_prod(ComputeShrProdData &d) {
  compute_shr_prod_host(d.nlevi, d.nlev, d.shcol, d.dz_zi, d.u_wind, d.v_wind,
                        d.sterm);
}

void isotropic_ts(IsotropicTsData &d) {
  isotropic_ts_host(d.nlev, d.shcol, d.brunt_int, d.tke, d.a_diss, d.brunt,
                    d.isotropy);
}

void adv_sgs_tke(AdvSgsTkeData &d) {
  adv_sgs_tke_host(d.nlev, d.shcol, d.dtime, d.shoc_mix, d.wthv_sec, d.sterm_zt,
                   d.tk, d.tke, d.a_diss);
}

void eddy_diffusivities(EddyDiffusivitiesData &d) {
  eddy_diffusivities_host(d.nlev, d.shcol, d.pblh, d.zt_grid, d.tabs,
                          d.shoc_mix, d.sterm_zt, d.isotropy, d.tke, d.tkh,
                          d.tk);
}

void shoc_length(ShocLengthData &d) {
  shoc_length_host(d.shcol, d.nlev, d.nlevi, d.host_dx, d.host_dy, d.zt_grid,
                   d.zi_grid, d.dz_zt, d.tke, d.thv, d.brunt, d.shoc_mix);
}

void compute_brunt_shoc_length(ComputeBruntShocLengthData &d) {
  compute_brunt_shoc_length_host(d.nlev, d.nlevi, d.shcol, d.dz_zt, d.thv,
                                 d.thv_zi, d.brunt);
}

void compute_l_inf_shoc_length(ComputeLInfShocLengthData &d) {
  compute_l_inf_shoc_length_host(d.nlev, d.shcol, d.zt_grid, d.dz_zt, d.tke,
                                 d.l_inf);
}

void compute_shoc_mix_shoc_length(ComputeShocMixShocLengthData &d) {
  compute_shoc_mix_shoc_length_host(d.nlev, d.shcol, d.tke, d.brunt, d.zt_grid,
                                    d.l_inf, d.shoc_mix);
}

void check_length_scale_shoc_length(CheckLengthScaleShocLengthData &d) {
  check_length_scale_shoc_length_host(d.nlev, d.shcol, d.host_dx, d.host_dy,
                                      d.shoc_mix);
}
...
void diag_second_moments_srf(DiagSecondMomentsSrfData &d) {
  shoc_diag_second_moments_srf_host(d.shcol, d.wthl_sfc, d.uw_sfc, d.vw_sfc,
                                    d.ustar2, d.wstar);
}
...
void diag_third_shoc_moments(DiagThirdShocMomentsData &d) {
  diag_third_shoc_moments_host(d.shcol, d.nlev, d.nlevi, d.w_sec, d.thl_sec,
                               d.wthl_sec, d.isotropy, d.brunt, d.thetal, d.tke,
                               d.dz_zt, d.dz_zi, d.zt_grid, d.zi_grid, d.w3);
}

void compute_diag_third_shoc_moment(ComputeDiagThirdShocMomentData &d) {
  compute_diag_third_shoc_moment_host(
      d.shcol, d.nlev, d.nlevi, d.w_sec, d.thl_sec, d.wthl_sec, d.tke, d.dz_zt,
      d.dz_zi, d.isotropy_zi, d.brunt_zi, d.w_sec_zi, d.thetal_zi, d.w3);
}

void shoc_assumed_pdf(ShocAssumedPdfData &d) {
  shoc_assumed_pdf_host(
      d.shcol, d.nlev, d.nlevi, d.thetal, d.qw, d.w_field, d.thl_sec, d.qw_sec,
...
void shoc_assumed_pdf_vv_parameters(ShocAssumedPdfVvParametersData &d) {
  shoc_assumed_pdf_vv_parameters_host(d.w_first, d.w_sec, d.w3var, d.w_tol_sqd,
                                      &d.skew_w, &d.w1_1, &d.w1_2, &d.w2_1,
                                      &d.w2_2, &d.a);
}

void shoc_assumed_pdf_thl_parameters(ShocAssumedPdfThlParametersData &d) {
  shoc_assumed_pdf_thl_parameters_host(
      d.wthlsec, d.sqrtw2, d.sqrtthl, d.thlsec, d.thl_first, d.w1_1, d.w1_2,
      d.skew_w, d.a, d.thl_tol, d.w_thresh, &d.thl1_1, &d.thl1_2, &d.thl2_1,
      &d.thl2_2, &d.sqrtthl2_1, &d.sqrtthl2_2);
}

void shoc_assumed_pdf_qw_parameters(ShocAssumedPdfQwParametersData &d) {
  shoc_assumed_pdf_qw_parameters_host(
      d.wqwsec, d.sqrtw2, d.skew_w, d.sqrtqt, d.qwsec, d.w1_2, d.w1_1,
      d.qw_first, d.a, d.rt_tol, d.w_thresh, &d.qw1_1, &d.qw1_2, &d.qw2_1,
      &d.qw2_2, &d.sqrtqw2_1, &d.sqrtqw2_2);
}
...
void shoc_assumed_pdf_inplume_correlations(
  ...
  shoc_assumed_pdf_inplume_correlations_host(
      d.sqrtqw2_1, d.sqrtthl2_1, d.a, d.sqrtqw2_2, d.sqrtthl2_2, d.qwthlsec,
...
void shoc_assumed_pdf_compute_qs(ShocAssumedPdfComputeQsData &d) {
  shoc_assumed_pdf_compute_qs_host(d.tl1_1, d.tl1_2, d.pval, &d.qs1, &d.beta1,
                                   &d.qs2, &d.beta2);
}

void shoc_assumed_pdf_compute_s(ShocAssumedPdfComputeSData &d) {
  shoc_assumed_pdf_compute_s_host(d.qw1, d.qs1, d.beta, d.pval, d.thl2, d.qw2,
                                  d.sqrtthl2, d.sqrtqw2, d.r_qwthl, &d.s,
                                  &d.std_s, &d.qn, &d.c);
}

void shoc_assumed_pdf_compute_sgs_liquid(
    ShocAssumedPdfComputeSgsLiquidData &d) {
...
void shoc_assumed_pdf_compute_cloud_liquid_variance(
  ...
  shoc_assumed_pdf_compute_cloud_liquid_variance_host(
      d.a, d.s1, d.ql1, d.c1, d.std_s1, d.s2, d.ql2, d.c2, d.std_s2, d.shoc_ql,
      &d.shoc_ql2);
}

void shoc_assumed_pdf_compute_liquid_water_flux(
    ShocAssumedPdfComputeLiquidWaterFluxData &d) {
  shoc_assumed_pdf_compute_liquid_water_flux_host(d.a, d.w1_1, d.w_first, d.ql1,
                                                  d.w1_2, d.ql2, &d.wqls);
}

void shoc_assumed_pdf_compute_buoyancy_flux(
    ShocAssumedPdfComputeBuoyancyFluxData &d) {
  shoc_assumed_pdf_compute_buoyancy_flux_host(d.wthlsec, d.wqwsec, d.pval,
                                              d.wqls, &d.wthv_sec);
}

void diag_second_moments_ubycond(DiagSecondMomentsUbycondData &d) {
  shoc_diag_second_moments_ubycond_host(d.shcol, d.thl_sec, d.qw_sec,
                                        d.wthl_sec, d.wqw_sec, d.qwthl_sec,
                                        d.uw_sec, d.vw_sec, d.wtke_sec);
}
...
void diag_second_moments_lbycond(DiagSecondMomentsLbycondData &d) {
  diag_second_moments_lbycond_host(d.shcol, d.wthl_sfc, d.wqw_sfc, d.uw_sfc,
                                   d.vw_sfc, d.ustar2, d.wstar, d.wthl_sec,
                                   d.wqw_sec, d.uw_sec, d.vw_sec, d.wtke_sec,
                                   d.thl_sec, d.qw_sec, d.qwthl_sec);
}

void diag_second_moments(DiagSecondMomentsData &d) {
  diag_second_moments_host(d.shcol, d.nlev, d.nlevi, d.thetal, d.qw, d.u_wind,
                           d.v_wind, d.tke, d.isotropy, d.tkh, d.tk, d.dz_zi,
                           d.zt_grid, d.zi_grid, d.shoc_mix, d.thl_sec,
                           d.qw_sec, d.wthl_sec, d.wqw_sec, d.qwthl_sec,
                           d.uw_sec, d.vw_sec, d.wtke_sec, d.w_sec);
}

void diag_second_shoc_moments(DiagSecondShocMomentsData &d) {
  diag_second_shoc_moments_host(
      d.shcol, d.nlev, d.nlevi, d.thetal, d.qw, d.u_wind, d.v_wind, d.tke,
...
void update_prognostics_implicit(UpdatePrognosticsImplicitData &d) {
  update_prognostics_implicit_host(
      d.shcol, d.nlev, d.nlevi, d.num_tracer, d.dtime, d.dz_zt, d.dz_zi,
      d.rho_zt, d.zt_grid, d.zi_grid, d.tk, d.tkh, d.uw_sfc, d.vw_sfc,
      d.wthl_sfc, d.wqw_sfc, d.wtracer_sfc, d.thetal, d.qw, d.tracer, d.tke,
      d.u_wind, d.v_wind);
}
...
void shoc_main(ShocMainData &d) {
  ...
  d.elapsed_s    = shoc_main_host(
      d.shcol, d.nlev, d.nlevi, d.dtime, d.nadv, npbl, d.host_dx, d.host_dy,
      d.thv, d.zt_grid, d.zi_grid, d.pres, d.presi, d.pdel, d.wthl_sfc,
      d.wqw_sfc, d.uw_sfc, d.vw_sfc, d.wtracer_sfc, d.num_qtracers, d.w_field,
      d.inv_exner, d.phis, d.host_dse, d.tke, d.thetal, d.qw, d.u_wind,
      d.v_wind, d.qtracers, d.wthv_sec, d.tkh, d.tk, d.shoc_ql, d.shoc_cldfrac,
      d.pblh, d.shoc_mix, d.isotropy, d.w_sec, d.thl_sec, d.qw_sec, d.qwthl_sec,
      d.wthl_sec, d.wqw_sec, d.wtke_sec, d.uw_sec, d.vw_sec, d.w3, d.wqls_sec,
      d.brunt, d.shoc_ql2);
}

void pblintd_height(PblintdHeightData &d) {
  pblintd_height_host(d.shcol, d.nlev, d.npbl, d.z, d.u, d.v, d.ustar, d.thv,
                      d.thv_ref, d.pblh, d.rino, d.check);
}

void vd_shoc_decomp_and_solve(VdShocDecompandSolveData &d) {
  vd_shoc_decomp_and_solve_host(d.shcol, d.nlev, d.nlevi, d.n_rhs, d.dtime,
                                d.kv_term, d.tmpi, d.rdp_zt, d.flux, d.var);
}

void pblintd_surf_temp(PblintdSurfTempData &d) {
  pblintd_surf_temp_host(d.shcol, d.nlev, d.nlevi, d.z, d.ustar, d.obklen,
                         d.kbfs, d.thv, d.tlv, d.pblh, d.check, d.rino);
}

void pblintd_check_pblh(PblintdCheckPblhData &d) {
  pblintd_check_pblh_host(d.shcol, d.nlev, d.nlevi, d.nlev /*npbl*/, d.z,
                          d.ustar, d.check, d.pblh);
}

void pblintd(PblintdData &d) {
  pblintd_host(d.shcol, d.nlev, d.nlevi, d.npbl, d.z, d.zi, d.thl, d.ql, d.q,
               d.u, d.v, d.ustar, d.obklen, d.kbfs, d.cldn, d.pblh);
}

void compute_shoc_temperature(ComputeShocTempData &d) {
  compute_shoc_temperature_host(d.shcol, d.nlev, d.thetal, d.ql, d.inv_exner,
                                d.tabs);
}
...
void calc_shoc_varorcovar_host(Int shcol, Int nlev, Int nlevi, Real tunefac,
  ...
  std::vector<const Real *> ptr_array = {isotropy_zi, tkh_zi, dz_zi,
                                         invar1,      invar2, varorcovar};

  // Sync to device
  ekat::host_to_device(ptr_array, dim1_sizes, dim2_sizes, temp_d);

  view_2d isotropy_zi_d(temp_d[0]), tkh_zi_d(temp_d[1]), dz_zi_d(temp_d[2]),
      invar1_d(temp_d[3]), invar2_d(temp_d[4]), varorcovar_d(temp_d[5]);

  const Int nk_pack = ekat::npack<Spack>(nlev);
  const auto policy =
      ekat::ExeSpaceUtils<ExeSpace>::get_default_team_policy(shcol, nk_pack);
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::calc_shoc_varorcovar(team, nlev, tunefac, oisotropy_zi_d,
                                  otkh_zi_d, odz_zi_d, oinvar1_d, oinvar2_d,
                                  ovarorcovar_d);
      });
...
void calc_shoc_vertflux_host(Int shcol, Int nlev, Int nlevi, Real *tkh_zi,
  ...
  view_2d tkh_zi_d(temp_d[0]), dz_zi_d(temp_d[1]), invar_d(temp_d[2]),
      vertflux_d(temp_d[3]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::calc_shoc_vertflux(team, nlev, otkh_zi_d, odz_zi_d, oinvar_d,
                                overtflux_d);
      });
...
void shoc_diag_second_moments_srf_host(Int shcol, Real *wthl_sfc, Real *uw_sfc,
                                       Real *vw_sfc, Real *ustar2,
                                       Real *wstar) {
  ...
  // inputs
  view_1d wthl_sfc_d(temp_d[0]), uw_sfc_d(temp_d[1]), vw_sfc_d(temp_d[2]);

  // outputs
  view_1d ustar2_d("ustar2", shcol), wstar_d("wstar", shcol);

  Kokkos::parallel_for(
      "parallel_moments_srf", shcol, KOKKOS_LAMBDA(const int &i) {
        ...
        SHOC::shoc_diag_second_moments_srf(wthl_sfc_s, uw_sfc_s, vw_sfc_s,
                                           ustar2_s, wstar_s);
...
void shoc_diag_second_moments_ubycond_host(Int shcol, Real *thl_sec,
                                           Real *qw_sec, Real *wthl_sec,
                                           Real *wqw_sec, Real *qwthl_sec,
                                           Real *uw_sec, Real *vw_sec,
                                           Real *wtke_sec) {
  using SHOC    = Functions<Real, DefaultDevice>;
  using Scalar  = typename SHOC::Scalar;
  using view_1d = typename SHOC::view_1d<Scalar>;

  view_1d thl_sec_d("thl_sec", shcol), qw_sec_d("qw_sec", shcol),
      qwthl_sec_d("qwthl_sec", shcol), wthl_sec_d("wthl_sec", shcol),
      wqw_sec_d("wqw_sec", shcol), uw_sec_d("uw_sec", shcol),
  ...
  Kokkos::parallel_for(
      "parallel_moments_ubycond", shcol, KOKKOS_LAMBDA(const int &i) {
        ...
        SHOC::shoc_diag_second_moments_ubycond(thl_sec_s, qw_sec_s, wthl_sec_s,
                                               wqw_sec_s, qwthl_sec_s, uw_sec_s,
                                               vw_sec_s, wtke_sec_s);
  ...
  std::vector<view_1d> host_views = {thl_sec_d,  qw_sec_d,  qwthl_sec_d,
                                     wthl_sec_d, wqw_sec_d, uw_sec_d,
                                     vw_sec_d,   wtke_sec_d};

  ScreamDeepCopy::copy_to_host(
      {thl_sec, qw_sec, qwthl_sec, wthl_sec, wqw_sec, uw_sec, vw_sec, wtke_sec},
      shcol, host_views);
}
...
void update_host_dse_host(Int shcol, Int nlev, Real *thlm, Real *shoc_ql,
  ...
  std::vector<const Real *> ptr_array = {thlm, shoc_ql, inv_exner, zt_grid,
                                         host_dse};
  ...
  view_2d thlm_d(temp_2d_d[0]), shoc_ql_d(temp_2d_d[1]),
      inv_exner_d(temp_2d_d[2]), zt_grid_d(temp_2d_d[3]),
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::update_host_dse(team, nlev, thlm_s, shoc_ql_s, inv_exner_s,
                             zt_grid_s, phis_s, host_dse_s);
      });
...
void compute_diag_third_shoc_moment_host(Int shcol, Int nlev, Int nlevi,
  ...
  std::vector<const Real *> ptr_array = {
      w_sec,       thl_sec,  wthl_sec, tke,       dz_zt, dz_zi,
      isotropy_zi, brunt_zi, w_sec_zi, thetal_zi, w3};

  // Sync to device
  ekat::host_to_device(ptr_array, dim1_sizes, dim2_sizes, temp_d);

  view_2d w_sec_d(temp_d[0]), thl_sec_d(temp_d[1]), wthl_sec_d(temp_d[2]),
      tke_d(temp_d[3]), dz_zt_d(temp_d[4]), dz_zi_d(temp_d[5]),
      isotropy_zi_d(temp_d[6]), brunt_zi_d(temp_d[7]), w_sec_zi_d(temp_d[8]),
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::compute_diag_third_shoc_moment(
            team, nlev, nlevi, c_diag_3rd_mom, w_sec_s, thl_sec_s, wthl_sec_s,
            tke_s, dz_zt_s, dz_zi_s, isotropy_zi_s, brunt_zi_s, w_sec_zi_s,
            thetal_zi_s, w3_s);
      });
...
void shoc_pblintd_init_pot_host(Int shcol, Int nlev, Real *thl, Real *ql,
  ...
  view_2d thl_d(temp_d[0]), ql_d(temp_d[1]), q_d(temp_d[2]);

  view_2d thv_d("thv", shcol, nlev);

  const Int nlev_pack = ekat::npack<Spack>(nlev);
  const auto policy =
      ekat::ExeSpaceUtils<ExeSpace>::get_default_team_policy(shcol, nlev_pack);
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        const Int i = team.league_rank();
...
void compute_shoc_mix_shoc_length_host(Int nlev, Int shcol, Real *tke,
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::compute_shoc_mix_shoc_length(team, nlev, length_fac, tke_s,
                                          brunt_s, zt_grid_s, l_inf_s,
                                          shoc_mix_s);
      });
...
void linear_interp_host(Real *x1, Real *x2, Real *y1, Real *y2, Int km1,
  ...
  view_2d x1_d(temp_2d_d[0]), x2_d(temp_2d_d[1]), y1_d(temp_2d_d[2]),
      y2_d("y2_d", ncol, km2);

  const Int nk_pack = ekat::npack<Spack>(km1);
  const auto policy =
      ekat::ExeSpaceUtils<ExeSpace>::get_default_team_policy(ncol, nk_pack);
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        const Int i = team.league_rank();
...
void clipping_diag_third_shoc_moments_host(Int nlevi, Int shcol, Real *w_sec_zi,
  ...
  view_2d w_sec_zi_d(temp_d[0]), w3_d(temp_d[1]);
...
void shoc_energy_integrals_host(Int shcol, Int nlev, Real *host_dse, Real *pdel,
  ...
  std::vector<const Real *> ptr_array = {host_dse, pdel,   rtm,
                                         rcm,      u_wind, v_wind};
  ...
  // inputs
  view_2d host_dse_d(temp_d[0]), pdel_d(temp_d[1]), rtm_d(temp_d[2]),
      rcm_d(temp_d[3]), u_wind_d(temp_d[4]), v_wind_d(temp_d[5]);

  // outputs
  view_1d se_int_d("se_int", shcol), ke_int_d("ke_int", shcol),
      wv_int_d("wv_int", shcol), wl_int_d("wl_int", shcol);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::shoc_energy_integrals(team, nlev, host_dse_s, pdel_s, rtm_s, rcm_s,
                                   u_wind_s, v_wind_s, se_int_s, ke_int_s,
                                   wv_int_s, wl_int_s);
  ...
  ScreamDeepCopy::copy_to_host({se_int, ke_int, wv_int, wl_int}, shcol,
                               inout_views);
}
...
void diag_second_moments_lbycond_host(Int shcol, Real *wthl_sfc, Real *wqw_sfc,
  ...
  ScreamDeepCopy::copy_to_device(
      {wthl_sfc, wqw_sfc, uw_sfc, vw_sfc, ustar2, wstar}, shcol, lbycond_d);

  // inputs
  view_1d wthl_d(lbycond_d[0]), wqw_d(lbycond_d[1]), uw_d(lbycond_d[2]),
      vw_d(lbycond_d[3]), ustar2_d(lbycond_d[4]), wstar_d(lbycond_d[5]);

  // outputs
  view_1d wthlo_d("wthl", shcol), wqwo_d("wqw", shcol), uwo_d("uw", shcol),
      vwo_d("vw", shcol), wtkeo_d("wtke", shcol), thlo_d("thl", shcol),
      qwo_d("qw", shcol), qwthlo_d("qwthl", shcol);
  ...
  Kokkos::parallel_for(
      "parallel_moments_lbycond", shcol, KOKKOS_LAMBDA(const int &i) {
        ...
        Scalar wthlo_s{0.}, wqwo_s{0.}, uwo_s{0.}, vwo_s{0.}, wtkeo_s{0.},
            thlo_s{0.}, qwo_s{0.}, qwthlo_s{0.};

        SHOC::shoc_diag_second_moments_lbycond(
            wthl_s, wqw_s, uw_s, vw_s, ustar2_s, wstar_s, wthlo_s, wqwo_s,
            uwo_s, vwo_s, wtkeo_s, thlo_s, qwo_s, qwthlo_s);
...
void diag_second_moments_host(Int shcol, Int nlev, Int nlevi, Real *thetal,
  ...
  std::vector<Int> dim2_array = {
      nlev,  nlev,  nlev,  nlev,  nlev,  nlev,  nlev,  nlev,  nlev,  nlev,
      nlevi, nlevi, nlevi, nlevi, nlevi, nlevi, nlevi, nlevi, nlevi, nlevi};

  std::vector<view_2d> temp_2d(20);
  std::vector<const Real *> ptr_array = {
      thetal,    qw,      u_wind,   v_wind,   tke,    isotropy, tkh,
  ...
  view_2d thetal_2d(temp_2d[0]), qw_2d(temp_2d[1]), u_wind_2d(temp_2d[2]),
      v_wind_2d(temp_2d[3]), tke_2d(temp_2d[4]), isotropy_2d(temp_2d[5]),
      tkh_2d(temp_2d[6]), tk_2d(temp_2d[7]), zt_grid_2d(temp_2d[8]),
      shoc_mix_2d(temp_2d[9]), thl_sec_2d(temp_2d[10]), qw_sec_2d(temp_2d[11]),
      wthl_sec_2d(temp_2d[12]), wqw_sec_2d(temp_2d[13]),
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHOC::diag_second_moments(
            team, nlev, nlevi, thl2tune, qw2tune, qwthl2tune, w2tune, thetal_1d,
            qw_1d, u_wind_1d, v_wind_1d, tke_1d, isotropy_1d, tkh_1d, tk_1d,
            dz_zi_1d, zt_grid_1d, zi_grid_1d, shoc_mix_1d, isotropy_zi_1d,
            tkh_zi_1d, tk_zi_1d, thl_sec_1d, qw_sec_1d, wthl_sec_1d, wqw_sec_1d,
            qwthl_sec_1d, uw_sec_1d, vw_sec_1d, wtke_sec_1d, w_sec_1d);
      });

  std::vector<Int> dim1(9, shcol);
  std::vector<Int> dim2           = {nlevi, nlevi, nlevi, nlevi, nlevi,
                                     nlevi, nlevi, nlevi, nlev};
  std::vector<view_2d> host_views = {thl_sec_2d, qw_sec_2d,    wthl_sec_2d,
                                     wqw_sec_2d, qwthl_sec_2d, uw_sec_2d,
                                     vw_sec_2d,  wtke_sec_2d,  w_sec_2d};
  ekat::device_to_host({thl_sec, qw_sec, wthl_sec, wqw_sec, qwthl_sec, uw_sec,
                        vw_sec, wtke_sec, w_sec},
                       dim1, dim2, host_views);
}
...
void diag_second_shoc_moments_host(
  ...
  ScreamDeepCopy::copy_to_device({wthl_sfc, wqw_sfc, uw_sfc, vw_sfc}, shcol,
                                 temp_1d);

  view_1d wthl_1d(temp_1d[0]), wqw_1d(temp_1d[1]), uw_1d(temp_1d[2]),
      vw_1d(temp_1d[3]);
  ...
  view_1d ustar2_1d("ustar2", shcol), wstar_1d("wstar", shcol);
  ...
  ekat::WorkspaceManager<Spack, KT::Device> workspace_mgr(nlevi_packs, 3,
                                                          policy);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHOC::diag_second_shoc_moments(
            team, nlev, nlevi, thl2tune, qw2tune, qwthl2tune, w2tune, thetal_1d,
            qw_1d, u_wind_1d, v_wind_1d, tke_1d, isotropy_1d, tkh_1d, tk_1d,
            dz_zi_1d, zt_grid_1d, zi_grid_1d, shoc_mix_1d, wthl_s, wqw_s, uw_s,
            vw_s, ustar2_s, wstar_s, workspace, thl_sec_1d, qw_sec_1d,
            wthl_sec_1d, wqw_sec_1d, qwthl_sec_1d, uw_sec_1d, vw_sec_1d,
            wtke_sec_1d, w_sec_1d);
      });
...
void compute_brunt_shoc_length_host(Int nlev, Int nlevi, Int shcol, Real *dz_zt,
  ...
  view_2d dz_zt_d(temp_d[0]), thv_d(temp_d[1]), thv_zi_d(temp_d[2]),
      brunt_d(temp_d[3]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::compute_brunt_shoc_length(team, nlev, nlevi, dz_zt_s, thv_s,
                                       thv_zi_s, brunt_s);
      });
...
void compute_l_inf_shoc_length_host(Int nlev, Int shcol, Real *zt_grid,
  ...
  // inputs
  view_2d zt_grid_d(temp_d[0]), dz_zt_d(temp_d[1]), tke_d(temp_d[2]);

  // outputs
  view_1d l_inf_d("l_inf", shcol);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::compute_l_inf_shoc_length(team, nlev, zt_grid_s, dz_zt_s, tke_s,
                                       l_inf_s);
...
void check_length_scale_shoc_length_host(Int nlev, Int shcol, Real *host_dx,
  ...
  view_2d shoc_mix_d(temp_2d_d[0]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::check_length_scale_shoc_length(team, nlev, host_dx_s, host_dy_s,
                                            shoc_mix_s);
      });
...
void shoc_diag_obklen_host(Int shcol, Real *uw_sfc, Real *vw_sfc,
  ...
  // Inputs
  view_1d uw_sfc_d(temp_d[0]), vw_sfc_d(temp_d[1]), wthl_sfc_d(temp_d[2]),
      wqw_sfc_d(temp_d[3]), thl_sfc_d(temp_d[4]), cldliq_sfc_d(temp_d[5]),
      qv_sfc_d(temp_d[6]);

  // Outputs
  view_1d ustar_d("ustar", shcol), kbfs_d("kbfs", shcol),
      obklen_d("obklen", shcol);

  Kokkos::parallel_for(
      "shoc_diag_obklen", shcol, KOKKOS_LAMBDA(const int &i) {
        Scalar uw_sfc_s{uw_sfc_d(i)};
        Scalar vw_sfc_s{vw_sfc_d(i)};
        Scalar wthl_sfc_s{wthl_sfc_d(i)};
        ...
        SHF::shoc_diag_obklen(uw_sfc_s, vw_sfc_s, wthl_sfc_s, wqw_sfc_s,
                              thl_sfc_s, cldliq_sfc_s, qv_sfc_s, ustar_s,
                              kbfs_s, obklen_s);
...
void shoc_pblintd_cldcheck_host(Int shcol, Int nlev, Int nlevi, Real *zi,
  ...
  view_2d zi_2d(cldcheck_2d[0]), cldn_2d(cldcheck_2d[1]);
  ...
  Kokkos::parallel_for(
      "pblintd_cldcheck", shcol, KOKKOS_LAMBDA(const int &i) {
...
void shoc_length_host(Int shcol, Int nlev, Int nlevi, Real *host_dx,
  ...
  std::vector<int> dim2_sizes = {nlev, nlevi, nlev, nlev, nlev, nlev, nlev};
  ...
  view_2d zt_grid_d(temp_2d_d[0]), zi_grid_d(temp_2d_d[1]),
      dz_zt_d(temp_2d_d[2]), tke_d(temp_2d_d[3]), thv_d(temp_2d_d[4]),
      brunt_d(temp_2d_d[5]), shoc_mix_d(temp_2d_d[6]);
  ...
  // Local variable workspace
  ekat::WorkspaceManager<Spack, KT::Device> workspace_mgr(nlevi_packs, 1,
                                                          policy);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::shoc_length(team, nlev, nlevi, length_fac, host_dx_s, host_dy_s,
                         zt_grid_s, zi_grid_s, dz_zt_s, tke_s, thv_s, workspace,
                         brunt_s, shoc_mix_s);
      });
...
void shoc_energy_fixer_host(Int shcol, Int nlev, Int nlevi, Real dtime,
  ...
  std::vector<const Real *> ptr_array_1d = {
  ...
  view_1d se_b_d(temp_1d_d[0]), ke_b_d(temp_1d_d[1]), wv_b_d(temp_1d_d[2]),
      wl_b_d(temp_1d_d[3]), se_a_d(temp_1d_d[4]), ke_a_d(temp_1d_d[5]),
      wv_a_d(temp_1d_d[6]), wl_a_d(temp_1d_d[7]), wthl_sfc_d(temp_1d_d[8]),
      wqw_sfc_d(temp_1d_d[9]);

  view_2d zt_grid_d(temp_2d_d[0]), zi_grid_d(temp_2d_d[1]),
      pint_d(temp_2d_d[2]), rho_zt_d(temp_2d_d[3]), tke_d(temp_2d_d[4]),
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::shoc_energy_fixer(
            team, nlev, nlevi, dtime, nadv, zt_grid_s, zi_grid_s, se_b_s,
            ke_b_s, wv_b_s, wl_b_s, se_a_s, ke_a_s, wv_a_s, wl_a_s, wthl_sfc_s,
...
void compute_shoc_vapor_host(Int shcol, Int nlev, Real *qw, Real *ql,
                             Real *qv) {
  using SHF = Functions<Real, DefaultDevice>;
  ...
  // Inputs/Outputs
  view_2d qw_d(temp_d[0]), ql_d(temp_d[1]), qv_d(temp_d[2]);
...
void update_prognostics_implicit_host(
  ...
  std::vector<int> dim2_sizes         = {nlev, nlevi, nlev,       nlev, nlevi,
                                         ...
                                         nlev, nlev,  nlev};
  std::vector<const Real *> ptr_array = {
      dz_zt,       dz_zi,  rho_zt, zt_grid, zi_grid, tk,    tkh,
      wtracer_sfc, thetal, qw,     tke,     u_wind,  v_wind};

  // Sync to device
  ScreamDeepCopy::copy_to_device({uw_sfc, vw_sfc, wthl_sfc, wqw_sfc}, shcol,
                                 temp_1d_d);
  ekat::host_to_device(ptr_array, dim1_sizes, dim2_sizes, temp_2d_d);
  ekat::host_to_device({tracer}, shcol, nlev, num_tracer, temp_3d_d);

  view_1d uw_sfc_d(temp_1d_d[0]), vw_sfc_d(temp_1d_d[1]),
      wthl_sfc_d(temp_1d_d[2]), wqw_sfc_d(temp_1d_d[3]);

  view_2d dz_zt_d(temp_2d_d[0]), dz_zi_d(temp_2d_d[1]), rho_zt_d(temp_2d_d[2]),
      zt_grid_d(temp_2d_d[3]), zi_grid_d(temp_2d_d[4]), tk_d(temp_2d_d[5]),
      tkh_d(temp_2d_d[6]), wtracer_sfc_d(temp_2d_d[7]), thetal_d(temp_2d_d[8]),
      qw_d(temp_2d_d[9]), tke_d(temp_2d_d[10]), u_wind_d(temp_2d_d[11]),
        ...
        Kokkos::parallel_for(
            Kokkos::TeamThreadRange(team, nlev), [&](const Int &k) {
              Kokkos::parallel_for(Kokkos::ThreadVectorRange(team, num_tracer),
                                   [&](const Int &q) {
                                     qtracers_cxx_d_s(i, q, k) =
                                         qtracers_f90_d_s(i, k, q);
                                   });
            });
      });
  ...
  ekat::WorkspaceManager<Spack, KT::Device> workspace_mgr(nlevi_packs,
                                                          tmp_var_size, policy);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        const auto tke_s         = ekat::subview(tke_d, i);
        const auto tracer_s =
            Kokkos::subview(qtracers_cxx_d, i, Kokkos::ALL(), Kokkos::ALL());

        SHF::update_prognostics_implicit(
            team, nlev, nlevi, num_tracer, dtime, dz_zt_s, dz_zi_s, rho_zt_s,
            zt_grid_s, zi_grid_s, tk_s, tkh_s, uw_sfc_s, vw_sfc_s, wthl_sfc_s,
            wqw_sfc_s, wtracer_sfc_s, workspace, thetal_s, qw_s, tracer_s,
            tke_s, u_wind_s, v_wind_s);
      });
  ...
  // Sync back to host
  std::vector<view_2d> inout_views_2d = {thetal_d, qw_d, u_wind_d, v_wind_d,
                                         tke_d};
  ekat::device_to_host({thetal, qw, u_wind, v_wind, tke}, shcol, nlev,
                       inout_views_2d);
...
void diag_third_shoc_moments_host(Int shcol, Int nlev, Int nlevi, Real *w_sec,
  ...
  view_2d wsec_d(temp_d[0]), thl_sec_d(temp_d[1]), wthl_sec_d(temp_d[2]),
      isotropy_d(temp_d[3]), brunt_d(temp_d[4]), thetal_d(temp_d[5]),
      tke_d(temp_d[6]), dz_zt_d(temp_d[7]), dz_zi_d(temp_d[8]),
      zt_grid_d(temp_d[9]), zi_grid_d(temp_d[10]), w3_d(temp_d[11]);
  ...
  // Local variable workspace
  ekat::WorkspaceManager<Spack, KT::Device> workspace_mgr(nlevi_packs, 4,
                                                          policy);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        const Real c_diag_3rd_mom = 7.0;
        SHF::diag_third_shoc_moments(team, nlev, nlevi, c_diag_3rd_mom, wsec_s,
                                     thl_sec_s, wthl_sec_s, isotropy_s, brunt_s,
                                     thetal_s, tke_s, dz_zt_s, dz_zi_s,
                                     zt_grid_s, zi_grid_s, workspace, w3_s);
      });
...
void adv_sgs_tke_host(Int nlev, Int shcol, Real dtime, Real *shoc_mix,
  ...
  std::vector<view_2d> temp_d(num_arrays);
  std::vector<const Real *> ptr_array = {shoc_mix, wthv_sec, sterm_zt,
                                         tk,       tke,      a_diss};
  ...
  view_2d
      // input
      shoc_mix_d(temp_d[0]),
      wthv_sec_d(temp_d[1]), sterm_zt_d(temp_d[2]), tk_d(temp_d[3]),
      // output
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::adv_sgs_tke(team, nlev, dtime, shoc_mix_s, wthv_sec_s, sterm_zt_s,
                         tk_s, tke_s, a_diss_s);
      });
...
void shoc_assumed_pdf_host(Int shcol, Int nlev, Int nlevi, Real *thetal,
  ...
  std::vector<const Real *> ptr_array = {
      thetal,  qw,           thl_sec, qw_sec,  wthl_sec, w_sec,
  ...
  // Inputs/Outputs
  view_2d thetal_d(temp_d[0]), qw_d(temp_d[1]), thl_sec_d(temp_d[2]),
      qw_sec_d(temp_d[3]), wthl_sec_d(temp_d[4]), w_sec_d(temp_d[5]),
      wqw_sec_d(temp_d[6]), qwthl_sec_d(temp_d[7]), w3_d(temp_d[8]),
      w_field_d(temp_d[9]), pres_d(temp_d[10]), zt_grid_d(temp_d[11]),
      zi_grid_d(temp_d[12]), shoc_cldfrac_d(temp_d[13]), shoc_ql_d(temp_d[14]),
      wqls_d(temp_d[15]), wthv_sec_d(temp_d[16]), shoc_ql2_d(temp_d[17]);
  ...
  // Local variable workspace
  ekat::WorkspaceManager<Spack, KT::Device> workspace_mgr(nlev_packs, 6,
                                                          policy);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::shoc_assumed_pdf(team, nlev, nlevi, thetal_s, qw_s, w_field_s,
                              thl_sec_s, qw_sec_s, wthl_sec_s, w_sec_s,
                              wqw_sec_s, qwthl_sec_s, w3_s, pres_s, zt_grid_s,
                              zi_grid_s, workspace, shoc_cldfrac_s, shoc_ql_s,
                              wqls_s, wthv_sec_s, shoc_ql2_s);
      });

  // Sync back to host
  std::vector<view_2d> out_views = {shoc_cldfrac_d, shoc_ql_d, wqls_d,
                                    wthv_sec_d, shoc_ql2_d};
  ekat::device_to_host({shoc_cldfrac, shoc_ql, wqls, wthv_sec, shoc_ql2}, shcol,
                       nlev, out_views);
}
void compute_shr_prod_host(Int nlevi, Int nlev, Int shcol, Real *dz_zi,
  ...
  view_2d
      // input
      dz_zi_d(temp_d[0]),
      u_wind_d(temp_d[1]), v_wind_d(temp_d[2]),
      // output
      sterm_d(temp_d[3]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::compute_shr_prod(team, nlevi, nlev, dz_zi_s, u_wind_s, v_wind_s,
                              sterm_s);
      });
...
void compute_tmpi_host(Int nlevi, Int shcol, Real dtime, Real *rho_zi,
  ...
  // Inputs/Outputs
  view_2d rho_zi_d(temp_d[0]), dz_zi_d(temp_d[1]), tmpi_d(temp_d[2]);
...
void integ_column_stability_host(Int nlev, Int shcol, Real *dz_zt, Real *pres,
  ...
  // Inputs
  view_2d dz_zt_d(temp_d[0]), pres_d(temp_d[1]), brunt_d(temp_d[2]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::integ_column_stability(team, nlev, dz_zt_s, pres_s, brunt_s,
                                    brunt_int_s);
...
void isotropic_ts_host(Int nlev, Int shcol, Real *brunt_int, Real *tke,
  ...
  view_2d tke_d(temp_2d[0]), a_diss_d(temp_2d[1]), brunt_d(temp_2d[2]),
      // output
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        const auto tke_s =
            ekat::subview(tke_d, i); // create subviews of the views
        const auto a_diss_s = ekat::subview(a_diss_d, i);
        const auto brunt_s  = ekat::subview(brunt_d, i);
        ...
        SHF::isotropic_ts(team, nlev, lambda_low, lambda_high, lambda_slope,
...
void dp_inverse_host(Int nlev, Int shcol, Real *rho_zt, Real *dz_zt,
  ...
  // Inputs/Outputs
  view_2d rho_zt_d(temp_d[0]), dz_zt_d(temp_d[1]), rdp_zt_d(temp_d[2]);
...
Int shoc_main_host(Int shcol, Int nlev, Int nlevi, Real dtime, Int nadv,
  ...
  std::vector<int> dim2_2d_sizes = {
      nlev,  nlevi, nlev,  nlevi, nlev,  nlev,  nlev,  num_qtracers, nlev,
  ...
  std::vector<const Real *> ptr_array_2d = {
      zt_grid, zi_grid,     pres,      presi,    pdel,     thv,
      w_field, wtracer_sfc, inv_exner, host_dse, tke,      thetal,
      qw,      u_wind,      v_wind,    wthv_sec, tk,       shoc_cldfrac,
      shoc_ql, shoc_ql2,    tkh,       shoc_mix, w_sec,    thl_sec,
      qw_sec,  qwthl_sec,   wthl_sec,  wqw_sec,  wtke_sec, uw_sec,
  ...
  Int index_counter = 0;
  view_1d host_dx_d(temp_1d_d[index_counter++]),
      ...
      vw_sfc_d(temp_1d_d[index_counter++]), phis_d(temp_1d_d[index_counter++]),
      pblh_d("pblh", shcol), ustar_d("ustar", shcol), obklen_d("obklen", shcol);

  index_counter = 0;
  view_2d zt_grid_d(temp_2d_d[index_counter++]),
      zi_grid_d(temp_2d_d[index_counter++]), pres_d(temp_2d_d[index_counter++]),
      presi_d(temp_2d_d[index_counter++]), pdel_d(temp_2d_d[index_counter++]),
      ...
      host_dse_d(temp_2d_d[index_counter++]), tke_d(temp_2d_d[index_counter++]),
      thetal_d(temp_2d_d[index_counter++]), qw_d(temp_2d_d[index_counter++]),
      ...
      shoc_ql2_d(temp_2d_d[index_counter++]), tkh_d(temp_2d_d[index_counter++]),
      ...
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        Kokkos::parallel_for(
            Kokkos::TeamThreadRange(team, nlev), [&](const Int &k) {
              ...
              Kokkos::parallel_for(
                  Kokkos::ThreadVectorRange(team, num_qtracers),
                  [&](const Int &q) {
  ...
  SHF::SHOCInputOutput shoc_input_output{
      host_dse_d, tke_d,          thetal_d, qw_d,           horiz_wind_d,
  ...
  SHF::SHOCHistoryOutput shoc_history_output{
      shoc_mix_d, w_sec_d,    thl_sec_d,  qw_sec_d,  qwthl_sec_d,
  ...
  view_1d se_b("se_b", shcol), ke_b("ke_b", shcol), wv_b("wv_b", shcol),
      wl_b("wl_b", shcol), se_a("se_a", shcol), ke_a("ke_a", shcol),
      wv_a("wv_a", shcol), wl_a("wl_a", shcol), kbfs("kbfs", shcol),
      ustar2("ustar2", shcol), wstar("wstar", shcol);

  view_2d rho_zt("rho_zt", shcol, nlevi_packs),
  ...
  const auto elapsed_microsec =
      SHF::shoc_main(shcol, nlev, nlevi, npbl, nadv, num_qtracers, dtime,
  ...
  std::vector<view_2d> out_views_2d = {
      host_dse_d,  tke_d,      thetal_d,   qw_d,           u_wind_d,
      v_wind_d,    wthv_sec_d, tk_d,       shoc_cldfrac_d, shoc_ql_d,
      shoc_ql2_d,  shoc_mix_d, w_sec_d,    thl_sec_d,      qw_sec_d,
      qwthl_sec_d, wthl_sec_d, wqw_sec_d,  wtke_sec_d,     uw_sec_d,
      vw_sec_d,    w3_d,       wqls_sec_d, brunt_d,        isotropy_d};
  ekat::device_to_host(ptr_array_2d_out, dim1_2d_out, dim2_2d_out,
                       out_views_2d);
...
void pblintd_height_host(Int shcol, Int nlev, Int npbl, Real *z, Real *u,
  ...
  view_2d z_2d(views_2d[0]), u_2d(views_2d[1]), v_2d(views_2d[2]),
      thv_2d(views_2d[3]), rino_2d(views_2d[4]);

  std::vector<view_1d> views_1d(3);
  ScreamDeepCopy::copy_to_device({ustar, thv_ref, pblh}, shcol, views_1d);
  view_1d ustar_1d(views_1d[0]), thv_ref_1d(views_1d[1]), pblh_1d(views_1d[2]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHOC::pblintd_height(team, nlev, npbl, z_1d, u_1d, v_1d, ustar_s,
                             thv_1d, thv_ref_s, pblh_s, rino_1d, check_s);
      });
...
void vd_shoc_decomp_and_solve_host(Int shcol, Int nlev, Int nlevi, Int num_rhs,
  ...
  view_2d kv_term_d(temp_2d_d[0]), tmpi_d(temp_2d_d[1]), rdp_zt_d(temp_2d_d[2]);

  view_2d_scalar du_d("du", shcol, nlev), dl_d("dl", shcol, nlev),
      d_d("d", shcol, nlev);

  view_3d var_d(temp_3d_d[0]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        const auto var_s =
            Kokkos::subview(var_d, i, Kokkos::ALL(), Kokkos::ALL());

        SHF::vd_shoc_decomp(team, nlev, kv_term_s, tmpi_s, rdp_zt_s, dtime,
                            flux_s, du_s, dl_s, d_s);
        team.team_barrier();
...
void shoc_grid_host(Int shcol, Int nlev, Int nlevi, Real *zt_grid,
  ...
  std::vector<view_2d> temp_2d_d(num_2d_arrays);
  std::vector<int> dim1_sizes(num_2d_arrays, shcol);
  std::vector<int> dim2_sizes         = {nlev, nlevi, nlev, nlev, nlevi, nlev};
  ...
  view_2d zt_grid_d(temp_2d_d[0]), zi_grid_d(temp_2d_d[1]),
      pdel_d(temp_2d_d[2]), dz_zt_d(temp_2d_d[3]), dz_zi_d(temp_2d_d[4]),
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::shoc_grid(team, nlev, nlevi, zt_grid_s, zi_grid_s, pdel_s, dz_zt_s,
                       dz_zi_s, rho_zt_s);
      });

  // Sync back to host
  std::vector<view_2d> inout_views = {dz_zt_d, dz_zi_d, rho_zt_d};
  ekat::device_to_host<Int>({dz_zt, dz_zi, rho_zt}, {shcol, shcol, shcol},
                            {nlev, nlevi, nlev}, inout_views);
}
...
void eddy_diffusivities_host(Int nlev, Int shcol, Real *pblh, Real *zt_grid,
  ...
  view_2d zt_grid_d(temp_2d_d[0]), tabs_d(temp_2d_d[1]),
      shoc_mix_d(temp_2d_d[2]), sterm_zt_d(temp_2d_d[3]),
      isotropy_d(temp_2d_d[4]), tke_d(temp_2d_d[5]), tkh_d(temp_2d_d[6]),
      tk_d(temp_2d_d[7]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        const Real Ckh = 0.1;
        const Real Ckm = 0.1;
        SHF::eddy_diffusivities(team, nlev, Ckh, Ckm, pblh_s, zt_grid_s, tabs_s,
                                shoc_mix_s, sterm_zt_s, isotropy_s, tke_s,
                                tkh_s, tk_s);
      });
...
void pblintd_surf_temp_host(Int shcol, Int nlev, Int nlevi, Real *z,
  ...
  view_2d z_2d(views_2d[0]), thv_2d(views_2d[1]), rino_2d(views_2d[2]);

  std::vector<view_1d> views_1d(5);
  ScreamDeepCopy::copy_to_device({ustar, obklen, kbfs, pblh, tlv}, shcol,
                                 views_1d);
  view_1d ustar_1d(views_1d[0]), obklen_1d(views_1d[1]), kbfs_1d(views_1d[2]),
      pblh_1d(views_1d[3]), tlv_1d(views_1d[4]);
  ...
  Kokkos::parallel_for(
      "pblintd_surf_temp", shcol, KOKKOS_LAMBDA(const int &i) {
        const auto z_1d    = ekat::subview(z_2d, i);
        const auto thv_1d  = ekat::subview(thv_2d, i);
        const auto rino_1d = ekat::subview(rino_2d, i);
        ...
        SHOC::pblintd_surf_temp(nlev, nlevi, npbl, z_1d, ustar_s, obklen_s,
                                kbfs_s, thv_1d, tlv_s, pblh_s, check_s,
                                rino_1d);
      });
...
void pblintd_check_pblh_host(Int shcol, Int nlev, Int nlevi, Int npbl, Real *z,
  ...
  view_1d ustar_1d(views_1d[0]), pblh_1d(views_1d[1]);
  ...
  Kokkos::parallel_for(
      "pblintd_check_pblh", shcol, KOKKOS_LAMBDA(const int &i) {
        const auto z_1d = ekat::subview(z_2d, i);
        Scalar &ustar_s = ustar_1d(i);
        Scalar &pblh_s  = pblh_1d(i);
...
void pblintd_host(Int shcol, Int nlev, Int nlevi, Int npbl, Real *z, Real *zi,
  ...
  std::vector<int> dim2_sizes         = {nlev, nlevi, nlev, nlev,
                                         nlev, nlev,  nlev, nlev};
  std::vector<const Real *> ptr_array = {z, zi, thl, ql, q, u, v, cldn};
  ...
  view_2d z_d(temp_2d_d[0]), zi_d(temp_2d_d[1]), thl_d(temp_2d_d[2]),
      ql_d(temp_2d_d[3]), q_d(temp_2d_d[4]), u_d(temp_2d_d[5]),
      v_d(temp_2d_d[6]), cldn_d(temp_2d_d[7]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::pblintd(team, nlev, nlevi, npbl, z_s, zi_s, thl_s, ql_s, q_s, u_s,
                     v_s, ustar_s, obklen_s, kbfs_s, cldn_s, workspace, pblh_s);
...
void shoc_tke_host(Int shcol, Int nlev, Int nlevi, Real dtime, Real *wthv_sec,
  ...
  std::vector<int> dim1_sizes(num_2d_arrays, shcol);
  std::vector<int> dim2_sizes         = {nlev,  nlev, nlev, nlev, nlevi,
                                         nlev,  nlev, nlev, nlev, nlev,
                                         nlevi, nlev, nlev, nlev, nlev};
  std::vector<const Real *> ptr_array = {
      wthv_sec, shoc_mix, u_wind,  v_wind, dz_zi, dz_zt, pres,    tabs,
  ...
  view_2d wthv_sec_d(temp_2d_d[0]), shoc_mix_d(temp_2d_d[1]),
      u_wind_d(temp_2d_d[2]), v_wind_d(temp_2d_d[3]), dz_zi_d(temp_2d_d[4]),
      dz_zt_d(temp_2d_d[5]), pres_d(temp_2d_d[6]), tabs_d(temp_2d_d[7]),
      brunt_d(temp_2d_d[8]), zt_grid_d(temp_2d_d[9]), zi_grid_d(temp_2d_d[10]),
      tke_d(temp_2d_d[11]), tk_d(temp_2d_d[12]), tkh_d(temp_2d_d[13]),
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::shoc_tke(team, nlev, nlevi, dtime, lambda_low, lambda_high,
                      lambda_slope, lambda_thresh, Ckh, Ckm, wthv_sec_s,
                      shoc_mix_s, dz_zi_s, dz_zt_s, pres_s, tabs_s, u_wind_s,
                      v_wind_s, brunt_s, zt_grid_s, zi_grid_s, pblh_s,
                      workspace, tke_s, tk_s, tkh_s, isotropy_s);
      });
...
void compute_shoc_temperature_host(Int shcol, Int nlev, Real *thetal, Real *ql,
  ...
  // Inputs/Outputs
  view_2d thetal_d(temp_d[0]), ql_d(temp_d[1]), inv_exner_d(temp_d[2]),
      tabs_d(temp_d[3]);
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        SHF::compute_shoc_temperature(team, nlev, thetal_s, ql_s, inv_exner_s,
                                      tabs_s);
      });
...
void shoc_assumed_pdf_vv_parameters_host(Real w_first, Real w_sec, Real w3var,
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack w3var_(w3var), w_first_(w_first), w_sec_(w_sec), a_, skew_w_,
            w1_1_, w1_2_, w2_1_, w2_2_;
        SHF::shoc_assumed_pdf_vv_parameters(w_first_, w_sec_, w3var_, w_tol_sqd,
                                            skew_w_, w1_1_, w1_2_, w2_1_, w2_2_,
                                            a_);
        t_d(0) = a_[0];
        t_d(1) = skew_w_[0];
        t_d(2) = w1_1_[0];
...
void shoc_assumed_pdf_thl_parameters_host(
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack a_(a), skew_w_(skew_w), sqrtthl_(sqrtthl), sqrtw2_(sqrtw2),
            thl_first_(thl_first), thlsec_(thlsec), w1_1_(w1_1), w1_2_(w1_2),
            wthlsec_(wthlsec), sqrtthl2_1_, sqrtthl2_2_, thl1_1_, thl1_2_,
            thl2_1_, thl2_2_;
        SHF::shoc_assumed_pdf_thl_parameters(
            wthlsec_, sqrtw2_, sqrtthl_, thlsec_, thl_first_, w1_1_, w1_2_,
            skew_w_, a_, thl_tol, w_thresh, thl1_1_, thl1_2_, thl2_1_, thl2_2_,
            sqrtthl2_1_, sqrtthl2_2_);
        t_d(0) = sqrtthl2_1_[0];
        t_d(1) = sqrtthl2_2_[0];
        t_d(2) = thl1_1_[0];
        t_d(3) = thl1_2_[0];
...
void shoc_assumed_pdf_qw_parameters_host(
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack a_(a), qw_first_(qw_first), qwsec_(qwsec), skew_w_(skew_w),
            sqrtqt_(sqrtqt), sqrtw2_(sqrtw2), w1_1_(w1_1), w1_2_(w1_2),
            wqwsec_(wqwsec), qw1_1_, qw1_2_, qw2_1_, qw2_2_, sqrtqw2_1_,
            sqrtqw2_2_;
        SHF::shoc_assumed_pdf_qw_parameters(
            wqwsec_, sqrtw2_, skew_w_, sqrtqt_, qwsec_, w1_2_, w1_1_, qw_first_,
            a_, rt_tol, w_thresh, qw1_1_, qw1_2_, qw2_1_, qw2_2_, sqrtqw2_1_,
            sqrtqw2_2_);
        t_d(0) = qw1_1_[0];
        t_d(1) = qw1_2_[0];
        t_d(2) = qw2_1_[0];
...
void shoc_assumed_pdf_inplume_correlations_host(
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack a_(a), qw1_1_(qw1_1), qw1_2_(qw1_2), qw_first_(qw_first),
            qwthlsec_(qwthlsec), sqrtqw2_1_(sqrtqw2_1), sqrtqw2_2_(sqrtqw2_2),
            sqrtthl2_1_(sqrtthl2_1), sqrtthl2_2_(sqrtthl2_2), thl1_1_(thl1_1),
            thl1_2_(thl1_2), thl_first_(thl_first), r_qwthl_1_;
        SHF::shoc_assumed_pdf_inplume_correlations(
            sqrtqw2_1_, sqrtthl2_1_, a_, sqrtqw2_2_, sqrtthl2_2_, qwthlsec_,
            qw1_1_, qw_first_, thl1_1_, thl_first_, qw1_2_, thl1_2_,
            r_qwthl_1_);
        t_d(0) = r_qwthl_1_[0];
      });
  Kokkos::deep_copy(t_h, t_d);
...
void shoc_assumed_pdf_compute_temperature_host(Real thl1, Real pval,
                                               Real *tl1) {
  using SHF = Functions<Real, DefaultDevice>;
...
void shoc_assumed_pdf_compute_qs_host(Real tl1_1, Real tl1_2, Real pval,
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack pval_(pval), tl1_1_(tl1_1), tl1_2_(tl1_2), beta1_, beta2_, qs1_,
            qs2_;
        Smask active_entries(true);
        SHF::shoc_assumed_pdf_compute_qs(tl1_1_, tl1_2_, pval_, active_entries,
                                         qs1_, beta1_, qs2_, beta2_);
        t_d(0) = beta1_[0];
        t_d(1) = beta2_[0];
        t_d(2) = qs1_[0];
        t_d(3) = qs2_[0];
...
void shoc_assumed_pdf_compute_s_host(Real qw1, Real qs1, Real beta, Real pval,
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack beta_(beta), pval_(pval), qs1_(qs1), qw1_(qw1), qw2_(qw2),
            r_qwthl_(r_qwthl), sqrtqw2_(sqrtqw2), sqrtthl2_(sqrtthl2),
            thl2_(thl2), c_, qn_, s_, std_s_;
        SHF::shoc_assumed_pdf_compute_s(qw1_, qs1_, beta_, pval_, thl2_, qw2_,
                                        sqrtthl2_, sqrtqw2_, r_qwthl_, s_,
                                        std_s_, qn_, c_);
        t_d(0) = c_[0];
        t_d(1) = qn_[0];
        t_d(2) = s_[0];
...
void shoc_assumed_pdf_compute_cloud_liquid_variance_host(
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack a_(a), c1_(c1), c2_(c2), ql1_(ql1), ql2_(ql2), s1_(s1), s2_(s2),
            shoc_ql_(shoc_ql), std_s1_(std_s1), std_s2_(std_s2), shoc_ql2_;
        SHF::shoc_assumed_pdf_compute_cloud_liquid_variance(
            a_, s1_, ql1_, c1_, std_s1_, s2_, ql2_, c2_, std_s2_, shoc_ql_,
            shoc_ql2_);
        t_d(0) = shoc_ql2_[0];
      });
  Kokkos::deep_copy(t_h, t_d);
...
void shoc_assumed_pdf_compute_liquid_water_flux_host(Real a, Real w1_1,
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack a_(a), ql1_(ql1), ql2_(ql2), w1_1_(w1_1), w1_2_(w1_2),
            w_first_(w_first), wqls_;
        SHF::shoc_assumed_pdf_compute_liquid_water_flux(
            a_, w1_1_, w_first_, ql1_, w1_2_, ql2_, wqls_);
        t_d(0) = wqls_[0];
      });
  Kokkos::deep_copy(t_h, t_d);
  *wqls = t_h(0);
...
void shoc_assumed_pdf_compute_buoyancy_flux_host(Real wthlsec, Real wqwsec,
  ...
  Kokkos::parallel_for(
      1, KOKKOS_LAMBDA(const Int &) {
        Spack pval_(pval), wqls_(wqls), wqwsec_(wqwsec), wthlsec_(wthlsec),
            wthv_sec_;
        PF::shoc_assumed_pdf_compute_buoyancy_flux(wthlsec_, wqwsec_, pval_,
                                                   wqls_, wthv_sec_);
        t_d(0) = wthv_sec_[0];
      });
  Kokkos::deep_copy(t_h, t_d);
