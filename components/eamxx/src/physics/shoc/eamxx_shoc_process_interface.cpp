...
void SHOCMacrophysics::init_buffers(const ATMBufferManager &buffer_manager) {
  ...
  scalar_view_t *_1d_scalar_view_ptrs[Buffer::num_1d_scalar_ncol] = {&m_buffer.wpthlp_sfc,
                                                                     &m_buffer.wprtp_sfc,
                                                                     &m_buffer.upwp_sfc,
                                                                     &m_buffer.vpwp_sfc
  ...
  spack_2d_view_t *_2d_spack_mid_view_ptrs[Buffer::num_2d_vector_mid] = {&m_buffer.z_mid,
                                                                         &m_buffer.rrho,
                                                                         &m_buffer.thv,
                                                                         &m_buffer.dz,
                                                                         &m_buffer.zt_grid,
  ...
  spack_2d_view_t *_2d_spack_int_view_ptrs[Buffer::num_2d_vector_int] = {&m_buffer.z_int,
                                                                         &m_buffer.rrho_i,
                                                                         &m_buffer.zi_grid,
                                                                         &m_buffer.thl_sec,
                                                                         &m_buffer.qw_sec,
...
void SHOCMacrophysics::initialize_impl(const RunType run_type) {
  ...
  Kokkos::parallel_for(
      Kokkos::RangePolicy<>(0, m_num_levs),
      KOKKOS_LAMBDA(const int lev) { s_pref_mid(lev) = ps0 * hyam(lev) + psref * hybm(lev); });
  Kokkos::fence();
