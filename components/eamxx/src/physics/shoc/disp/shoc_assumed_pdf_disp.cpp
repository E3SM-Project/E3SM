...
void Functions<Real, DefaultDevice>::shoc_assumed_pdf_disp(
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        shoc_assumed_pdf(team, nlev, nlevi, ekat::subview(thetal, i),
                         ekat::subview(qw, i), ekat::subview(w_field, i),
                         ekat::subview(thl_sec, i), ekat::subview(qw_sec, i),
                         ekat::subview(wthl_sec, i), ekat::subview(w_sec, i),
                         ekat::subview(wqw_sec, i), ekat::subview(qwthl_sec, i),
                         ekat::subview(w3, i), ekat::subview(pres, i),
                         ekat::subview(zt_grid, i), ekat::subview(zi_grid, i),
                         workspace, ekat::subview(shoc_cldfrac, i),
                         ekat::subview(shoc_ql, i), ekat::subview(wqls, i),
