...
void Functions<Real, DefaultDevice>::update_host_dse_disp(
    const Int &shcol, const Int &nlev, const view_2d<const Spack> &thlm,
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        update_host_dse(team, nlev, ekat::subview(thlm, i),
                        ekat::subview(shoc_ql, i), ekat::subview(inv_exner, i),
                        ekat::subview(zt_grid, i), phis(i),
