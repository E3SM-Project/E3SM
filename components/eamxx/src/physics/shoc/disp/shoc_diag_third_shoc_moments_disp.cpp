  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        diag_third_shoc_moments(
            team, nlev, nlevi, c_diag_3rd_mom, ekat::subview(w_sec, i),
            ekat::subview(thl_sec, i), ekat::subview(wthl_sec, i),
            ekat::subview(isotropy, i), ekat::subview(brunt, i),
            ekat::subview(thetal, i), ekat::subview(tke, i),
            ekat::subview(dz_zt, i), ekat::subview(dz_zi, i),
