...
void Functions<Real, DefaultDevice>::shoc_tke_disp(
    ...
    const Scalar &Ckm, const view_2d<const Spack> &wthv_sec,
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        shoc_tke(team, nlev, nlevi, dtime, lambda_low, lambda_high,
                 lambda_slope, lambda_thresh, Ckh, Ckm,
                 ekat::subview(wthv_sec, i), ekat::subview(shoc_mix, i),
                 ekat::subview(dz_zi, i), ekat::subview(dz_zt, i),
                 ekat::subview(pres, i), ekat::subview(tabs, i),
                 ekat::subview(u_wind, i), ekat::subview(v_wind, i),
                 ekat::subview(brunt, i), ekat::subview(zt_grid, i),
                 ekat::subview(zi_grid, i), pblh(i), workspace,
                 ekat::subview(tke, i), ekat::subview(tk, i),
