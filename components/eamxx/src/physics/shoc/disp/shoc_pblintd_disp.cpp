...
void Functions<Real, DefaultDevice>::pblintd_disp(
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        Scalar pblh_;
        pblintd(team, nlev, nlevi, npbl, ekat::subview(z, i),
                ekat::subview(zi, i), ekat::subview(thl, i),
                ekat::subview(ql, i), ekat::subview(q, i), ekat::subview(u, i),
                ekat::subview(v, i), ustar(i), obklen(i), kbfs(i),
