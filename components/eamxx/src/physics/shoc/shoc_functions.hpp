...
template <typename ScalarT, typename DeviceT> struct Functions {
  ...
  template <typename S>
  using uview_2d_strided =
      typename ekat::template Unmanaged<view_2d_strided<S>>;
  ...
  //
  KOKKOS_FUNCTION
  static void calc_shoc_varorcovar(const MemberType &team, const Int &nlev,
  ...
  KOKKOS_FUNCTION
  static void shoc_diag_second_moments_srf(const Scalar &wthl_sfc,
                                           const Scalar &uw_sfc,
...
#ifdef SCREAM_SHOC_SMALL_KERNELS
  static void update_host_dse_disp(const Int &shcol, const Int &nlev,
  ...
  KOKKOS_FUNCTION
  static void check_tke(const MemberType &team, const Int &nlev,
                        const uview_1d<Spack> &tke);
#ifdef SCREAM_SHOC_SMALL_KERNELS
  static void check_tke_disp(const Int &schol, const Int &nlev,
                             const view_2d<Spack> &tke);
#endif

  KOKKOS_FUNCTION
  static void
  clipping_diag_third_shoc_moments(const MemberType &team, const Int &nlevi,
                                   const uview_1d<const Spack> &w_sec_zi,
                                   const uview_1d<Spack> &w3);

  KOKKOS_FUNCTION
  static void linear_interp(const MemberType &team,
                            const uview_1d<const Spack> &x1,
                            const uview_1d<const Spack> &x2,
                            const uview_1d<const Spack> &y1,
                            const uview_1d<Spack> &y2, const Int &km1,
                            const Int &km2, const Scalar &minthresh);
  ...
  static void diag_second_shoc_moments(
      ...
      const Scalar &w2tune, const uview_1d<const Spack> &thetal,
      const uview_1d<const Spack> &qw, const uview_1d<const Spack> &u_wind,
      const uview_1d<const Spack> &v_wind, const uview_1d<const Spack> &tke,
      const uview_1d<const Spack> &isotropy, const uview_1d<const Spack> &tkh,
      const uview_1d<const Spack> &tk, const uview_1d<const Spack> &dz_zi,
      const uview_1d<const Spack> &zt_grid,
      const uview_1d<const Spack> &zi_grid,
      const uview_1d<const Spack> &shoc_mix, const Scalar &wthl_sfc,
      const Scalar &wqw_sfc, const Scalar &uw_sfc, const Scalar &vw_sfc,
      Scalar &ustar2, Scalar &wstar, const Workspace &workspace,
      const uview_1d<Spack> &thl_sec, const uview_1d<Spack> &qw_sec,
      const uview_1d<Spack> &wthl_sec, const uview_1d<Spack> &wqw_sec,
      const uview_1d<Spack> &qwthl_sec, const uview_1d<Spack> &uw_sec,
      const uview_1d<Spack> &vw_sec, const uview_1d<Spack> &wtke_sec,
  ...
  static void diag_second_shoc_moments_disp(
      ...
      const Scalar &thl2tune, const Scalar &qw2tune, const Scalar &qwthl2tune,
      const Scalar &w2tune, const view_2d<const Spack> &thetal,
      ...
      const view_1d<Scalar> &wstar, const WorkspaceMgr &workspace_mgr,
      const view_2d<Spack> &thl_sec, const view_2d<Spack> &qw_sec,
      const view_2d<Spack> &wthl_sec, const view_2d<Spack> &wqw_sec,
      const view_2d<Spack> &qwthl_sec, const view_2d<Spack> &uw_sec,
      const view_2d<Spack> &vw_sec, const view_2d<Spack> &wtke_sec,
      const view_2d<Spack> &w_sec);
#endif

  KOKKOS_FUNCTION
  static void compute_brunt_shoc_length(const MemberType &team, const Int &nlev,
                                        const Int &nlevi,
  ...
  KOKKOS_FUNCTION
  static void check_length_scale_shoc_length(const MemberType &team,
                                             const Int &nlev, const Scalar &dx,
                                             const Scalar &dy,
                                             const uview_1d<Spack> &shoc_mix);

  KOKKOS_FUNCTION
  static void shoc_diag_obklen(const Scalar &uw_sfc, const Scalar &vw_sfc,
                               const Scalar &wthl_sfc, const Scalar &wqw_sfc,
                               const Scalar &thl_sfc, const Scalar &cldliq_sfc,
                               const Scalar &qv_sfc, Scalar &ustar,
                               Scalar &kbfs, Scalar &obklen);
#ifdef SCREAM_SHOC_SMALL_KERNELS
  static void shoc_diag_obklen_disp(const Int &shcol, const Int &nlev,
  ...
  KOKKOS_FUNCTION
  static void shoc_pblintd_cldcheck(const Scalar &zi, const Scalar &cldn,
                                    Scalar &pblh);

  KOKKOS_FUNCTION
  static void
  shoc_length(const MemberType &team, const Int &nlev, const Int &nlevi,
  ...
  static void shoc_length_disp(
      ...
      const view_2d<const Spack> &zi_grid, const view_2d<const Spack> &dz_zt,
      const view_2d<const Spack> &tke, const view_2d<const Spack> &thv,
  ...
  static void update_prognostics_implicit(
      const MemberType &team, const Int &nlev, const Int &nlevi,
      const Int &num_tracer, const Scalar &dtime,
      const uview_1d<const Spack> &dz_zt, const uview_1d<const Spack> &dz_zi,
  ...
  static void update_prognostics_implicit_disp(
      ...
      const WorkspaceMgr &workspace_mgr, const view_2d<Spack> &thetal,
      const view_2d<Spack> &qw, const view_3d_strided<Spack> &tracer,
      const view_2d<Spack> &tke, const view_2d<Spack> &u_wind,
  ...
  KOKKOS_FUNCTION
  static void adv_sgs_tke(const MemberType &team, const Int &nlev,
                          const Real &dtime,
  ...
  static void shoc_assumed_pdf_compute_buoyancy_flux(const Spack &wthlsec,
                                                     const Spack &wqwsec,
                                                     const Spack &pval,
                                                     const Spack &wqls,
                                                     Spack &wthv_sec);
  ...
  static void shoc_assumed_pdf_compute_cloud_liquid_variance(
      const Spack &a, const Spack &s1, const Spack &ql1, const Spack &C1,
      const Spack &std_s1, const Spack &s2, const Spack &ql2, const Spack &C2,
      const Spack &std_s2, const Spack &shoc_ql, Spack &shoc_ql2);

  KOKKOS_INLINE_FUNCTION
  static void shoc_assumed_pdf_compute_liquid_water_flux(
      const Spack &a, const Spack &w1_1, const Spack &w_first, const Spack &ql1,
      const Spack &w1_2, const Spack &ql2, Spack &wqls);

  KOKKOS_INLINE_FUNCTION
  static void shoc_assumed_pdf_compute_qs(const Spack &Tl1_1,
                                          const Spack &Tl1_2, const Spack &pval,
                                          const Smask &active_entries,
                                          Spack &qs1, Spack &beta1, Spack &qs2,
                                          Spack &beta2);

  KOKKOS_INLINE_FUNCTION
  static void shoc_assumed_pdf_compute_s(const Spack &qw1, const Spack &qs,
                                         const Spack &beta, const Spack &pval,
                                         const Spack &thl2, const Spack &qw2,
                                         const Spack &sqrtthl2,
                                         const Spack &sqrtqw2,
                                         const Spack &r_qwthl, Spack &s,
                                         Spack &std_s, Spack &qn, Spack &C);

  KOKKOS_INLINE_FUNCTION
  static void shoc_assumed_pdf_compute_sgs_liquid(const Spack &a,
                                                  const Spack &ql1,
                                                  const Spack &ql2,
                                                  Spack &shoc_ql);

  KOKKOS_INLINE_FUNCTION
  static void shoc_assumed_pdf_compute_temperature(const Spack &thl1,
                                                   const Spack &pval,
                                                   Spack &Tl1);

  KOKKOS_INLINE_FUNCTION
  static void shoc_assumed_pdf_inplume_correlations(
      const Spack &sqrtqw2_1, const Spack &sqrtthl2_1, const Spack &a,
      const Spack &sqrtqw2_2, const Spack &sqrtthl2_2, const Spack &qwthlsec,
      const Spack &qw1_1, const Spack &qw_first, const Spack &thl1_1,
      const Spack &thl_first, const Spack &qw1_2, const Spack &thl1_2,
      Spack &r_qwthl_1);
  ...
  static void shoc_assumed_pdf_thl_parameters(
      const Spack &wthlsec, const Spack &sqrtw2, const Spack &sqrtthl,
  ...
  KOKKOS_INLINE_FUNCTION
  static void shoc_assumed_pdf_tilde_to_real(const Spack &w_first,
                                             const Spack &sqrtw2, Spack &w1);

  KOKKOS_INLINE_FUNCTION
  static void
  shoc_assumed_pdf_vv_parameters(const Spack &w_first, const Spack &w_sec,
                                 const Spack &w3var, const Scalar w_tol_sqd,
                                 Spack &Skew_w, Spack &w1_1, Spack &w1_2,
                                 Spack &w2_1, Spack &w2_2, Spack &a);

  KOKKOS_FUNCTION
  static void compute_shr_prod(const MemberType &team, const Int &nlevi,
                               const Int &nlev,
                               const uview_1d<const Spack> &dz_zi,
  ...
  KOKKOS_FUNCTION
  static void compute_tmpi(const MemberType &team, const Int &nlevi,
                           const Scalar &dtime,
  ...
  KOKKOS_FUNCTION
  static void isotropic_ts(const MemberType &team, const Int &nlev,
  ...
  static void shoc_main_internal(
      ...
      // Input Variables
      const Scalar &host_dx, const Scalar &host_dy,
      const uview_1d<const Spack> &zt_grid,
  ...
  static void shoc_main_internal(
      ...
      const view_1d<const Scalar> &host_dy, const view_2d<const Spack> &zt_grid,
      const view_2d<const Spack> &zi_grid, const view_2d<const Spack> &pres,
      const view_2d<const Spack> &presi, const view_2d<const Spack> &pdel,
      const view_2d<const Spack> &thv, const view_2d<const Spack> &w_field,
      const view_1d<const Scalar> &wthl_sfc,
      const view_1d<const Scalar> &wqw_sfc, const view_1d<const Scalar> &uw_sfc,
      const view_1d<const Scalar> &vw_sfc,
      const view_2d<const Spack> &wtracer_sfc,
      ...
      const view_2d<Spack> &shoc_qv, const view_2d<Spack> &tabs,
  ...
  KOKKOS_FUNCTION
  static void
  pblintd_height(const MemberType &team, const Int &nlev, const Int &npbl,
  ...
  static void vd_shoc_decomp(const MemberType &team, const Int &nlev,
                             ...
                             const Scalar &dtime, const Scalar &flux,
  ...
  KOKKOS_FUNCTION
  static void pblintd_surf_temp(const Int &nlev, const Int &nlevi,
                                const Int &npbl, const uview_1d<const Spack> &z,
                                const Scalar &ustar, const Scalar &obklen,
                                const Scalar &kbfs,
                                const uview_1d<const Spack> &thv, Scalar &tlv,
                                Scalar &pblh, bool &check,
  ...
  KOKKOS_FUNCTION
  static void
  pblintd(const MemberType &team, const Int &nlev, const Int &nlevi,
          const Int &npbl, const uview_1d<const Spack> &z,
          const uview_1d<const Spack> &zi, const uview_1d<const Spack> &thl,
          const uview_1d<const Spack> &ql, const uview_1d<const Spack> &q,
          const uview_1d<const Spack> &u, const uview_1d<const Spack> &v,
          const Scalar &ustar, const Scalar &obklen, const Scalar &kbfs,
          const uview_1d<const Spack> &cldn, const Workspace &workspace,
          Scalar &pblh);
#ifdef SCREAM_SHOC_SMALL_KERNELS
  ...
  KOKKOS_FUNCTION
  static void shoc_grid(const MemberType &team, const Int &nlev,
                        const Int &nlevi, const uview_1d<const Spack> &zt_grid,
                        const uview_1d<const Spack> &zi_grid,
...
#ifdef SCREAM_SHOC_SMALL_KERNELS
  static void
  shoc_grid_disp(const Int &shcol, const Int &nlev, const Int &nlevi,
                 const view_2d<const Spack> &zt_grid,
  ...
  static void eddy_diffusivities(
      ...
      const Scalar &Ckm, const Scalar &pblh,
  ...
  static void shoc_tke(
      ...
      const Scalar &lambda_slope, const Scalar &lambda_thresh,
      const Scalar &Ckh, const Scalar &Ckm,
      const uview_1d<const Spack> &wthv_sec,
      ...
      const uview_1d<const Spack> &zt_grid,
      const uview_1d<const Spack> &zi_grid, const Scalar &pblh,
      const Workspace &workspace, const uview_1d<Spack> &tke,
  ...
  static void shoc_tke_disp(
      ...
      const view_2d<const Spack> &zt_grid, const view_2d<const Spack> &zi_grid,
      const view_1d<const Scalar> &pblh, const WorkspaceMgr &workspace_mgr,
      const view_2d<Spack> &tke, const view_2d<Spack> &tk,
