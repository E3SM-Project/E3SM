...
template <typename ScalarT, typename DeviceT> struct Functions {
  ...
  static void compute_diag_third_shoc_moment(
      ...
      const bool &shoc_1p5tke, const uview_1d<const Spack> &w_sec,
      ...
      const uview_1d<const Spack> &dz_zi, const uview_1d<const Spack> &isotropy_zi,
      const uview_1d<const Spack> &brunt_zi, const uview_1d<const Spack> &w_sec_zi,
...
#ifdef SCREAM_SHOC_SMALL_KERNELS
  static void check_tke_disp(const Int &schol, const Int &nlev, const view_2d<Spack> &tke);
#endif
  ...
  static void diag_second_shoc_moments(
      ...
      const bool &shoc_1p5tke, const uview_1d<const Spack> &thetal, const uview_1d<const Spack> &qw,
      const uview_1d<const Spack> &u_wind, const uview_1d<const Spack> &v_wind,
      const uview_1d<const Spack> &tke, const uview_1d<const Spack> &isotropy,
      const uview_1d<const Spack> &tkh, const uview_1d<const Spack> &tk,
      const uview_1d<const Spack> &dz_zi, const uview_1d<const Spack> &zt_grid,
  ...
  static void diag_second_shoc_moments_disp(
      ...
      const Scalar &qw2tune, const Scalar &qwthl2tune, const Scalar &w2tune,
      const bool &shoc_1p5tke, const view_2d<const Spack> &thetal, const view_2d<const Spack> &qw,
  ...
  static void diag_third_shoc_moments_disp(
      ...
      const bool &shoc_1p5tke, const view_2d<const Spack> &w_sec,
  ...
  static void adv_sgs_tke(const MemberType &team, const Int &nlev, const Real &dtime,
                          const bool &shoc_1p5tke, const uview_1d<const Spack> &shoc_mix,
                          const uview_1d<const Spack> &wthv_sec,
                          const uview_1d<const Spack> &sterm_zt, const uview_1d<const Spack> &tk,
                          const uview_1d<const Spack> &brunt, const uview_1d<Spack> &tke,
  ...
  shoc_assumed_pdf(const MemberType &team, const Int &nlev, const Int &nlevi,
                   ...
                   const uview_1d<Spack> &shoc_cond, const uview_1d<Spack> &shoc_evap,
  ...
  static void shoc_assumed_pdf_disp(
      ...
      const view_2d<const Spack> &thl_sec, const view_2d<const Spack> &qw_sec, const Scalar &dtime,
      const bool &extra_diags, const view_2d<const Spack> &wthl_sec,
      ...
      const view_2d<Spack> &shoc_cond, const view_2d<Spack> &shoc_evap,
      const view_2d<Spack> &shoc_cldfrac, const view_2d<Spack> &shoc_ql, const view_2d<Spack> &wqls,
      const view_2d<Spack> &wthv_sec, const view_2d<Spack> &shoc_ql2);
#endif
  ...
  static void compute_tmpi(const MemberType &team, const Int &nlevi, const Scalar &dtime,
                           const uview_1d<const Spack> &rho_zi, const uview_1d<const Spack> &dz_zi,
  ...
  static void shoc_main_internal(
      ...
      // Diagnostic Output Variables
      const view_2d<Spack> &shoc_evap, const view_2d<Spack> &shoc_cond,
      ...
      const view_2d<Spack> &shoc_qv, const view_2d<Spack> &tabs, const view_2d<Spack> &dz_zt,
  ...
  static void shoc_tke_disp(const Int &shcol, const Int &nlev, const Int &nlevi,
                            ...
                            const bool &shoc_1p5tke, const view_2d<const Spack> &wthv_sec,
