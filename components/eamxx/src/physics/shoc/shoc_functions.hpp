...
template <typename ScalarT, typename DeviceT> struct Functions {
  ...
  shoc_assumed_pdf(const MemberType &team, const Int &nlev, const Int &nlevi,
                   ...
                   const bool &extra_diags, const bool &shoc_enable_condensation, const uview_1d<const Pack> &wthl_sec,
  ...
  static void shoc_assumed_pdf_disp(
      ...
      const bool &extra_diags, const bool &shoc_enable_condensation, const view_2d<const Pack> &wthl_sec,
  ...
  static void shoc_main_internal(
      ...
      const Scalar &c_diag_3rd_mom, const Scalar &Ckh, const Scalar &Ckm, const bool &shoc_1p5tke, const bool &shoc_enable_condensation,
