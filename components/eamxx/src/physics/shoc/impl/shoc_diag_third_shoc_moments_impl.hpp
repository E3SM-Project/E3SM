...
KOKKOS_FUNCTION void Functions<S, D>::diag_third_shoc_moments(
  ...
  linear_interp(team, zt_grid, zi_grid, w_sec, w_sec_zi, nlev, nlevi,
                sp(2.0 / 3.0) * mintke);
  ...
  compute_diag_third_shoc_moment(
      team, nlev, nlevi, c_diag_3rd_mom, w_sec, thl_sec, wthl_sec, tke, dz_zt,
      dz_zi, isotropy_zi, brunt_zi, w_sec_zi, thetal_zi, w3);
  team.team_barrier();
