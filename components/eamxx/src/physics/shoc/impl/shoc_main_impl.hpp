  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        Kokkos::parallel_reduce(
            Kokkos::TeamVectorRange(team, begin_pack_indx, end_pack_indx),
...
template <typename S, typename D>
KOKKOS_FUNCTION void Functions<S, D>::shoc_main_internal(
    ...
    // Runtime Parameters
    const Scalar &lambda_low, const Scalar &lambda_high,
    const Scalar &lambda_slope, const Scalar &lambda_thresh,
    const Scalar &thl2tune, const Scalar &qw2tune, const Scalar &qwthl2tune,
    const Scalar &w2tune, const Scalar &length_fac,
    ...
    const Scalar &vw_sfc, const uview_1d<const Spack> &wtracer_sfc,
    const uview_1d<const Spack> &inv_exner, const Scalar &phis,
    // Workspace/Local Variables
    const Workspace &workspace,
    // Input/Output Variables
    const uview_1d<Spack> &host_dse, const uview_1d<Spack> &tke,
    ...
    // Output Variables
    Scalar &pblh, Scalar &ustar, Scalar &obklen,
    const uview_1d<Spack> &shoc_ql2, const uview_1d<Spack> &tkh,
    // Diagnostic Output Variables
    const uview_1d<Spack> &shoc_mix, const uview_1d<Spack> &w_sec,
    const uview_1d<Spack> &thl_sec, const uview_1d<Spack> &qw_sec,
    const uview_1d<Spack> &qwthl_sec, const uview_1d<Spack> &wthl_sec,
    const uview_1d<Spack> &wqw_sec, const uview_1d<Spack> &wtke_sec,
    const uview_1d<Spack> &uw_sec, const uview_1d<Spack> &vw_sec,
    const uview_1d<Spack> &w3, const uview_1d<Spack> &wqls_sec,
  ...
  // Local scalars
  Scalar se_b{0}, ke_b{0}, wv_b{0}, wl_b{0}, se_a{0}, ke_a{0}, wv_a{0}, wl_a{0},
  ...
  // Compute integrals of static energy, kinetic energy, water vapor, and liquid
  // water for the computation of total energy before SHOC is called.  This is
  // for an effort to conserve energy since liquid water potential temperature
  // (which SHOC conserves) and static energy (which E3SM conserves) are not
  // exactly equal.
  shoc_energy_integrals(team, nlev, host_dse, pdel, qw, shoc_ql, u_wind,
                        v_wind,                  // Input
  ...
  for (Int t = 0; t < nadv; ++t) {
    ...
    update_prognostics_implicit(
        team, nlev, nlevi, num_qtracers, dtime, dz_zt,    // Input
    ...
    diag_second_shoc_moments(
        team, nlev, nlevi, thl2tune, qw2tune, qwthl2tune,
    ...
    team.team_barrier();
    shoc_assumed_pdf(
        team, nlev, nlevi, thetal, qw, w_field, thl_sec, qw_sec, // Input
...
void Functions<S, D>::shoc_main_internal(
    ...
    // Input/Output Variables
    const view_2d<Spack> &host_dse, const view_2d<Spack> &tke,
    const view_2d<Spack> &thetal, const view_2d<Spack> &qw,
    const uview_2d<Spack> &u_wind, const uview_2d<Spack> &v_wind,
    const view_2d<Spack> &wthv_sec, const view_3d_strided<Spack> &qtracers,
    const view_2d<Spack> &tk, const view_2d<Spack> &shoc_cldfrac,
    const view_2d<Spack> &shoc_ql,
    // Output Variables
    const view_1d<Scalar> &pblh, const view_1d<Scalar> &ustar,
    const view_1d<Scalar> &obklen, const view_2d<Spack> &shoc_ql2,
    const view_2d<Spack> &tkh,
    // Diagnostic Output Variables
    const view_2d<Spack> &shoc_mix, const view_2d<Spack> &w_sec,
    const view_2d<Spack> &thl_sec, const view_2d<Spack> &qw_sec,
    const view_2d<Spack> &qwthl_sec, const view_2d<Spack> &wthl_sec,
    const view_2d<Spack> &wqw_sec, const view_2d<Spack> &wtke_sec,
    const view_2d<Spack> &uw_sec, const view_2d<Spack> &vw_sec,
    const view_2d<Spack> &w3, const view_2d<Spack> &wqls_sec,
    const view_2d<Spack> &brunt, const view_2d<Spack> &isotropy,
    // Temporaries
    const view_1d<Scalar> &se_b, const view_1d<Scalar> &ke_b,
    const view_1d<Scalar> &wv_b, const view_1d<Scalar> &wl_b,
    const view_1d<Scalar> &se_a, const view_1d<Scalar> &ke_a,
    const view_1d<Scalar> &wv_a, const view_1d<Scalar> &wl_a,
    const view_1d<Scalar> &kbfs, const view_1d<Scalar> &ustar2,
    const view_1d<Scalar> &wstar, const view_2d<Spack> &rho_zt,
    const view_2d<Spack> &shoc_qv, const view_2d<Spack> &shoc_tabs,
  ...
  // (which SHOC conserves) and static energy (which E3SM conserves) are not
  // exactly equal.
  shoc_energy_integrals_disp(shcol, nlev, host_dse, pdel, qw, shoc_ql, u_wind,
                             v_wind, se_b, ke_b, wv_b, wl_b); // Input
  ...
  for (Int t = 0; t < nadv; ++t) {
    ...
    update_prognostics_implicit_disp(
        shcol, nlev, nlevi, num_qtracers, dtime, dz_zt,   // Input
        dz_zi, rho_zt, zt_grid, zi_grid, tk, tkh, uw_sfc, // Input
        vw_sfc, wthl_sfc, wqw_sfc, wtracer_sfc,           // Input
        workspace_mgr,                                    // Workspace mgr
        thetal, qw, qtracers, tke, u_wind, v_wind);       // Input/Output
    ...
    diag_second_shoc_moments_disp(
        shcol, nlev, nlevi, thl2tune, qw2tune, qwthl2tune,
        w2tune,                                          // Runtime options
        thetal, qw, u_wind, v_wind,                      // Input
        tke, isotropy, tkh, tk, dz_zi, zt_grid, zi_grid, // Input
        shoc_mix, wthl_sfc, wqw_sfc, uw_sfc, vw_sfc,     // Input
    ...
    diag_third_shoc_moments_disp(shcol, nlev, nlevi,
                                 c_diag_3rd_mom,           // Runtime options
                                 w_sec, thl_sec, wthl_sec, // Input
                                 isotropy, brunt, thetal, tke, dz_zt,
                                 dz_zi,            // Input
                                 zt_grid, zi_grid, // Input
                                 workspace_mgr,    // Workspace mgr
                                 w3);              // Output
    ...
    shoc_assumed_pdf_disp(
        shcol, nlev, nlevi, thetal, qw, w_field, thl_sec, qw_sec, // Input
        wthl_sec, w_sec, wqw_sec, qwthl_sec, w3, pres,            // Input
        zt_grid, zi_grid,                                         // Input
        workspace_mgr,                                        // Workspace mgr
        shoc_cldfrac, shoc_ql, wqls_sec, wthv_sec, shoc_ql2); // Ouptut
  ...
  shoc_energy_fixer_disp(
      shcol, nlev, nlevi, dtime, nadv, zt_grid, zi_grid, // Input
      se_b, ke_b, wv_b, wl_b, se_a, ke_a, wv_a, wl_a,    // Input
      wthl_sfc, wqw_sfc, rho_zt, tke, presi,             // Input
      workspace_mgr,                                     // Workspace
      host_dse);                                         // Output
...
Int Functions<S, D>::shoc_main(
  ...
  Kokkos::parallel_for(
      policy, KOKKOS_LAMBDA(const MemberType &team) {
        ...
        const auto shoc_cldfrac_s =
            ekat::subview(shoc_input_output.shoc_cldfrac, i);
        ...
        const auto qwthl_sec_s =
            ekat::subview(shoc_history_output.qwthl_sec, i);
        ...
        const auto u_wind_s =
            Kokkos::subview(shoc_input_output.horiz_wind, i, 0, Kokkos::ALL());
        const auto v_wind_s =
            Kokkos::subview(shoc_input_output.horiz_wind, i, 1, Kokkos::ALL());
        const auto qtracers_s = Kokkos::subview(shoc_input_output.qtracers, i,
                                                Kokkos::ALL(), Kokkos::ALL());

        shoc_main_internal(
            team, nlev, nlevi, npbl, nadv, num_qtracers, dtime, lambda_low,
            lambda_high, lambda_slope,
            ...
            workspace,                                 // Workspace
            host_dse_s, tke_s, thetal_s, qw_s, u_wind_s,
            v_wind_s,                                     // Input/Output
            ...
            shoc_mix_s, w_sec_s, thl_sec_s, qw_sec_s,
            qwthl_sec_s, // Diagnostic Output Variables
            wthl_sec_s, wqw_sec_s, wtke_sec_s, uw_sec_s,
            vw_sec_s, // Diagnostic Output Variables
            w3_s, wqls_sec_s, brunt_s,
            isotropy_s); // Diagnostic Output Variables
  ...
  Kokkos::fence();
#else
  const auto u_wind_s = Kokkos::subview(shoc_input_output.horiz_wind,
                                        Kokkos::ALL(), 0, Kokkos::ALL());
  const auto v_wind_s = Kokkos::subview(shoc_input_output.horiz_wind,
                                        Kokkos::ALL(), 1, Kokkos::ALL());

  shoc_main_internal(
      shcol, nlev, nlevi, npbl, nadv, num_qtracers, dtime, lambda_low,
      lambda_high, lambda_slope,
      lambda_thresh,                                     // Runtime options
      thl2tune, qw2tune, qwthl2tune, w2tune, length_fac, // Runtime options
      c_diag_3rd_mom, Ckh, Ckm,                          // Runtime options
      shoc_input.dx, shoc_input.dy, shoc_input.zt_grid,
      shoc_input.zi_grid, // Input
      shoc_input.pres, shoc_input.presi, shoc_input.pdel, shoc_input.thv,
      shoc_input.w_field, // Input
      shoc_input.wthl_sfc, shoc_input.wqw_sfc, shoc_input.uw_sfc,
      shoc_input.vw_sfc,                                             // Input
      shoc_input.wtracer_sfc, shoc_input.inv_exner, shoc_input.phis, // Input
      workspace_mgr, // Workspace Manager
      shoc_input_output.host_dse, shoc_input_output.tke,
      shoc_input_output.thetal, shoc_input_output.qw, u_wind_s,
      v_wind_s, // Input/Output
      shoc_input_output.wthv_sec, shoc_input_output.qtracers,
      shoc_input_output.tk,
      shoc_input_output.shoc_cldfrac, // Input/Output
      shoc_input_output.shoc_ql,      // Input/Output
      shoc_output.pblh, shoc_output.ustar, shoc_output.obklen,
      shoc_output.shoc_ql2,
      shoc_output.tkh, // Output
      shoc_history_output.shoc_mix, shoc_history_output.w_sec,
      shoc_history_output.thl_sec, shoc_history_output.qw_sec,
      shoc_history_output.qwthl_sec, // Diagnostic Output Variables
      shoc_history_output.wthl_sec, shoc_history_output.wqw_sec,
      shoc_history_output.wtke_sec, shoc_history_output.uw_sec,
      shoc_history_output.vw_sec, // Diagnostic Output Variables
      shoc_history_output.w3, shoc_history_output.wqls_sec,
      shoc_history_output.brunt,
      shoc_history_output.isotropy, // Diagnostic Output Variables
      // Temporaries
      shoc_temporaries.se_b, shoc_temporaries.ke_b, shoc_temporaries.wv_b,
      shoc_temporaries.wl_b, shoc_temporaries.se_a, shoc_temporaries.ke_a,
      shoc_temporaries.wv_a, shoc_temporaries.wl_a, shoc_temporaries.kbfs,
      shoc_temporaries.ustar2, shoc_temporaries.wstar, shoc_temporaries.rho_zt,
      shoc_temporaries.shoc_qv, shoc_temporaries.tabs, shoc_temporaries.dz_zt,
