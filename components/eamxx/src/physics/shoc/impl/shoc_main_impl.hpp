...
KOKKOS_FUNCTION void Functions<S, D>::shoc_main_internal(
  ...
  workspace.template take_many_and_reset<5>({"rho_zt", "shoc_qv", "shoc_tabs", "dz_zt", "dz_zi"},
  ...
  workspace.template release_many_contiguous<5>({&rho_zt, &shoc_qv, &shoc_tabs, &dz_zt, &dz_zi});
}
#else
template <typename S, typename D>
