...
void Functions<S,D>::diag_second_shoc_moments(const MemberType& team, const Int& nlev, const Int& nlevi,
       ...
       const Workspace& workspace, const uview_1d<Pack>& thl_sec,
       const uview_1d<Pack>& qw_sec, const uview_1d<Pack>& wthl_sec, const uview_1d<Pack>& wqw_sec, const uview_1d<Pack>& qwthl_sec,
       const uview_1d<Pack>& uw_sec, const uview_1d<Pack>& vw_sec, const uview_1d<Pack>& wtke_sec, const uview_1d<Pack>& w_sec)
{
  // This is the main routine to compute the second
  // order moments in SHOC.

  // Define temporary variables
  uview_1d<Pack> isotropy_zi, tkh_zi, tk_zi;
