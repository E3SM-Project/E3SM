#ifndef EAMXX_RAIN_WATER_PATH_DIAGNOSTIC_HPP
...
class RainWaterPathDiagnostic : public AtmosphereDiagnostic
{
public:
  ...
  // Constructors
  RainWaterPathDiagnostic (const ekat::Comm& comm, const ekat::ParameterList& params);
...
#endif // EAMXX_RAIN_WATER_PATH_DIAGNOSTIC_HPP
