...
// =========================================================================================
LongwaveCloudForcingDiagnostic::LongwaveCloudForcingDiagnostic(
...
void LongwaveCloudForcingDiagnostic::set_grids(
  ...
  add_field<Required>("LW_clrsky_flux_up", scalar3d_layout_mid, W / m2,
                      grid_name);
...
void LongwaveCloudForcingDiagnostic::compute_diagnostic_impl() {
  ...
  const auto &LW_clrsky_flux_up =
      get_field_in("LW_clrsky_flux_up").get_view<const Real **>();

  Kokkos::parallel_for(
      "LongwaveCloudForcingDiagnostic", default_policy,
