...
// =========================================================================================
LongwaveCloudForcingDiagnostic::LongwaveCloudForcingDiagnostic(const ekat::Comm &comm,
...
void LongwaveCloudForcingDiagnostic::compute_diagnostic_impl() {
  ...
  Kokkos::parallel_for(
      "LongwaveCloudForcingDiagnostic", default_policy, KOKKOS_LAMBDA(const MemberType &team) {
