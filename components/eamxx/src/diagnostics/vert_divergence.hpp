...
class VertDivergenceDiag : public AtmosphereDiagnostic {
 public:
  // Constructors
  VertDivergenceDiag(const ekat::Comm &comm, const ekat::ParameterList &params);

  // The name of the diagnostic CLASS (not the computed field)
  std::string name() const { return "VertDivergenceDiag"; }
 ...
 public:
  ...
  // Name of divergence method (dp, dz, none)
  std::string m_divergence_method;
