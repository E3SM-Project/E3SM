...
MACHINE_METADATA = {
    ...
    "mappy"   : (["module purge", "module load sems-archive-env acme-env sems-archive-gcc/9.2.0 sems-archive-git/2.10.1 acme-openmpi/4.0.7 acme-netcdf/4.7.4/acme", "export PATH=/ascldap/users/jgfouca/packages/cmake-3.26.3/bin:${PATH}"],
                 ["mpicxx","mpifort","mpicc"],
                  "",
