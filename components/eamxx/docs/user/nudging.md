...
Alternatively, the data can contain a time-invariant pressure variable `p_levs` corresponding to the option `STATIC_1D_VERTICAL_PROFILE` for `source_pressure_type`.
