/**
 * @file atm_io.cpp
 * @brief Implementation of atmosphere I/O functions.
 *
 * Handles reading initial conditions from NetCDF files and
 * distributing data to local MPI partitions.
 *
 * @see atm_io.hpp for function documentation
 */
