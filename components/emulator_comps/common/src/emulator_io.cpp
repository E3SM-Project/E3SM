 ...
 * @brief Implementation of the EmulatorIO class for parallel I/O.
 *
 * Wraps the SCORPIO (PIO) library to provide parallel NetCDF I/O
 * for emulator components.
 *
 * @see emulator_io.hpp for class documentation
 */
