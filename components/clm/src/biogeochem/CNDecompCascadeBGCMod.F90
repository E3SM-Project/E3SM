...
contains
  ...
  subroutine init_decompcascade_bgc(bounds, cnstate_vars, soilstate_vars)
    ...
    associate(                                                                                 &
         ...
         floating_cn_ratio_decomp_pools => decomp_cascade_con%floating_cn_ratio_decomp_pools , & ! Output: [logical           (:)     ]  TRUE => pool has floating C:N ratio                          
         floating_cp_ratio_decomp_pools => decomp_cascade_con%floating_cp_ratio_decomp_pools , & ! Output: [logical           (:)     ]  TRUE => pool has floating C:P ratio                          
