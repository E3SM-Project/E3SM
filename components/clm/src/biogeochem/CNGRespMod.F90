...
contains
  ...
  subroutine CNGResp(num_soilp, filter_soilp, carbonflux_vars)
    ...
    associate(                                                                                     & 
         ...
         cpool_to_leafc                =>    carbonflux_vars%pool_to_leaf_patch                , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_leafc_storage        =>    carbonflux_vars%pool_to_leaf_storage_patch        , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_frootc               =>    carbonflux_vars%pool_to_froot_patch               , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_frootc_storage       =>    carbonflux_vars%pool_to_froot_storage_patch       , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_livestemc            =>    carbonflux_vars%pool_to_livestem_patch            , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_livestemc_storage    =>    carbonflux_vars%pool_to_livestem_storage_patch    , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_deadstemc            =>    carbonflux_vars%pool_to_deadstem_patch            , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_deadstemc_storage    =>    carbonflux_vars%pool_to_deadstem_storage_patch    , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_livecrootc           =>    carbonflux_vars%pool_to_livecroot_patch           , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_livecrootc_storage   =>    carbonflux_vars%pool_to_livecroot_storage_patch   , & ! Input:  [real(r8) (:)]                                                    
         cpool_to_deadcrootc           =>    carbonflux_vars%pool_to_deadcroot_patch           , & ! Input:  [real(r8) (:)]  allocation to dead coarse root C (gC/m2/s)        
         cpool_to_deadcrootc_storage   =>    carbonflux_vars%pool_to_deadcroot_storage_patch   , & ! Input:  [real(r8) (:)]  allocation to dead coarse root C storage (gC/m2/s)
         cpool_to_grainc               =>    carbonflux_vars%pool_to_grain_patch               , & ! Input:  [real(r8) (:)]  allocation to grain C (gC/m2/s)                   
         cpool_to_grainc_storage       =>    carbonflux_vars%pool_to_grain_storage_patch       , & ! Input:  [real(r8) (:)]  allocation to grain C storage (gC/m2/s)           
         grainc_xfer_to_grainc         =>    carbonflux_vars%grain_xfer_to_grain_patch         , & ! Input:  [real(r8) (:)]  grain C growth from storage (gC/m2/s)             
         leafc_xfer_to_leafc           =>    carbonflux_vars%leaf_xfer_to_leaf_patch           , & ! Input:  [real(r8) (:)]  leaf C growth from storage (gC/m2/s)              
         frootc_xfer_to_frootc         =>    carbonflux_vars%froot_xfer_to_froot_patch         , & ! Input:  [real(r8) (:)]  fine root C growth from storage (gC/m2/s)         
         livestemc_xfer_to_livestemc   =>    carbonflux_vars%livestem_xfer_to_livestem_patch   , & ! Input:  [real(r8) (:)]  live stem C growth from storage (gC/m2/s)         
         deadstemc_xfer_to_deadstemc   =>    carbonflux_vars%deadstem_xfer_to_deadstem_patch   , & ! Input:  [real(r8) (:)]  dead stem C growth from storage (gC/m2/s)         
         livecrootc_xfer_to_livecrootc =>    carbonflux_vars%livecroot_xfer_to_livecroot_patch , & ! Input:  [real(r8) (:)]  live coarse root C growth from storage (gC/m2/s)  
         deadcrootc_xfer_to_deadcrootc =>    carbonflux_vars%deadcroot_xfer_to_deadcroot_patch , & ! Input:  [real(r8) (:)]  dead coarse root C growth from storage (gC/m2/s)  
