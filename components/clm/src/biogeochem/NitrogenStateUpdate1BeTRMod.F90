module NitrogenStateUpdate1BeTRMod
  !-----------------------------------------------------------------------
  ! !DESCRIPTION:
  ...
  public :: NitrogenStateUpdate1Soil
  public :: NitrogenStateUpdate1Veg
  !-----------------------------------------------------------------------
...
contains
  ...
  !-----------------------------------------------------------------------
  subroutine NitrogenStateUpdate1Soil(num_soilc, filter_soilc, num_soilp, filter_soilp, &
       cnstate_vars, col_ns, col_nf, is_decomp_on)
    !
    ! !DESCRIPTION:
  ...
  end subroutine NitrogenStateUpdate1Soil
  !-----------------------------------------------------------------------
  subroutine NitrogenStateUpdate1Veg(num_soilc, filter_soilc, num_soilp, filter_soilp, &
       cnstate_vars, veg_ns, veg_nf)
    !
    ! !DESCRIPTION:
    ! On the radiation time step, update all the prognostic nitrogen state
    ! variables (except for gap-phase mortality and fire fluxes)
  ...
  end subroutine NitrogenStateUpdate1Veg


  !-----------------------------------------------------------------------
  subroutine NitrogenStateUpdate1(num_soilc, filter_soilc, num_soilp, filter_soilp, &
       cnstate_vars, col_ns, veg_ns, col_nf, veg_nf, ldecomp_on)
    !
    ! !DESCRIPTION:
    ! On the radiation time step, update all the prognostic nitrogen state
    ! variables (except for gap-phase mortality and fire fluxes)
  ...
  call NitrogenStateUpdate1Veg(num_soilc, filter_soilc, num_soilp, filter_soilp, &
     cnstate_vars, veg_ns, veg_nf)

  end subroutine NitrogenStateUpdate1
end module NitrogenStateUpdate1BeTRMod
