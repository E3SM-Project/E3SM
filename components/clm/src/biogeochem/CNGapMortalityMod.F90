...
contains
  ...
  subroutine CNGapMortality (&
    ...
    associate(                                                                                              & 
      ...
      do fp = 1,num_soilp
         ...
         carbonflux_vars%m_pool_to_litter_patch(p)               = carbonstate_vars%pool_patch(p)               * m
         ...
         nitrogenflux_vars%m_pool_to_litter_patch(p)               = nitrogenstate_vars%pool_patch(p)               * m
         ...
         phosphorusflux_vars%m_pool_to_litter_patch(p)               = phosphorusstate_vars%pool_patch(p)               * m
  ...
  subroutine CNGapPftToColumn ( &
    ...
    associate(                                                                                              & 
         ...
         m_npool_to_litter                   =>    nitrogenflux_vars%m_pool_to_litter_patch              , & ! Input:  [real(r8) (:)   ]
         ...
         m_ppool_to_litter                   =>    phosphorusflux_vars%m_pool_to_litter_patch              , & ! Input:  [real(r8) (:)   ]         
