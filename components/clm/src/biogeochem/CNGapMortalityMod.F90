  ...
  subroutine CNGapMortality (&
    ...
    associate(                                                                                              & 
      ...
      do fp = 1,num_soilp
         ...
         carbonflux_vars%m_cpool_to_litter_patch(p)               = carbonstate_vars%pool_patch(p)               * m
         ...
         nitrogenflux_vars%m_npool_to_litter_patch(p)               = nitrogenstate_vars%pool_patch(p)               * m
         ...
         phosphorusflux_vars%m_ppool_to_litter_patch(p)               = phosphorusstate_vars%pool_patch(p)               * m
