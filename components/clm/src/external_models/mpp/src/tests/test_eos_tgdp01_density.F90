program test_eos_constant_density
...
#include <petsc/finclude/petsc.h>
  ...
  !
  PetscReal, parameter :: den_bmark                 = 55.317560635066179d0     ! [kmol m^{-3}]
  PetscReal, parameter :: dden_dp_bmark             = 2.4884914247886521d-8    ! [kmol m^{-3} Pa^{-1}]
  PetscReal, parameter :: dden_dT_bmark             = -1.5203176216371761d-2   ! [kmol m^{-3} K^{-1}]
  !
  ...
  call Density(p, t_K, DENSITY_TGDPB01, den, dden_dp, dden_dT)
...
end program test_eos_constant_density
