...
#include <petsc/finclude/petsc.h>
  ...
  !
  PetscReal, parameter :: den_bmark                 = 55.508250191225926d0     ! [kmol m^{-3}]
  PetscReal, parameter :: dden_dp_bmark             = 0.d0                     ! [kmol m^{-3} Pa^{-1}]
  PetscReal, parameter :: dden_dT_bmark             = 0.d0                     ! [kmol m^{-3} K^{-1}]
  !
  ...
  call Density(p, t_K, DENSITY_CONSTANT, den, dden_dp, dden_dT)
