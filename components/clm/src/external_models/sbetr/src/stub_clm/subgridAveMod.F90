...
contains
  ...
  subroutine p2c_1d (bounds, parr, carr, p2c_scale_type)
    ...
    SHR_ASSERT_ALL((ubound(parr) == (/bounds%endp/)), errMsg(mod_filename, __LINE__))
    SHR_ASSERT_ALL((ubound(carr) == (/bounds%endc/)), errMsg(mod_filename, __LINE__))
  ...
  subroutine p2c_2d (bounds, num2d, parr, carr, p2c_scale_type)
    ...
    SHR_ASSERT_ALL((ubound(parr) == (/bounds%endp, num2d/)), errMsg(mod_filename, __LINE__))
    SHR_ASSERT_ALL((ubound(carr) == (/bounds%endc, num2d/)), errMsg(mod_filename, __LINE__))
  ...
  subroutine p2c_1d_filter (bounds, numfc, filterc,  pftarr, colarr)
    ...
    SHR_ASSERT_ALL((ubound(pftarr) == (/bounds%endp/)), errMsg(mod_filename, __LINE__))
    SHR_ASSERT_ALL((ubound(colarr) == (/bounds%endc/)), errMsg(mod_filename, __LINE__))
  ...
  subroutine p2l_1d (bounds, parr, larr, p2c_scale_type, c2l_scale_type)
    ...
    SHR_ASSERT_ALL((ubound(parr) == (/bounds%endp/)), errMsg(mod_filename, __LINE__))
    SHR_ASSERT_ALL((ubound(larr) == (/bounds%endl/)), errMsg(mod_filename, __LINE__))
  ...
  subroutine p2l_2d(bounds, num2d, parr, larr, p2c_scale_type, c2l_scale_type)
    ...
    SHR_ASSERT_ALL((ubound(parr) == (/bounds%endp, num2d/)), errMsg(mod_filename, __LINE__))
    SHR_ASSERT_ALL((ubound(larr) == (/bounds%endl, num2d/)), errMsg(mod_filename, __LINE__))
  ...
  subroutine p2g_1d(bounds, parr, garr, p2c_scale_type, c2l_scale_type, l2g_scale_type)
    ...
    SHR_ASSERT_ALL((ubound(parr) == (/bounds%endp/)), errMsg(mod_filename, __LINE__))
    SHR_ASSERT_ALL((ubound(garr) == (/bounds%endg/)), errMsg(mod_filename, __LINE__))
  ...
  subroutine p2g_2d(bounds, num2d, parr, garr, p2c_scale_type, c2l_scale_type, l2g_scale_type)
    ...
    SHR_ASSERT_ALL((ubound(parr) == (/bounds%endp, num2d/)), errMsg(mod_filename, __LINE__))
    SHR_ASSERT_ALL((ubound(garr) == (/bounds%endg, num2d/)), errMsg(mod_filename, __LINE__))
  ...
  subroutine build_scale_l2g(bounds, l2g_scale_type, scale_l2g)
    ...
    SHR_ASSERT_ALL((ubound(scale_l2g) == (/bounds%endl/)), errMsg(mod_filename, __LINE__))
