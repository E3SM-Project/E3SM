module ThermalKSPTemperatureSSWAuxMod
...
#include "finclude/petscsys.h"
  ...
  public :: ThermKSPTempSSWAuxVarSetRValues
  public :: ThermKSPTempSSWAuxVarGetRValues

contains
  
  !------------------------------------------------------------------------
  subroutine ThermKSPTempSSWAuxVarSetRValues(auxvars, var_type, nauxvar, auxvar_ids, data_1d)
    !
    ! !DESCRIPTION:
    !
    ...
    !
    ! !ARGUMENTS
    type(therm_ksp_temp_ssw_auxvar_type), pointer :: auxvars(:)
  ...
  end subroutine ThermKSPTempSSWAuxVarSetRValues

  
  !------------------------------------------------------------------------
  subroutine ThermKSPTempSSWAuxVarGetRValues(auxvars, var_type, nauxvar, auxvar_ids, data_1d)
    !
    ! !DESCRIPTION:
    !
    use MultiPhysicsProbConstants, only : VAR_TEMPERATURE
  ...
  end subroutine ThermKSPTempSSWAuxVarGetRValues

#endif
end module ThermalKSPTemperatureSSWAuxMod
