Module SoilHydrologyType
  ...
  type, public :: soilhydrology_type
     ...
     real(r8), pointer :: vic_clm_fract_col (:,:,:) => null()! col VIC fraction of VIC layers in CLM layers
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%vic_clm_fract_col (begc:endc,nlayer, nlevsoi)) ; this%vic_clm_fract_col (:,:,:) = spval
