...
contains
  ...
  character(len=32) function SoilTextureType(stxt)
    ...
    if ( silt + 1.5_r8*clay < 15._r8 ) then
       ...
       !#py call endrun(msg=' ERROR: soil clay, silt and sand are out of bounds.'//&
  ...
  real(r8) function SoilDetachability(stxt)
    ...
    if (txttype=='clay') then
       SoilDetachability = 0.05_r8
    else if (txttype=='silty clay') then
       SoilDetachability = 0.5_r8
    else if (txttype=='sandy clay') then
       SoilDetachability = 0.3_r8
    else if (txttype=='silty clay loam') then
       SoilDetachability = 0.8_r8
    else if (txttype=='clay loam') then
       SoilDetachability = 0.7_r8
    else if (txttype=='sandy clay loam') then
       SoilDetachability = 0.1_r8
    else if (txttype=='silt') then
       SoilDetachability = 1.0_r8
    else if (txttype=='silt loam') then
       SoilDetachability = 0.9_r8
    else if (txttype=='loam') then
       SoilDetachability = 0.8_r8
    else if (txttype=='sandy loam') then
       SoilDetachability = 0.7_r8
    else if (txttype=='loamy sand') then
       SoilDetachability = 0.3_r8
    else if (txttype=='sand') then
       SoilDetachability = 1.9_r8
    else
       !#py call endrun(msg=' ERROR: no soil texture type is found.'//&
            !#py !#py errMsg(__FILE__, __LINE__))
    end if
