module clm_varctl
  ...
  logical,  public :: iop_scream    = .false. ! true => iop scream mode
...
contains
  ...
  subroutine clm_varctl_set( caseid_in, ctitle_in, brnch_retain_casename_in,    &
       single_column_in, iop_scream_in, scmlat_in, scmlon_in, nsrest_in, &
    ...
    logical,            optional, intent(IN) :: iop_scream_in
    ...
    if ( present(iop_scream_in   ) ) iop_scream    = iop_scream_in
