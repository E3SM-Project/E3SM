module pftvarcon
  ...
  integer :: noilpalm               !value for oil palm, rain fed (rf)
  integer :: noilpalmirrig          !value for oil palm, irrigated (ir)
  integer :: nothergrains           !value for other grain, rain fed (rf)
  integer :: nothergrainsirrig      !value for other grain, irrigated (ir)
  ...
  integer :: nrootstubers           !value for roots and tubers, rain fed (rf)
  integer :: nrootstubersirrig      !value for roots and tubers, irrigated (ir)
...
!-----------------------------------------------------------------------
    ...
    expected_pftnames(39) = 'roots_tubers                       '
    ...
    do i = 0, mxpft
       ...
       if ( trim(pftname(i)) == 'other_grains'                        ) nothergrains         = i
       if ( trim(pftname(i)) == 'irrigated_other_grains'              ) nothergrainsirrig    = i
       ...
       if ( trim(pftname(i)) == 'roots_tubers'                        ) nrootstubers         = i
       if ( trim(pftname(i)) == 'irrigated_root_tubers'               ) nrootstubersirrig    = i
    ...
    if( .not. use_fates ) then
       ...
       do i = 0, mxpft
          if ( irrigated(i) == 1.0_r8  .and. (i == nc3irrig .or. &
                                              ...
                                              i == noilpalmirrig .or. &
                                              i == nothergrainsirrig .or. &
                                              i == nrapeseedirrig .or. &
                                              i == nriceirrig .or. &
                                              i == nrootstubersirrig .or. &
