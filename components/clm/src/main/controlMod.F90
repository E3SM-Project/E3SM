...
contains
  ...
  subroutine control_init( )
    ...
    namelist /clm_inparm/ fates_paramfile, use_fates,      &
          ...
          use_fates_planthydro, use_fates_alt_planthydro,use_fates_ed_st3,       &
  ...
  subroutine control_spmd()
    ...
    call mpi_bcast (use_fates_alt_planthydro, 1, MPI_LOGICAL, 0, mpicom, ier)
  ...
  subroutine control_print ()
    ...
    if (use_fates) then
       ...
       write(iulog, *) '    use_fates_alt_planthydro = ', use_fates_alt_planthydro
