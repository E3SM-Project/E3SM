...
parser.add_option("--caseroot", dest="caseroot", default="../../../../../cime/scripts")
...
if (os.path.isfile(surffile_new)):
    print('Warning:  Removing existing surface data file')
...
if (options.nopftdyn == False):
  ...
  pftdyn_new = csmdir+'/components/clm/tools/clm4_5/pointclm/temp/surfdata.pftdyn.nc'
  if (os.path.isfile(pftdyn_new)):
