...
param.test_data_path = os.path.join(data_prefix, 'test_model_data_for_acme_diags/climatology/')
...
enso_param.reference_data_path = os.path.join(data_prefix, 'obs_for_e3sm_diags/time-series/')
enso_param.test_data_path = os.path.join(data_prefix, 'test_model_data_for_acme_diags/time-series/E3SM_v1/')
enso_param.test_name = 'e3sm_v1'
enso_param.start_yr = '1990'
enso_param.end_yr = '1999'

qbo_param = QboParameter()
qbo_param.reference_data_path = os.path.join(data_prefix, 'obs_for_e3sm_diags/time-series/')
qbo_param.test_data_path = os.path.join(data_prefix, 'test_model_data_for_acme_diags/time-series/E3SM_v1/')
qbo_param.test_name = 'e3sm_v1'
qbo_param.start_yr = '1990'
qbo_param.end_yr = '1999'

ts_param = AreaMeanTimeSeriesParameter()
ts_param.reference_data_path = os.path.join(data_prefix, 'obs_for_e3sm_diags/time-series/')
ts_param.test_data_path = os.path.join(data_prefix, 'test_model_data_for_acme_diags/time-series/E3SM_v1/')
