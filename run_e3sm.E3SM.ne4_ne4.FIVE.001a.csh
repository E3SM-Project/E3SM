...
### - prepare input files
### - submit 10-day test simulation using 39 nodes to the debug queue
###  
...
set my_npes  = 64
set job_name       = FIVE.001a
set compset        = FC5AV1C-L
set resolution     = ne4_ne4
set machine        = cori-haswell
set walltime       = 00:30:00
setenv project       m3230
...
set tag_name       = E3SM_LS_v2 # code sub-directory name

### CASE_NAME
set case_name = ${tag_name}.${job_name}.ne4_ne4.${machine}
...
#set processor_config = M        # PE count: S (39 nodes), L (285 nodes)
...
### DIRECTORIES
set code_root_dir               = /global/cscratch1/sd/dmartin/E3SM/E3SM
set e3sm_simulations_dir        = /global/cscratch1/sd/dmartin/E3SM/E3SM/E3SM_simulations
...
echo "cime_dir = "$cime_dir
echo "create_newcase_exe = "$create_newcase_exe
...
if ( `lowercase $processor_config` == '1' ) then
  ...
  e3sm_print 'using custom layout for LC because $processor_config = '$processor_config
...
$xmlchange_exe --id DIN_LOC_ROOT --val '/global/cfs/cdirs/e3sm/inputdata'
...
#$xmlchange_exe --id CAM_CONFIG_OPTS --val "-phys cam5 -clubb_sgs -microphys p3 -chem linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 72 -bc_dep_to_snow_updates"

#$xmlchange_exe --id CAM_CONFIG_OPTS --val "-phys cam5 -shoc_sgs -microphys p3 -chem #linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 72 -bc_dep_to_snow_updates -rad rrtmg"
...
if ( `$xmlquery_exe --value COMP_ATM` == 'datm'  ) then 
  ...
  e3sm_newline
  $xmlchange_exe --id CAM_CONFIG_OPTS --append --val='-cosp -five'
endif
...
#$xmlchange_exe --id JOB_QUEUE --val 'premium'
$xmlchange_exe --id DOUT_S --val 'TRUE'
...
cat <<EOF >> user_nl_cam
 five_add_nlevels = 7
 five_bot_toadd = 99500.0D0
 five_top_toadd = 69000.0D0
 cosp_lite = .true. 
