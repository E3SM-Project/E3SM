...
readonly DESCRIPTOR="F2010-P3.ne30pg2"      # This will be the main part of the casename

readonly CASE_GROUP="NGD.Integration"

# Code and compilation
readonly CHECKOUT="20220203"                       # Provide a timestamp for distinction
readonly BRANCH="jacobshpund/atm/E3SMv2_cpl_P3_ConvAssesPhase3"   # v2 release tag + P3 with updates
