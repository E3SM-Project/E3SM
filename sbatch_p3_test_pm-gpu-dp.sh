...
#SBATCH --gpus=4
#SBATCH -t 00:30:00
#SBATCH -J p3_test_pm-gpu-dp
#SBATCH -o pm-gpu-p3_test_results/o.p3_test_pm-gpu-dp.%j.txt
#
# Perlmutter GPU batch job for the standalone P3 test in DP.
# Build first on the login node with ./build_p3_test_pm-gpu-dp.sh.
set -e
...
exec "${REPO_ROOT}/run_p3_test_pm-gpu-dp.sh"
