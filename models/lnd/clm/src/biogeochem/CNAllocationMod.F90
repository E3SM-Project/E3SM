...
!  public :: CNAllocation             ! run method, divided into 3 subroutines/phases (see below)
  public :: CNAllocation1_AG, CNAllocation2_BG, CNAllocation3_AG !run method
...
!      end if  !end of if_not_use_nitrif_denitrif
    ...
    !-------------------------------------------------------------------
      !'plant available N distribution and C allocation' portion is in 'CNAllocation2'
      !================================================================================================
...
!write(*,'(A40,12E14.6)')"DEBUG | puptake_prof=",puptake_prof(1,1:nlevdecomp)
    ...
    !------------------------------------------------------------------
      ...
      !-------------------------------------------------------------------
      !'plant available N distribution and C allocation' portion is in 'CNAllocation3_AG'
      !================================================================================================
