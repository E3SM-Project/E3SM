...
contains
  ...
  !-----------------------------------------------------------------------
  subroutine SLakeTemperature(bounds, num_lakec, filter_lakec, num_lakep, filter_lakep)
    !
    ! !DESCRIPTION:
    ...
    real(r8) :: lakeresist(bounds%begc:bounds%endc)                       ! [s/m] (Needed for calc. of grnd_ch4_cond)
