...
!-------------------------------------------------------------------------------
   ...
   !
   ! I have made a serious attempt to reconcile processes of gas dissolution, langmuir adsorption
   ! with the ECA kinetics. However the efforts ended in vain. So even with approximation error
   ! once the adsorbed phase is calcualted, it is assumed constant within the time step being evolved.
   ! Therefore, the total aqueous and gases phase concentration is = theta*aqueous+epsilon*gaseous
...
!-------------------------------------------------------------------------------   
   ...
   !there are isotopic effect on the henry's law constant,
   !however it is not considered in this version of the code, Jinyun Tang, Aug 19, 2012
