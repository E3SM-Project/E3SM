...
!-------------------------------------------------------------------------------
  ...
  subroutine one_box_century_bgc(ystate, dtime, time, nprimvars, nstvars, dydt)
    ...
    call apply_nutrient_down_regulation(nstvars, Extra_inst%nr, nitrogen_limit_flag, ystate(centurybgc_vars%lid_nh4),&
         ystate(centurybgc_vars%lid_no3), dtime, cascade_matrix, reaction_rates)
