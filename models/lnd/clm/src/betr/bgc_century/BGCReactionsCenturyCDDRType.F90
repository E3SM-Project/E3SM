module BGCReactionsCenturyCDDRType
...
!
! This code does nutrient competition using the component-wise down-regulation approach, which pre-calculates down-regulation factor and applied it
...
implicit none
  ...
  end type bgc_reaction_CENTURY_CDDR_type
  ...
  interface bgc_reaction_CENTURY_CDDR_type
    module procedure constructor

  end interface bgc_reaction_CENTURY_CDDR_type
...
!-------------------------------------------------------------------------------
  type(bgc_reaction_CENTURY_CDDR_type) function constructor()
  !
  ! ! DESCRIPTION
  ! create an object of type bgc_reaction_CENTURY_CDDR_type.
...
!-------------------------------------------------------------------------------
  ...
  class(bgc_reaction_CENTURY_CDDR_type), intent(in) :: this
...
end module BGCReactionsCenturyCDDRType
