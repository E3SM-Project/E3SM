module ODEMod
!
! module contains ode integrators for the biogeochemistry model
! Jinyun Tang, 2013
!
...
!-------------------------------------------------------------------------------
   ...
   !mbbks1.
   !Caution: this code should only be used for mass positive ODE integration 
   implicit none
   real(r8), intent(in) :: y0(neq)  ! state variable at previous time step
...
!-------------------------------------------------------------------------------   
   ...
   implicit none
   !rk3  Solve differential equations with a non-adaptive method of order 4.
