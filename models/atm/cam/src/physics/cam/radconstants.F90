...
! *** For interface consistency -- used only by modal_aero_optics and assumes use of RRTMG
! Need to provide a function interface to avoid this hack.
integer, parameter, public :: idx_nir_diag = 999 ! index to sw near infrared (778-1240 nm) band
integer, parameter, public :: idx_uv_diag = 999  ! index to sw uv (345-441 nm) band
