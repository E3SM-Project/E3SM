...
subroutine gw_drag_readnl(nlfile)
  ...
  namelist /gw_drag_nl/ pgwv, gw_dc, effgw_beres, effgw_cm, effgw_oro, &
       fcrit2, frontgfc, gw_drag_file, taubgnd
  !----------------------------------------------------------------------
...
subroutine gw_init()
  ...
  call gw_common_init(pver, pgwv, dc, cref, do_molec_diff, nbot_molec, &
       ktop, kbotbg, fcrit2, kwv, gravit, rair, alpha, errstring)
