...
module carma_model_flags_mod
  ...
  real(r8), public               :: carma_emis_total  = 1e5_r8  ! Total mass emitted (kt/year)
  character(len=256), public     :: carma_emis_file   = 'early_earth_haze.nc'   ! name of the emission file
