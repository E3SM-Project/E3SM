!! This CARMA model is for meteor smoke aerosols and sulfates
!! is based upon Mills..
!!
...
module carma_model_mod
  ...
  integer, public, parameter      :: I_H2SO4          = 2       !! sulfuric acid

  ! Define group, element, solute and gas indexes.
  integer, public, parameter      :: I_GRP_DUST     = 1         !! meteor smoke
  integer, public, parameter      :: I_GRP_SULFATE  = 2         !! sulfate aerosol

  integer, public, parameter      :: I_ELEM_DUST    = 1         !! meteor smoke
  integer, public, parameter      :: I_ELEM_SULFATE = 2         !! sulfate aerosol
  integer, public, parameter      :: I_ELEM_SULCORE = 3         !! meteor smoke core in sulfate
...
!  Set radius of smallest bin such that mass is that of 2 molecules of H2SO4:
  ...
  subroutine CARMA_EmitParticle(carma, ielem, ibin, icnst, dt, state, cam_in, tendency, surfaceFlux, rc)
    ...
    ! NOTE: The global realtive flux file is based upon a noleap calendar, so don't
