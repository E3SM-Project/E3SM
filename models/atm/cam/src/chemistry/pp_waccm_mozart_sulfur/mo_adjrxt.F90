...
!--------------------------------------------------------------------
      ...
      do k = 1,pver
         ...
         rate(:,k, 82) = rate(:,k, 82) * inv(:,k, 1)
         rate(:,k, 85) = rate(:,k, 85) * inv(:,k, 2)
         rate(:,k, 91) = rate(:,k, 91) * inv(:,k, 2)
         rate(:,k, 93) = rate(:,k, 93) * inv(:,k, 2)
         rate(:,k,119) = rate(:,k,119) * inv(:,k, 1)
         rate(:,k,123) = rate(:,k,123) * inv(:,k, 1)
         rate(:,k,125) = rate(:,k,125) * inv(:,k, 1)
         rate(:,k,126) = rate(:,k,126) * inv(:,k, 1)
         rate(:,k,127) = rate(:,k,127) * inv(:,k, 1)
         rate(:,k,133) = rate(:,k,133) * inv(:,k, 1)
         rate(:,k,135) = rate(:,k,135) * inv(:,k, 1)
         rate(:,k,143) = rate(:,k,143) * inv(:,k, 1)
         rate(:,k,145) = rate(:,k,145) * inv(:,k, 1)
         rate(:,k,154) = rate(:,k,154) * inv(:,k, 1)
         rate(:,k,173) = rate(:,k,173) * inv(:,k, 1)
         rate(:,k,177) = rate(:,k,177) * inv(:,k, 1)
         rate(:,k,178) = rate(:,k,178) * inv(:,k, 1)
         rate(:,k,194) = rate(:,k,194) * inv(:,k, 1)
         rate(:,k,220) = rate(:,k,220) * inv(:,k, 1)
         rate(:,k,241) = rate(:,k,241) * inv(:,k, 2)
         rate(:,k,250) = rate(:,k,250) * inv(:,k, 2)
         ...
         rate(:,k,251) = rate(:,k,251) * m(:,k)
         rate(:,k,252) = rate(:,k,252) * m(:,k)
         rate(:,k,253) = rate(:,k,253) * m(:,k)
         rate(:,k,254) = rate(:,k,254) * m(:,k)
      end do
