...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 42, & ! number of photolysis reactions
                            rxntot = 237, & ! number of total reactions
                            gascnt = 195, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 120, & ! number of "gas phase" species
                            nfs = 4, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 970, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 116, & ! number of species in implicit class
