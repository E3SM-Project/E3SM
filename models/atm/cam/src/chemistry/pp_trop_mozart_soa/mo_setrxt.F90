...
!-------------------------------------------------------
      ...
      rate(:,:,215) = 1.4e-12_r8 * exp_fac(:,:)
      rate(:,:,218) = 1.4e-12_r8 * exp_fac(:,:)
      rate(:,:,224) = 7.5e-13_r8 * exp_fac(:,:)
      ...
      rate(:,:,123) = 4.63e-12_r8 * exp_fac(:,:)
      rate(:,:,216) = 2.6e-12_r8 * exp_fac(:,:)
      ...
      rate(:,:,214) = 2.3e-12_r8 * exp( -193._r8 * itemp(:,:) )
      rate(:,:,220) = 1.2e-11_r8 * exp( 444._r8 * itemp(:,:) )
      rate(:,:,221) = 1.e-15_r8 * exp( -732._r8 * itemp(:,:) )
      rate(:,:,222) = 1.2e-12_r8 * exp( 490._r8 * itemp(:,:) )
      rate(:,:,232) = 9.60e-12_r8 * exp( -234._r8 * itemp(:,:) )
      rate(:,:,234) = 1.90e-13_r8 * exp( 520._r8 * itemp(:,:) )
      rate(:,:,235) = 1.70e-12_r8 * exp( -710._r8 * itemp(:,:) )
