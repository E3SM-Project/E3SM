...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 81, & ! number of photolysis reactions
                            rxntot = 373, & ! number of total reactions
                            gascnt = 292, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 157, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1263, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 132, & ! number of species in implicit class
