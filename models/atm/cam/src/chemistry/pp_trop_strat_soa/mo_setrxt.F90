...
!-------------------------------------------------------
      ...
      rate(:,:,334) = 1.4e-12_r8 * exp_fac(:,:)
      rate(:,:,337) = 1.4e-12_r8 * exp_fac(:,:)
      rate(:,:,343) = 7.5e-13_r8 * exp_fac(:,:)
      ...
      rate(:,:,242) = 4.63e-12_r8 * exp_fac(:,:)
      rate(:,:,335) = 2.6e-12_r8 * exp_fac(:,:)
      rate(:,:,338) = 2.6e-12_r8 * exp_fac(:,:)
      ...
      rate(:,:,333) = 2.3e-12_r8 * exp( -193._r8 * itemp(:,:) )
      rate(:,:,339) = 1.2e-11_r8 * exp( 444._r8 * itemp(:,:) )
      rate(:,:,340) = 1.e-15_r8 * exp( -732._r8 * itemp(:,:) )
      rate(:,:,341) = 1.2e-12_r8 * exp( 490._r8 * itemp(:,:) )
      rate(:,:,351) = 9.60e-12_r8 * exp( -234._r8 * itemp(:,:) )
      rate(:,:,353) = 1.90e-13_r8 * exp( 520._r8 * itemp(:,:) )
      rate(:,:,354) = 1.70e-12_r8 * exp( -710._r8 * itemp(:,:) )
