...
!!
    ...
    public :: shr_test_infnan_isnan
    public :: shr_test_infnan_isinf
    public :: shr_test_infnan_isposinf
    public :: shr_test_infnan_isneginf
   ...
   interface shr_test_infnan_isnan
   ...
   interface shr_test_infnan_isinf
      module procedure sisinf
      module procedure disinf
   end interface   
   
   interface shr_test_infnan_isposinf
      module procedure sisposinf
      module procedure disposinf
   end interface   
   
   interface shr_test_infnan_isneginf
...
end module shr_test_infnan_mod
