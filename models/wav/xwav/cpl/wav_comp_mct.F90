...
!!    call wav_run_mct(EClock, cdata, x2d, d2x)
...
!EOP
   ...
   character(*), parameter :: F00   = "('(wav_run_mct) ',8a)"
   character(*), parameter :: F04   = "('(wav_run_mct) ',2a,2i8,'s')"
...
!
! !DESCRIPTION:
!     finalize method for dead wav model
!
! !REVISION HISTORY:
!
! !INTERFACE: ------------------------------------------------------------------
...
!EOP
   ...
   character(*), parameter :: F00   = "('(wav_final_mct) ',8a)"
   character(*), parameter :: F91   = "('(wav_final_mct) ',73('-'))"
