...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public :: &
      POP_blockSizeX = 32, &! size of block in first  horizontal dimension
      POP_blockSizeY = 24   ! size of block in second horizontal dimension
   ...
   integer (POP_i4), parameter, public :: &
      POP_maxBlocksClinic = 10,  &! max number of blocks per processor
      POP_maxBlocksTropic = 10    !   in each distribution
