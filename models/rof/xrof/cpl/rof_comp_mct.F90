...
!!    call rof_run_mct(EClock, cdata, x2d, d2x)
...
!EOP
   ...
   character(*), parameter :: F00   = "('(rof_run_mct) ',8a)"
   character(*), parameter :: F04   = "('(rof_run_mct) ',2a,2i8,'s')"
...
!
! !DESCRIPTION:
!     finalize method for dead rof model
!
! !REVISION HISTORY:
!
! !INTERFACE: ------------------------------------------------------------------
...
!EOP
   ...
   !--- formats ---
   character(*), parameter :: F00   = "('(rof_final_mct) ',8a)"
   character(*), parameter :: F91   = "('(rof_final_mct) ',73('-'))"
