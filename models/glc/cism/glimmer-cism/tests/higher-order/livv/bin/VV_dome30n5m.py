...
# Failure checking
	failedt = VV_ismip.failcheck(job_path, '/dome30/diagnostic/data/gnu.JFNK.1proc')	
...
# Failure checking
	failedt = VV_ismip.failcheck(job_path, '/dome30/diagnostic/data/gnu.JFNK.4proc')	
...
# Failure checking
	failedt = VV_ismip.failcheck(job_path, '/dome30/evolving/data/gnu.JFNK.9proc')	
...
# Failure checking
	failedt = VV_ismip.failcheck(job_path, '/dome30/evolving/data/gnu.JFNK.15proc')	
...
def dplot(plot_file,job_path,ncl_path,html_path):  # using data, fill the web page with info
	...
	if nc_parse.emptycheck(tmpath) == 0 and nc_parse.emptycheck(tmpath2) == 0:
		return 
...
def eplot(plot_file,job_path,ncl_path,html_path):  # using data, fill the web page with info
	...
	tmpath = job_path + '/dome30/evolving/data/dome.9.nc'
	tmpath2 = job_path + '/dome30/evolving/data/dome.15.nc'
	if nc_parse.emptycheck(tmpath) == 0 and nc_parse.emptycheck(tmpath2) == 0:
		return 
