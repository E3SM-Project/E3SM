...
foreach (comp IN LISTS NetCDF_FIND_VALID_COMPONENTS)
    ...
    if (NOT NetCDF_${comp}_IS_SHARED)
        ...
        elseif (comp STREQUAL CXX OR comp STREQUAL CXX4)
        
            # DEPENDENCY: HDF5
            find_package (HDF5 REQUIRED COMPONENTS CXX HL)
            if (HDF5_FOUND)
                list (APPEND NetCDF_${comp}_INCLUDE_DIRS ${HDF5_INCLUDE_DIRS})
                list (APPEND NetCDF_${comp}_LIBRARIES ${HDF5_CXX_LIBRARIES}
                                                      ${HDF5_HL_LIBRARIES})
            endif ()
            ...
            find_package (CURL REQUIRED)
            if (CURL_FOUND)
                list (APPEND NetCDF_${comp}_INCLUDE_DIRS ${CURL_INCLUDE_DIRS})
                list (APPEND NetCDF_${comp}_LIBRARIES ${CURL_LIBRARIES})
            endif ()
