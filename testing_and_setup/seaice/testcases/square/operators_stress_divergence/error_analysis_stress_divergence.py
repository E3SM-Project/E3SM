        ...
        for iTerm in range(0,nTerms):
            ...
            for iSurroundingCell in range(0,vertexDegree):
                ...
                for iStressVertex in range(0,nEdgesOnCell[iCell]):
                    ...
                    if (iTerm == 3):
                        #print(iSurroundingCell,iStressVertex,(fTerm * basisIntegralsU[iCell,iVelocityVertex,iStressVertex]) / areaTriangle[iVertexTest],(fTerm * basisIntegralsV[iCell,iVelocityVertex,iStressVertex]) / areaTriangle[iVertexTest])
                        print("%i %i % .5e % .5e" %(iSurroundingCell,iStressVertex,fTerm*basisIntegralsU[iCell,iVelocityVertex,iStressVertex],fTerm*basisIntegralsV[iCell,iVelocityVertex,iStressVertex]))
