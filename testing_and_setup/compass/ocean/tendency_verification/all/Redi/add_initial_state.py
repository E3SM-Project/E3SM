...
# {{{
    ...
    parser.add_argument('-H', '--thicknessAllLayers', dest='thicknessAllLayers', 
                        default=10,
                        type=float,
...
# {{{
    ...
    refLayerThickness[0] = 100 # make first layer deep to avoid z^2 derivative problems near zero.
...
# {{{
    ...
    tracer1Tend = ds.createVariable('tracer1Tend', np.float64, ('Time','nCells','nVertLevels',))
    tracer2Tend = ds.createVariable('tracer2Tend', np.float64, ('Time','nCells','nVertLevels',))
    tracer3Tend = ds.createVariable('tracer3Tend', np.float64, ('Time','nCells','nVertLevels',))
