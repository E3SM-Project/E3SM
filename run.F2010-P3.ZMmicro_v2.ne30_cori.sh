...
readonly CHECKOUT="20220222"                       # Provide a timestamp for distinction
...
readonly CODE_ROOT="/global/cscratch1/sd/terai/E3SM_code/E3SMv2_P31_ZMmicro"               # where it contains 'components','cime', etc.
