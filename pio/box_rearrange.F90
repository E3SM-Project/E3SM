!===================================================
! DO NOT EDIT THIS FILE, it was generated using /glade/scratch/jedwards/testpio/src/pio/genf90.pl 
...
!!!!!!!
    ...
    call compute_dest( compdof,start,kount,gsize,ndim,Iosystem%num_aiotasks, &
