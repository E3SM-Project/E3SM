...
# 69 "piodarray.F90.in"
  subroutine write_darray_1d_int (File,varDesc,ioDesc, array, iostat, fillval)
    ...
    if(ios%async_interface .and. .not. ios%ioproc) then
       ...
       case(pio_iotype_vdc2)
          call write_vdc2_int(File, Vardesc, iodesc, array, iostat)
       case(pio_iotype_binary)
          print *, subName,': IO type not supported'
       end select
...
# 69 "piodarray.F90.in"
  subroutine write_darray_1d_double (File,varDesc,ioDesc, array, iostat, fillval)
    ...
    if(ios%async_interface .and. .not. ios%ioproc) then
       ...
       case(pio_iotype_vdc2)
          call write_vdc2_double(File, Vardesc, iodesc, array, iostat)
       case(pio_iotype_binary)
          print *, subName,': IO type not supported'
       end select
...
# 200 "piodarray.F90.in"
  subroutine read_darray_1d_int (File,varDesc, ioDesc, array, iostat)
    ...
    case(pio_iotype_vdc2)
       call read_vdc2_int (File, vardesc, iodesc, array, iostat)
    case(pio_iotype_binary)
       print *, subName,': IO type not supported'
    end select
...
# 200 "piodarray.F90.in"
  subroutine read_darray_1d_double (File,varDesc, ioDesc, array, iostat)
    ...
    case(pio_iotype_vdc2)
       call read_vdc2_double (File, vardesc, iodesc, array, iostat)
    case(pio_iotype_binary)
       print *, subName,': IO type not supported'
    end select
...
# 1066 "piodarray.F90.in"
 subroutine write_vdc2_real(File,varDesc,ioDesc,array, iostat)
    ...
    if (IOproc) then
	call write_vdc2_var(iobuf, start, count,  ndims, File%iosystem%IO_comm, varDesc%bs, varDesc%cur_ts, varDesc%lod, varDesc%dims, TRIM(varDesc%vdf), TRIM(varDesc%name), File%iosystem%num_iotasks)
...
! TYPE real,int,double
# 1066 "piodarray.F90.in"
 subroutine write_vdc2_int(File,varDesc,ioDesc,array, iostat)
    ...
    if(UseRearranger) then 
       if (IOproc) then 
          ...
          if(Debug) print *, 'write_vdc2_int: IAM: ',File%iosystem%comp_rank,'Before call to allocate(IOBUF): ',len
          call alloc_check(IOBUF,len,' TYPE :IOBUF')
          IOBUF= -1.0_r8
  ...
  end subroutine write_vdc2_int
! TYPE real,int,double
# 1066 "piodarray.F90.in"
 subroutine write_vdc2_double(File,varDesc,ioDesc,array, iostat)
    ...
    if(UseRearranger) then 
       if (IOproc) then 
          ...
          if(Debug) print *, 'write_vdc2_double: IAM: ',File%iosystem%comp_rank,'Before call to allocate(IOBUF): ',len
          call alloc_check(IOBUF,len,' TYPE :IOBUF')
          IOBUF= -1.0_r8
  ...
  end subroutine write_vdc2_double

! TYPE real,int,double
# 1153 "piodarray.F90.in"
subroutine read_vdc2_real(File,varDesc,ioDesc,array, iostat)
    ...
    if(UseRearranger) then 
       if (IOproc) then 
          ...
          call alloc_check(IOBUF,len,' TYPE :IOBUF')
          IOBUF= -1.0_r8
  	  call read_vdc2_var(iobuf, start, count,  ndims, File%iosystem%IO_comm, varDesc%bs, varDesc%cur_ts, varDesc%lod, varDesc%dims, TRIM(varDesc%vdf), TRIM(varDesc%name))
       else
          call alloc_check(IOBUF,0)
          IOBUF= -1.0_r8
       endif
...
! TYPE real,int,double
# 1153 "piodarray.F90.in"
subroutine read_vdc2_int(File,varDesc,ioDesc,array, iostat)
    ...
    integer(i4), dimension(:), intent(inout), target ::  &
         array                  ! array to be written
  ...
  end subroutine read_vdc2_int

! TYPE real,int,double
# 1153 "piodarray.F90.in"
subroutine read_vdc2_double(File,varDesc,ioDesc,array, iostat)
  ...
  end subroutine read_vdc2_double
