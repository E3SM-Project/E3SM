...
# 1387 "piodarray.F90.in"
 subroutine write_vdc2_real(File,varDesc,ioDesc,array, iostat)
	...
	call WriteVDC2Var(iobuf, start, count,  File%iosystem%IO_comm, varDesc%ts, varDesc%lod, varDesc%reflevel, varDesc%name(1:vlen)//char(0), File%iosystem%num_iotasks)
    endif
