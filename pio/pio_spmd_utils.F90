...
!===================================================
#define _FILE_ "pio_spmd_utils.F90"
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
...
!
   ...
   character(len=*), intent(in)   :: sndbuf(sbuf_siz)   ! outgoing message buffer
   character(len=*), intent(out)  :: rcvbuf(rbuf_siz)   ! incoming message buffer
...
!---------------------------Local workspace-------------------------------------------
!
   character(len=*), parameter :: subName=modName//'::pio_swapm_text'
