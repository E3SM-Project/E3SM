...
PminusE._FillValue = 1.0e20
PminusE.missing_value = 1.0e20
...
setattr(
    fout,
    "data_name",
    "P - E computed using precipitation rate from GPCP (1979-2013) and evaporation rate from OAFlux (1979-2013)",
)
