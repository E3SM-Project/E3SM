...
cdo splityear HadISST_sst.nc ${tmp}HadISST1
...
ncrcat ${tmp}HadISST2*nc ${time_series_output_path}sst_187001_201612_orig.nc 
#add time_bnds to time attr
ncatted -O -a bounds,time,a,c,time_bnds ${time_series_output_path}sst_187001_201612_orig.nc
