...
MODULE shr_const_mod
   ...
   real(SHR_KIND_R8),parameter :: CZERO = 0.0_SHR_KIND_R8 
   real(SHR_KIND_R8),parameter :: SPVAL_INIT = 0.0_SHR_KIND_R8
   ...
   real(SHR_KIND_R8),parameter :: SHR_CONST_TKFRZ   = 273.15_SHR_KIND_R8       ! freezing T of fresh water          ~ K
   real(SHR_KIND_R8),parameter :: SHR_CONST_TKFRZSW = SHR_CONST_TKFRZ - 1.8_SHR_KIND_R8 ! freezing T of salt water  ~ K
   real(SHR_KIND_R8),parameter :: SHR_CONST_ZSRFLYR = 3.0_SHR_KIND_R8          ! ocn surf layer depth for diurnal SST cal ~ m

   real(SHR_KIND_R8),parameter :: SHR_CONST_RHODAIR = &               ! density of dry air at STP  ~ kg/m^3
   ...
   real(SHR_KIND_R8),parameter :: SHR_CONST_LATSUB  = &               ! latent heat of sublimation ~ J/kg
                         SHR_CONST_LATICE + SHR_CONST_LATVAP
   real(SHR_KIND_R8),parameter :: SHR_CONST_CONDICE = 2.1_SHR_KIND_R8          ! thermal conductivity of ice ~ W/m/K
   real(SHR_KIND_R8),parameter :: SHR_CONST_KAPPA_LAND_ICE = &        ! Diffusivity of heat in land ice ~
                         SHR_CONST_CONDICE / (SHR_CONST_RHOICE*SHR_CONST_CPICE)
   real(SHR_KIND_R8),parameter :: SHR_CONST_TF0    = 6.22e-2_SHR_KIND_R8       ! The freezing temperature at zero pressure in
   ! sub-ice-shelf ocean cavities ~ C
   real(SHR_KIND_R8),parameter :: SHR_CONST_DTF_DP = -7.43e-8_SHR_KIND_R8      ! The coefficient for the term proportional to the (limited)
   ! pressure in the freezing temperature in sub-ice-shelf ocean cavities. ~ C Pa^{-1}
   real(SHR_KIND_R8),parameter :: SHR_CONST_DTF_DS = -5.63e-2_SHR_KIND_R8      !The coefficient for the term proportional to salinity in
   ! the freezing temperature in sub-ice-ice ocean cavities ~ C PSU^{-1}
   real(SHR_KIND_R8),parameter :: SHR_CONST_DTF_DPDS = -1.74e-10_SHR_KIND_R8   ! The coefficient for the term proportional to salinity times
   ...
   real(SHR_KIND_R8),parameter :: SHR_CONST_VSMOW_17O   = 379.e-6_SHR_KIND_R8   ! 18O/16O in VMSOW
   real(SHR_KIND_R8),parameter :: SHR_CONST_VSMOW_16O   = 0.997628_SHR_KIND_R8    ! 16O/Tot in VMSOW 
   real(SHR_KIND_R8),parameter :: SHR_CONST_VSMOW_D   = 155.76e-6_SHR_KIND_R8   ! 2H/1H in VMSOW 
   real(SHR_KIND_R8),parameter :: SHR_CONST_VSMOW_T   = 1.85e-6_SHR_KIND_R8  ! 3H/1H in VMSOW 
   real(SHR_KIND_R8),parameter :: SHR_CONST_VSMOW_H   = 0.99984426_SHR_KIND_R8  ! 1H/Tot in VMSOW 
   ! For best numerics in CAM5
   real(SHR_KIND_R8),parameter :: SHR_CONST_RSTD_H2ODEV   = 1.0_SHR_KIND_R8      ! Rstd Dev Use 
