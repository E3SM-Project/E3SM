...
module fvm_reconstruction_mod
  ...
  use dimensions_mod, only         : nc,nhc,nhe,nhr,nht,ns
...
subroutine reconstruction(fcube,fvm,recons)
  ...
  !
  real (kind=real_kind), dimension(1-nh:nc+nh,1:nhr,1:ns,2) :: halo_interp_weight
...
subroutine fill_halo(fcube,fvm,halo_interp_weight,fpanel,fotherpanel)!dbg
  implicit none
  real (kind=real_kind),   &
