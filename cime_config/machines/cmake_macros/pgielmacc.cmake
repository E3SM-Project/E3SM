...
if (COMP_NAME STREQUAL elm)
    if(DEBUG)
        string(APPEND FFLAGS " -g -Mchkptr -Mchkstk -O0 -ta=tesla:deepcopy,ptxinfo -Minfo=accel -acc -Mcuda")
    else(DEBUG)
        string(APPEND FFLAGS " -fast -ta=tesla:deepcopy,ptxinfo -Minfo=accel -acc -Mcuda")
    endif(DEBUG)
endif()
