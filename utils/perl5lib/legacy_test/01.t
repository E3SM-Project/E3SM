...
like( $@, qr/ERROR: xxx is not a valid value for parameter dyn: valid values are eul,sld,fv,se/,
      'set() trapped invalid parameter value');

eval { $cfg->set('dyn', "eul,sld"); };
like( $@, qr/ERROR: eul,sld is not a valid value for parameter dyn: valid values are eul,sld,fv,se/,
