...
from CIME.XML.build.macros_writer import write_macros_file_v1
...
class Compilers(GenericXML):
	...
	if self._version == "1.0":
	    ...
	    return write_macros_file_v1(macros, macros_file, output_format)
	else:
	    return self._write_macros_file_v2(macros_file, output_format)
