...
CONTAINS
  ...
  subroutine ocn_init_mct( EClock, cdata, x2d, d2x, NLFilename )
    ...
    !EOP
    call dead_init_mct('ocn', flds_d2x, flds_x2d, EClock, cdata, x2d, d2x, NLFilename )
  ...
  subroutine ocn_run_mct(EClock, cdata, x2d, d2x)
    ...
    call dead_run_mct('ocn',EClock, cdata, x2d, d2x)
  ...
  subroutine ocn_final_mct(EClock, cdata, x2d, d2x)
    ...
    !EOP
    call dead_final_mct('ocn', EClock, cdata, x2d, d2x)
