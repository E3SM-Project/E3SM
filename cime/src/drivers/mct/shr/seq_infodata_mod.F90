...
CONTAINS
  ...
  SUBROUTINE seq_infodata_Init( infodata, nmlfile, ID, pioid, cpl_tag)
    ...
    if (seq_comm_iamroot(ID)) then
       ...
       infodata%flux_scheme           = flux_scheme
  ...
  SUBROUTINE seq_infodata_GetData_explicit( infodata, cime_model, case_name, case_desc, timing_dir,  &
    ...
    integer,                optional, intent(OUT) :: flux_scheme             ! 0: E3SMv1  1: COARE  2: UA
    ...
    if ( present(flux_scheme)    ) flux_scheme    = infodata%flux_scheme
  ...
  SUBROUTINE seq_infodata_PutData_explicit( infodata, cime_model, case_name, case_desc, timing_dir,  &
    ...
    integer,                optional, intent(IN)    :: flux_scheme             ! 0: E3SMv1 1: COARE 2:UA
    ...
    if ( present(flux_scheme)    ) infodata%flux_scheme    = flux_scheme
  ...
  subroutine seq_infodata_bcast(infodata,mpicom)
    ...
    call shr_mpi_bcast(infodata%flux_scheme,             mpicom)
  ...
  SUBROUTINE seq_infodata_print( infodata )
    ...
    write(logunit,F0L) subname,'flux_scheme              = ', infodata%flux_scheme
