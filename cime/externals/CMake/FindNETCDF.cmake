...
IF (${NETCDF_REQUIRE_HDF5})
  ...
  CHECK_SYMBOL_EXISTS(H5_HAVE_LIBDL "${HDF5_INCLUDE_DIR}/H5pubconf.h" HDF5_REQUIRE_DL)
  ...
  IF (${HDF5_REQUIRE_DL})
    MESSAGE(STATUS "HDF5 library needs dl ${CMAKE_DL_LIBS}")
    SET(Netcdf_LIBRARIES ${Netcdf_LIBRARIES} ${CMAKE_DL_LIBS})
  ENDIF ()
