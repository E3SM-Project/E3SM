...
class HOMME(SystemTestsCommon):
    ...
    def build_phase(self, sharedlib_only=False, model_only=False):
        if not sharedlib_only:
            ...
            cmake_cmd = "cmake -C {0}/components/homme/cmake/machineFiles/{1}-bfb.cmake -DUSE_NUM_PROCS={2} {0}/components/homme -DHOMME_BASELINE_DIR={3}/{4} -DCPRNC_DIR={5}/..".format(srcroot, mach, procs, baselinedir, basename, cprnc)
